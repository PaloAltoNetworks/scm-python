...
class TestKerberosServerProfilesListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> KerberosServerProfilesListResponse:
        """Test KerberosServerProfilesListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KerberosServerProfilesListResponse`
        """
        model = KerberosServerProfilesListResponse()
        if include_optional:
    ...
    def testKerberosServerProfilesListResponse(self):
        """Test KerberosServerProfilesListResponse"""
