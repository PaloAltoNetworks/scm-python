...
class TestLocalUserGroupsListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LocalUserGroupsListResponse:
        """Test LocalUserGroupsListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalUserGroupsListResponse`
        """
        model = LocalUserGroupsListResponse()
        if include_optional:
    ...
    def testLocalUserGroupsListResponse(self):
        """Test LocalUserGroupsListResponse"""
