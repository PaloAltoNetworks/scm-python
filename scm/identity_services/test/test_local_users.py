...
class TestLocalUsers(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LocalUsers:
        """Test LocalUsers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalUsers`
        """
        model = LocalUsers()
        if include_optional:
            return LocalUsers(
