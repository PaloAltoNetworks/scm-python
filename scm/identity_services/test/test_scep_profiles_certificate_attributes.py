...
class TestScepProfilesCertificateAttributes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ScepProfilesCertificateAttributes:
        """Test ScepProfilesCertificateAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScepProfilesCertificateAttributes`
        """
        model = ScepProfilesCertificateAttributes()
        if include_optional:
            return ScepProfilesCertificateAttributes(
                dnsname = '',
                rfc822name = '',
    ...
    def testScepProfilesCertificateAttributes(self):
        """Test ScepProfilesCertificateAttributes"""
