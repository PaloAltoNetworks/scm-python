...
class TestTACACSServerProfilesListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TACACSServerProfilesListResponse:
        """Test TACACSServerProfilesListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TACACSServerProfilesListResponse`
        """
        model = TACACSServerProfilesListResponse()
        if include_optional:
    ...
    def testTACACSServerProfilesListResponse(self):
        """Test TACACSServerProfilesListResponse"""
