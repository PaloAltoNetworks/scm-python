...
class TestAuthenticationProfilesMethodCloud(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AuthenticationProfilesMethodCloud:
        """Test AuthenticationProfilesMethodCloud
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthenticationProfilesMethodCloud`
        """
        model = AuthenticationProfilesMethodCloud()
        if include_optional:
            return AuthenticationProfilesMethodCloud(
                profile_name = ''
            )
        else:
            return AuthenticationProfilesMethodCloud(
    ...
    def testAuthenticationProfilesMethodCloud(self):
        """Test AuthenticationProfilesMethodCloud"""
