...
class TestTrustedCertificateAuthoritiesListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TrustedCertificateAuthoritiesListResponse:
        """Test TrustedCertificateAuthoritiesListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrustedCertificateAuthoritiesListResponse`
        """
        model = TrustedCertificateAuthoritiesListResponse()
        if include_optional:
    ...
    def testTrustedCertificateAuthoritiesListResponse(self):
        """Test TrustedCertificateAuthoritiesListResponse"""
