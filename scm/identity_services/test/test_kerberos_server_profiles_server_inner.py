...
class TestKerberosServerProfilesServerInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> KerberosServerProfilesServerInner:
        """Test KerberosServerProfilesServerInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KerberosServerProfilesServerInner`
        """
        model = KerberosServerProfilesServerInner()
        if include_optional:
            return KerberosServerProfilesServerInner(
                host = '',
                name = '',
                port = 1
            )
    ...
    def testKerberosServerProfilesServerInner(self):
        """Test KerberosServerProfilesServerInner"""
