...
class TestAuthenticationRulesListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AuthenticationRulesListResponse:
        """Test AuthenticationRulesListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthenticationRulesListResponse`
        """
        model = AuthenticationRulesListResponse()
        if include_optional:
    ...
    def testAuthenticationRulesListResponse(self):
        """Test AuthenticationRulesListResponse"""
