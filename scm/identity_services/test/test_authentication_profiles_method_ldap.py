...
class TestAuthenticationProfilesMethodLdap(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AuthenticationProfilesMethodLdap:
        """Test AuthenticationProfilesMethodLdap
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthenticationProfilesMethodLdap`
        """
        model = AuthenticationProfilesMethodLdap()
        if include_optional:
            return AuthenticationProfilesMethodLdap(
                login_attribute = '',
                passwd_exp_days = 56,
                server_profile = ''
            )
    ...
    def testAuthenticationProfilesMethodLdap(self):
        """Test AuthenticationProfilesMethodLdap"""
