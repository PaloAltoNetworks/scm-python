# scm_identity_services.AuthenticationSequencesApi
...
with scm_identity_services.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_identity_services.AuthenticationSequencesApi(api_client)
    authentication_sequences = scm_identity_services.AuthenticationSequences() # AuthenticationSequences | Created (optional)
...
with scm_identity_services.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_identity_services.AuthenticationSequencesApi(api_client)
    id = '123e4567-e89b-12d3-a456-426655440000' # str | The UUID of the configuration resource
    authentication_sequences = scm_identity_services.AuthenticationSequences() # AuthenticationSequences | OK (optional)
