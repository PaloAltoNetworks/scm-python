# scm_identity_services.LocalUsersApi
...
with scm_identity_services.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_identity_services.LocalUsersApi(api_client)
    local_users = scm_identity_services.LocalUsers() # LocalUsers | Created (optional)
...
with scm_identity_services.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_identity_services.LocalUsersApi(api_client)
    id = '123e4567-e89b-12d3-a456-426655440000' # str | The UUID of the configuration resource
    local_users = scm_identity_services.LocalUsers() # LocalUsers | OK (optional)
