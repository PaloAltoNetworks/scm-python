...
class SdwanPathQualityProfiles(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["device", "folder", "id", "metric", "name", "snippet"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "metric": SdwanPathQualityProfilesMetric.from_dict(obj["metric"]) if obj.get("metric") is not None else None,
            "name": obj.get("name"),
