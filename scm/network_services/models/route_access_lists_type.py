...
class RouteAccessListsType(BaseModel):
    """
    RouteAccessListsType
    """ # noqa: E501
    ipv4: Optional[RouteAccessListsTypeIpv4] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ipv4": RouteAccessListsTypeIpv4.from_dict(obj["ipv4"]) if obj.get("ipv4") is not None else None
        })
        return _obj
