...
class BgpRouteMapRedistributionsConnectedStaticRibRouteMapInnerSet(BaseModel):
    """
    Connected Static Root RIB set
    """ # noqa: E501
    source_address: Optional[StrictStr] = Field(default=None, description="Connected Static BGP Rib Route Map Distribution Source address")
    __properties: ClassVar[List[str]] = ["source_address"]
