...
class BgpAddressFamilyNextHop(BaseModel):
    ...
    """ # noqa: E501
    var_self: Optional[Dict[str, Any]] = Field(default=None, alias="self")
    self_force: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["self", "self_force"]
