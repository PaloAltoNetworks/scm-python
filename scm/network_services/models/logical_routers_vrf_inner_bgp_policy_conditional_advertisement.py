...
class LogicalRoutersVrfInnerBgpPolicyConditionalAdvertisement(BaseModel):
    """
    LogicalRoutersVrfInnerBgpPolicyConditionalAdvertisement
    """ # noqa: E501
    policy: Optional[List[LogicalRoutersVrfInnerBgpPolicyConditionalAdvertisementPolicyInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "policy": [LogicalRoutersVrfInnerBgpPolicyConditionalAdvertisementPolicyInner.from_dict(_item) for _item in obj["policy"]] if obj.get("policy") is not None else None
        })
        return _obj
