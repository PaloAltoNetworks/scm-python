...
class LogicalRoutersVrfInnerBgpAggregateRoutesInnerType(BaseModel):
    """
    LogicalRoutersVrfInnerBgpAggregateRoutesInnerType
    """ # noqa: E501
    ipv4: Optional[LogicalRoutersVrfInnerBgpAggregateRoutesInnerTypeIpv4] = None
    ipv6: Optional[LogicalRoutersVrfInnerBgpAggregateRoutesInnerTypeIpv4] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ipv4": LogicalRoutersVrfInnerBgpAggregateRoutesInnerTypeIpv4.from_dict(obj["ipv4"]) if obj.get("ipv4") is not None else None,
            "ipv6": LogicalRoutersVrfInnerBgpAggregateRoutesInnerTypeIpv4.from_dict(obj["ipv6"]) if obj.get("ipv6") is not None else None
        })
        return _obj
