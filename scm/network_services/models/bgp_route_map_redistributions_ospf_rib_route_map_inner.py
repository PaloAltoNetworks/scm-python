...
class BgpRouteMapRedistributionsOspfRibRouteMapInner(BaseModel):
    """
    BgpRouteMapRedistributionsOspfRibRouteMapInner
    """ # noqa: E501
    action: Optional[StrictStr] = Field(default=None, description="OSPF RIB Route maps Action")
    description: Optional[StrictStr] = Field(default=None, description="OSPF RIB Route maps Description")
    match: Optional[BgpRouteMapRedistributionsOspfRibRouteMapInnerMatch] = None
    name: Optional[Annotated[int, Field(le=65535, strict=True, ge=1)]] = Field(default=None, description="OSPF RIB Route mapsSequence number")
    set: Optional[BgpRouteMapRedistributionsOspfRibRouteMapInnerSet] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "match": BgpRouteMapRedistributionsOspfRibRouteMapInnerMatch.from_dict(obj["match"]) if obj.get("match") is not None else None,
            "name": obj.get("name"),
            "set": BgpRouteMapRedistributionsOspfRibRouteMapInnerSet.from_dict(obj["set"]) if obj.get("set") is not None else None
        })
        return _obj
