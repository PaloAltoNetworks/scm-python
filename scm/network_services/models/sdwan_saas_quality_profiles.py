...
class SdwanSaasQualityProfiles(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["device", "folder", "id", "monitor_mode", "name", "snippet"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of monitor_mode
        if self.monitor_mode:
            _dict['monitor_mode'] = self.monitor_mode.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "monitor_mode": SdwanSaasQualityProfilesMonitorMode.from_dict(obj["monitor_mode"]) if obj.get("monitor_mode") is not None else None,
            "name": obj.get("name"),
