...
class LogicalRoutersVrfInnerOspfv3AuthProfileInnerEsp(BaseModel):
    """
    LogicalRoutersVrfInnerOspfv3AuthProfileInnerEsp
    """ # noqa: E501
    authentication: Optional[LogicalRoutersVrfInnerOspfv3AuthProfileInnerEspAuthentication] = None
    encryption: Optional[LogicalRoutersVrfInnerOspfv3AuthProfileInnerEspEncryption] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "authentication": LogicalRoutersVrfInnerOspfv3AuthProfileInnerEspAuthentication.from_dict(obj["authentication"]) if obj.get("authentication") is not None else None,
            "encryption": LogicalRoutersVrfInnerOspfv3AuthProfileInnerEspEncryption.from_dict(obj["encryption"]) if obj.get("encryption") is not None else None
        })
        return _obj
