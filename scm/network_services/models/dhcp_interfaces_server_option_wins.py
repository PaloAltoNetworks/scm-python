...
class DhcpInterfacesServerOptionWins(BaseModel):
    """
    DhcpInterfacesServerOptionWins
    """ # noqa: E501
    primary: Optional[StrictStr] = Field(default=None, description="Primary WINS server")
    secondary: Optional[StrictStr] = Field(default=None, description="Secondary WINS server")
