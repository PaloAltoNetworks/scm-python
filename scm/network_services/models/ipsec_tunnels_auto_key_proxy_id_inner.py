...
class IpsecTunnelsAutoKeyProxyIdInner(BaseModel):
    """
    IPv4 type of proxy_id values for TCP protocol
    """ # noqa: E501
    local: Optional[StrictStr] = None
    name: StrictStr
    protocol: Optional[IpsecTunnelsAutoKeyProxyIdInnerProtocol] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "local": obj.get("local"),
            "name": obj.get("name"),
            "protocol": IpsecTunnelsAutoKeyProxyIdInnerProtocol.from_dict(obj["protocol"]) if obj.get("protocol") is not None else None,
