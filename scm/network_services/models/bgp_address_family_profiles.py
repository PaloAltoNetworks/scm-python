...
class BgpAddressFamilyProfiles(BaseModel):
    """
    ...
    ipv4: Optional[BgpAddressFamilyProfilesIpv4] = None
    ...
    __properties: ClassVar[List[str]] = ["device", "folder", "id", "ipv4", "name", "snippet"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "ipv4": BgpAddressFamilyProfilesIpv4.from_dict(obj["ipv4"]) if obj.get("ipv4") is not None else None,
            "name": obj.get("name"),
