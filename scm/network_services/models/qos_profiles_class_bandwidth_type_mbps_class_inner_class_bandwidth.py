...
class QosProfilesClassBandwidthTypeMbpsClassInnerClassBandwidth(BaseModel):
    """
    QosProfilesClassBandwidthTypeMbpsClassInnerClassBandwidth
    """ # noqa: E501
    egress_guaranteed: Optional[Annotated[int, Field(le=60000, strict=True, ge=0)]] = Field(default=0, description="guaranteed sending bandwidth in mbps")
    egress_max: Optional[Annotated[int, Field(le=60000, strict=True, ge=0)]] = Field(default=0, description="max sending bandwidth in mbps")
