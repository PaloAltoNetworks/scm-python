...
class RouteCommunityLists(BaseModel):
    """
    RouteCommunityLists
    """ # noqa: E501
    ...
    name: StrictStr = Field(description="Route community list name")
    ...
    type: Optional[RouteCommunityListsType] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": RouteCommunityListsType.from_dict(obj["type"]) if obj.get("type") is not None else None
        })
        return _obj
