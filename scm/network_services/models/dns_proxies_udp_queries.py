...
class DnsProxiesUdpQueries(BaseModel):
    """
    DnsProxiesUdpQueries
    """ # noqa: E501
    retries: Optional[DnsProxiesUdpQueriesRetries] = None
    __properties: ClassVar[List[str]] = ["retries"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "retries": DnsProxiesUdpQueriesRetries.from_dict(obj["retries"]) if obj.get("retries") is not None else None
        })
        return _obj
