...
class DHCPInterfacesListResponse(BaseModel):
    """
    DHCPInterfacesListResponse
    """ # noqa: E501
    data: List[DhcpInterfaces]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [DhcpInterfaces.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
