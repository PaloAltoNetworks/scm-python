...
class AutoVpnClustersBranchesInnerInterfacesInnerSdwanLinkSettingsUpstreamNatStaticIp(BaseModel):
    """
    AutoVpnClustersBranchesInnerInterfacesInnerSdwanLinkSettingsUpstreamNatStaticIp
    """ # noqa: E501
    fqdn: Optional[StrictStr] = Field(default=None, description="FQDN")
