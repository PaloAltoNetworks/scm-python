...
class LogicalRoutersVrfInnerRoutingTableIpv6StaticRouteInnerNexthop(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["discard", "fqdn", "ipv6_address", "next_lr", "next_vr", "receive", "tunnel"]
