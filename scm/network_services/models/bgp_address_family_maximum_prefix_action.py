...
class BgpAddressFamilyMaximumPrefixAction(BaseModel):
    ...
    """ # noqa: E501
    restart: Optional[BgpAddressFamilyMaximumPrefixActionRestart] = None
    warning_only: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["restart", "warning_only"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "restart": BgpAddressFamilyMaximumPrefixActionRestart.from_dict(obj["restart"]) if obj.get("restart") is not None else None,
            "warning_only": obj.get("warning_only")
        })
        return _obj
