...
class QosProfilesClassBandwidthTypeMbps(BaseModel):
    """
    QosProfilesClassBandwidthTypeMbps
    """ # noqa: E501
    var_class: Optional[List[QosProfilesClassBandwidthTypeMbpsClassInner]] = Field(default=None, description="QoS setting for traffic classes", alias="class")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "class": [QosProfilesClassBandwidthTypeMbpsClassInner.from_dict(_item) for _item in obj["class"]] if obj.get("class") is not None else None
        })
        return _obj
