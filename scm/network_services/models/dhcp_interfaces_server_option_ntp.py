...
class DhcpInterfacesServerOptionNtp(BaseModel):
    """
    DhcpInterfacesServerOptionNtp
    """ # noqa: E501
    primary: Optional[StrictStr] = Field(default=None, description="Primary NTP server")
    secondary: Optional[StrictStr] = Field(default=None, description="Secondary NTP server")
