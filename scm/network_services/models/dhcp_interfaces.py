...
class DhcpInterfaces(BaseModel):
    """
    DhcpInterfaces
    """ # noqa: E501
    ...
    relay: Optional[DhcpInterfacesRelay] = None
    server: Optional[DhcpInterfacesServer] = None
    ...
    __properties: ClassVar[List[str]] = ["device", "folder", "id", "name", "relay", "server", "snippet"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "relay": DhcpInterfacesRelay.from_dict(obj["relay"]) if obj.get("relay") is not None else None,
            "server": DhcpInterfacesServer.from_dict(obj["server"]) if obj.get("server") is not None else None,
