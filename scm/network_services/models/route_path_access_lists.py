...
class RoutePathAccessLists(BaseModel):
    """
    RoutePathAccessLists
    """ # noqa: E501
    aspath_entry: Optional[List[RoutePathAccessListsAspathEntryInner]] = Field(default=None, description="AS paths")
    ...
    name: StrictStr = Field(description="AS path access list name")
    ...
    __properties: ClassVar[List[str]] = ["aspath_entry", "description", "device", "folder", "id", "name", "snippet"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in aspath_entry (list)
        _items = []
        if self.aspath_entry:
            for _item_aspath_entry in self.aspath_entry:
                if _item_aspath_entry:
                    _items.append(_item_aspath_entry.to_dict())
            _dict['aspath_entry'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "aspath_entry": [RoutePathAccessListsAspathEntryInner.from_dict(_item) for _item in obj["aspath_entry"]] if obj.get("aspath_entry") is not None else None,
