...
class LoopbackInterfaces(BaseModel):
    """
    LoopbackInterfaces
    """ # noqa: E501
    ...
    def default_value_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^loopback\.([1-9][0-9]{0,3})$", value):
            raise ValueError(r"must validate the regular expression /^loopback\.([1-9][0-9]{0,3})$/")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ip": [LoopbackInterfacesIpInner.from_dict(_item) for _item in obj["ip"]] if obj.get("ip") is not None else None,
            "ipv6": LoopbackInterfacesIpv6.from_dict(obj["ipv6"]) if obj.get("ipv6") is not None else None,
            "mtu": obj.get("mtu"),
            "name": obj.get("name"),
