...
class NatRulesSourceTranslationDynamicIpAndPortInterfaceAddress(BaseModel):
    """
    Translated source interface
    """ # noqa: E501
    floating_ip: Optional[StrictStr] = Field(default=None, description="Floating IP address")
    interface: Optional[StrictStr] = Field(default=None, description="Interface name")
    ip: Optional[StrictStr] = Field(default=None, description="Translated source IP address")
    __properties: ClassVar[List[str]] = ["floating_ip", "interface", "ip"]
