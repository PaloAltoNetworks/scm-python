...
class RouteAccessListsTypeIpv4Ipv4EntryInnerDestinationAddress(BaseModel):
    """
    ...
    entry: Optional[RouteAccessListsTypeIpv4Ipv4EntryInnerDestinationAddressEntry] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entry": RouteAccessListsTypeIpv4Ipv4EntryInnerDestinationAddressEntry.from_dict(obj["entry"]) if obj.get("entry") is not None else None
        })
        return _obj
