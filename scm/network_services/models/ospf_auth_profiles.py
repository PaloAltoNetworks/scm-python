...
class OspfAuthProfiles(BaseModel):
    """
    OspfAuthProfiles
    """ # noqa: E501
    ...
    md5: Optional[List[OspfAuthProfilesMd5Inner]] = Field(default=None, description="MD5s")
    ...
    __properties: ClassVar[List[str]] = ["device", "folder", "id", "md5", "name", "password", "snippet"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "md5": [OspfAuthProfilesMd5Inner.from_dict(_item) for _item in obj["md5"]] if obj.get("md5") is not None else None,
            "name": obj.get("name"),
