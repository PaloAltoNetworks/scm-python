...
class BgpRouteMaps(BaseModel):
    ...
    name: StrictStr
    route_map: Optional[List[BgpRouteMapsRouteMapInner]] = None
    ...
    __properties: ClassVar[List[str]] = ["description", "device", "folder", "id", "name", "route_map", "snippet"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "route_map": [BgpRouteMapsRouteMapInner.from_dict(_item) for _item in obj["route_map"]] if obj.get("route_map") is not None else None,
