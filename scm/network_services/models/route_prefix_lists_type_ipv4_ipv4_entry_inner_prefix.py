...
class RoutePrefixListsTypeIpv4Ipv4EntryInnerPrefix(BaseModel):
    """
    RoutePrefixListsTypeIpv4Ipv4EntryInnerPrefix
    """ # noqa: E501
    entry: Optional[RoutePrefixListsTypeIpv4Ipv4EntryInnerPrefixEntry] = None
    network: Optional[StrictStr] = Field(default=None, description="Network")
    __properties: ClassVar[List[str]] = ["entry", "network"]
    ...
    def network_validate_enum(cls, value):
        ...
        if value not in set(['any']):
            raise ValueError("must be one of enum values ('any')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entry": RoutePrefixListsTypeIpv4Ipv4EntryInnerPrefixEntry.from_dict(obj["entry"]) if obj.get("entry") is not None else None,
