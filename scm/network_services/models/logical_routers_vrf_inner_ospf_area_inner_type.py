...
class LogicalRoutersVrfInnerOspfAreaInnerType(BaseModel):
    """
    LogicalRoutersVrfInnerOspfAreaInnerType
    """ # noqa: E501
    normal: Optional[LogicalRoutersVrfInnerOspfAreaInnerTypeNormal] = None
    nssa: Optional[LogicalRoutersVrfInnerOspfAreaInnerTypeNssa] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "nssa": LogicalRoutersVrfInnerOspfAreaInnerTypeNssa.from_dict(obj["nssa"]) if obj.get("nssa") is not None else None,
