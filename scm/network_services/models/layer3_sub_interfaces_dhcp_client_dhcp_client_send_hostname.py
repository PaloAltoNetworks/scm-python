...
class Layer3SubInterfacesDhcpClientDhcpClientSendHostname(BaseModel):
    """
    Layer3 sub interfaces DHCP Client Send hostname
    """ # noqa: E501
    enable: Optional[StrictBool] = True
    hostname: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=64)]] = Field(default='system-hostname', description="Set interface hostname")
    __properties: ClassVar[List[str]] = ["enable", "hostname"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hostname": obj.get("hostname") if obj.get("hostname") is not None else 'system-hostname'
        })
        return _obj
