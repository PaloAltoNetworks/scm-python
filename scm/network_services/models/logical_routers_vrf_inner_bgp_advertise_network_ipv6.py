...
class LogicalRoutersVrfInnerBgpAdvertiseNetworkIpv6(BaseModel):
    """
    LogicalRoutersVrfInnerBgpAdvertiseNetworkIpv6
    """ # noqa: E501
    network: Optional[List[LogicalRoutersVrfInnerBgpAdvertiseNetworkIpv6NetworkInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "network": [LogicalRoutersVrfInnerBgpAdvertiseNetworkIpv6NetworkInner.from_dict(_item) for _item in obj["network"]] if obj.get("network") is not None else None
        })
        return _obj
