...
class BgpAddressFamilyMaximumPrefixActionRestart(BaseModel):
    """
    BgpAddressFamilyMaximumPrefixActionRestart
    """ # noqa: E501
    interval: Optional[Annotated[int, Field(le=65535, strict=True, ge=1)]] = Field(default=None, description="Restart interval")
