...
class RoutePrefixListsType(BaseModel):
    """
    Address Family Type
    """ # noqa: E501
    ipv4: RoutePrefixListsTypeIpv4
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ipv4": RoutePrefixListsTypeIpv4.from_dict(obj["ipv4"]) if obj.get("ipv4") is not None else None
        })
        return _obj
