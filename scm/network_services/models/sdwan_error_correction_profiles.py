...
class SdwanErrorCorrectionProfiles(BaseModel):
    """
    SdwanErrorCorrectionProfiles
    """ # noqa: E501
    activation_threshold: StrictInt
    ...
    __properties: ClassVar[List[str]] = ["activation_threshold", "device", "folder", "id", "mode", "name", "snippet"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activation_threshold": obj.get("activation_threshold"),
            "device": obj.get("device"),
            "folder": obj.get("folder"),
            "id": obj.get("id"),
            "mode": SdwanErrorCorrectionProfilesMode.from_dict(obj["mode"]) if obj.get("mode") is not None else None,
            "name": obj.get("name"),
