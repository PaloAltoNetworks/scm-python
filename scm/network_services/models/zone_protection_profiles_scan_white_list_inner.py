...
class ZoneProtectionProfilesScanWhiteListInner(BaseModel):
    """
    ZoneProtectionProfilesScanWhiteListInner
    """ # noqa: E501
    ipv4: Optional[StrictStr] = None
    ipv6: Optional[StrictStr] = None
    name: StrictStr = Field(description="A descriptive name for the address to exclude.")
    __properties: ClassVar[List[str]] = ["ipv4", "ipv6", "name"]
