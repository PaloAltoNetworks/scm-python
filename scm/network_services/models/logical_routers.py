...
class LogicalRouters(BaseModel):
    """
    LogicalRouters
    """ # noqa: E501
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in vrf (list)
        _items = []
        if self.vrf:
            for _item_vrf in self.vrf:
                if _item_vrf:
                    _items.append(_item_vrf.to_dict())
            _dict['vrf'] = _items
        return _dict
