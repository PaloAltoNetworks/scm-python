...
class AutoVpnSettingsAsRange(BaseModel):
    """
    AutoVpnSettingsAsRange
    """ # noqa: E501
    end: Optional[Annotated[int, Field(le=65535, strict=True, ge=1)]] = None
    start: Optional[Annotated[int, Field(le=65535, strict=True, ge=1)]] = None
