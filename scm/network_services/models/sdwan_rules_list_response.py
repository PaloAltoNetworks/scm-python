...
class SDWANRulesListResponse(BaseModel):
    """
    SDWANRulesListResponse
    """ # noqa: E501
    data: List[SdwanRules]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        if "data" not in obj and "total" not in obj:
            single_obj = SdwanRules.from_dict(obj)
        ...
        _obj = cls.model_validate({
            "data": [SdwanRules.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
