...
class LogicalRoutersVrfInnerBgpAdvertiseNetwork(BaseModel):
    """
    LogicalRoutersVrfInnerBgpAdvertiseNetwork
    """ # noqa: E501
    ipv4: Optional[LogicalRoutersVrfInnerBgpAdvertiseNetworkIpv4] = None
    ipv6: Optional[LogicalRoutersVrfInnerBgpAdvertiseNetworkIpv6] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ipv4": LogicalRoutersVrfInnerBgpAdvertiseNetworkIpv4.from_dict(obj["ipv4"]) if obj.get("ipv4") is not None else None,
            "ipv6": LogicalRoutersVrfInnerBgpAdvertiseNetworkIpv6.from_dict(obj["ipv6"]) if obj.get("ipv6") is not None else None
        })
        return _obj
