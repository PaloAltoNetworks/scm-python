...
class BgpRouteMapRedistributionsBgpRibRouteMapInnerSet(BaseModel):
    """
    Set attributes for BGP route map
    """ # noqa: E501
    source_address: Optional[StrictStr] = Field(default=None, description="BGP Root RIB Route maps set Source address")
