...
class LogicalRoutersVrfInnerRoutingTable(BaseModel):
    """
    LogicalRoutersVrfInnerRoutingTable
    """ # noqa: E501
    ip: Optional[LogicalRoutersVrfInnerRoutingTableIp] = None
    ipv6: Optional[LogicalRoutersVrfInnerRoutingTableIpv6] = None
    __properties: ClassVar[List[str]] = ["ip", "ipv6"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ip": LogicalRoutersVrfInnerRoutingTableIp.from_dict(obj["ip"]) if obj.get("ip") is not None else None,
            "ipv6": LogicalRoutersVrfInnerRoutingTableIpv6.from_dict(obj["ipv6"]) if obj.get("ipv6") is not None else None
        })
        return _obj
