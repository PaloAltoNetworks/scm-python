...
class IpsecTunnelsAutoKeyProxyIdV6Inner(BaseModel):
    """
    IPv6 type of proxy_id values for TCP protocol
    """ # noqa: E501
    local: Optional[StrictStr] = None
    name: StrictStr
    protocol: Optional[IpsecTunnelsAutoKeyProxyIdV6InnerProtocol] = None
    remote: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["local", "name", "protocol", "remote"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "local": obj.get("local"),
            "name": obj.get("name"),
            "protocol": IpsecTunnelsAutoKeyProxyIdV6InnerProtocol.from_dict(obj["protocol"]) if obj.get("protocol") is not None else None,
