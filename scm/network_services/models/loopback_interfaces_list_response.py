...
class LoopbackInterfacesListResponse(BaseModel):
    """
    LoopbackInterfacesListResponse
    """ # noqa: E501
    data: List[LoopbackInterfaces]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        if "data" not in obj and "total" not in obj:
            single_obj = LoopbackInterfaces.from_dict(obj)
        ...
        _obj = cls.model_validate({
            "data": [LoopbackInterfaces.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
