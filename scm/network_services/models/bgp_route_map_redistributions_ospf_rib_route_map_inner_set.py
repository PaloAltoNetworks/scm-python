...
class BgpRouteMapRedistributionsOspfRibRouteMapInnerSet(BaseModel):
    """
    OSPF RIB Route maps set
    """ # noqa: E501
    source_address: Optional[StrictStr] = Field(default=None, description="OSPF RIB Route maps set Source address")
