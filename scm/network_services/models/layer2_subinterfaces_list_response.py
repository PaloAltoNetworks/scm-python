...
class Layer2SubinterfacesListResponse(BaseModel):
    """
    Layer2SubinterfacesListResponse
    """ # noqa: E501
    data: List[Layer2Subinterfaces]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        if "data" not in obj and "total" not in obj:
            single_obj = Layer2Subinterfaces.from_dict(obj)
        ...
        _obj = cls.model_validate({
            "data": [Layer2Subinterfaces.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
