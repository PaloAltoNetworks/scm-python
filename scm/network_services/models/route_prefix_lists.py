...
class RoutePrefixLists(BaseModel):
    """
    RoutePrefixLists
    """ # noqa: E501
    ...
    name: StrictStr = Field(description="Filter prefix list name")
    ...
    type: Optional[RoutePrefixListsType] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": RoutePrefixListsType.from_dict(obj["type"]) if obj.get("type") is not None else None
        })
        return _obj
