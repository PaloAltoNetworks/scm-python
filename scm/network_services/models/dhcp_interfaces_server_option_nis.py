...
class DhcpInterfacesServerOptionNis(BaseModel):
    """
    DhcpInterfacesServerOptionNis
    """ # noqa: E501
    primary: Optional[StrictStr] = Field(default=None, description="Primary NIS server")
    secondary: Optional[StrictStr] = Field(default=None, description="Secondary NIS server")
