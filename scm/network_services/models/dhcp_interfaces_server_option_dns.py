...
class DhcpInterfacesServerOptionDns(BaseModel):
    """
    DhcpInterfacesServerOptionDns
    """ # noqa: E501
    primary: Optional[StrictStr] = Field(default=None, description="Primary DNS server")
    secondary: Optional[StrictStr] = Field(default=None, description="Secondary DNS server")
