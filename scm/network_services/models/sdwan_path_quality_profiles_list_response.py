...
class SDWANPathQualityProfilesListResponse(BaseModel):
    """
    SDWANPathQualityProfilesListResponse
    """ # noqa: E501
    data: List[SdwanPathQualityProfiles]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        if "data" not in obj and "total" not in obj:
            single_obj = SdwanPathQualityProfiles.from_dict(obj)
        ...
        _obj = cls.model_validate({
            "data": [SdwanPathQualityProfiles.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
