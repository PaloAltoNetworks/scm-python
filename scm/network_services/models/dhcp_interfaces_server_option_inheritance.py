...
class DhcpInterfacesServerOptionInheritance(BaseModel):
    """
    DhcpInterfacesServerOptionInheritance
    """ # noqa: E501
    source: Optional[StrictStr] = Field(default=None, description="Interface from which to inherit lease options")
