...
class BgpRouteMapRedistributions(BaseModel):
    """
    BgpRouteMapRedistributions
    """ # noqa: E501
    bgp: Optional[BgpRouteMapRedistributionsBgp] = None
    connected_static: Optional[BgpRouteMapRedistributionsConnectedStatic] = None
    description: Optional[StrictStr] = Field(default=None, description="BGP Route Map Redistributions Description")
    ...
    id: Optional[StrictStr] = Field(default=None, description="BGP Route Map Redistributions UUID of the resource")
    name: StrictStr = Field(description="BGP Route Map Redistributions Name")
    ospf: Optional[BgpRouteMapRedistributionsOspf] = None
    ...
    __properties: ClassVar[List[str]] = ["bgp", "connected_static", "description", "device", "folder", "id", "name", "ospf", "snippet"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of connected_static
        if self.connected_static:
            _dict['connected_static'] = self.connected_static.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bgp": BgpRouteMapRedistributionsBgp.from_dict(obj["bgp"]) if obj.get("bgp") is not None else None,
            "connected_static": BgpRouteMapRedistributionsConnectedStatic.from_dict(obj["connected_static"]) if obj.get("connected_static") is not None else None,
            "description": obj.get("description"),
            "device": obj.get("device"),
            "folder": obj.get("folder"),
            "id": obj.get("id"),
            "name": obj.get("name"),
            "ospf": BgpRouteMapRedistributionsOspf.from_dict(obj["ospf"]) if obj.get("ospf") is not None else None,
