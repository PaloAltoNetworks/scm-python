...
class BgpRedistributionProfiles(BaseModel):
    """
    ...
    ipv4: BgpRedistributionProfilesIpv4
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "ipv4": BgpRedistributionProfilesIpv4.from_dict(obj["ipv4"]) if obj.get("ipv4") is not None else None,
            "name": obj.get("name"),
