...
class RouteCommunityListsType(BaseModel):
    """
    RouteCommunityListsType
    """ # noqa: E501
    extended: Optional[RouteCommunityListsTypeExtended] = None
    large: Optional[RouteCommunityListsTypeLarge] = None
    regular: Optional[RouteCommunityListsTypeRegular] = None
    __properties: ClassVar[List[str]] = ["extended", "large", "regular"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "extended": RouteCommunityListsTypeExtended.from_dict(obj["extended"]) if obj.get("extended") is not None else None,
            "large": RouteCommunityListsTypeLarge.from_dict(obj["large"]) if obj.get("large") is not None else None,
            "regular": RouteCommunityListsTypeRegular.from_dict(obj["regular"]) if obj.get("regular") is not None else None
        })
        return _obj
