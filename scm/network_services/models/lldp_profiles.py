...
class LldpProfiles(BaseModel):
    ...
    mode: Optional[StrictStr] = Field(default=None, description="LLDP mode")
    name: StrictStr = Field(description="LLDP profile name")
    option_tlvs: Optional[LldpProfilesOptionTlvs] = None
    ...
    snmp_syslog_notification: Optional[StrictBool] = Field(default=None, description="SNMP syslog notification")
    __properties: ClassVar[List[str]] = ["device", "folder", "id", "mode", "name", "option_tlvs", "snippet", "snmp_syslog_notification"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of option_tlvs
        if self.option_tlvs:
            _dict['option_tlvs'] = self.option_tlvs.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mode": obj.get("mode"),
            "name": obj.get("name"),
            "option_tlvs": LldpProfilesOptionTlvs.from_dict(obj["option_tlvs"]) if obj.get("option_tlvs") is not None else None,
            "snippet": obj.get("snippet"),
            "snmp_syslog_notification": obj.get("snmp_syslog_notification")
        })
        return _obj
