...
class LogicalRoutersVrfInnerBgpPolicyExportRulesInnerAction(BaseModel):
    """
    LogicalRoutersVrfInnerBgpPolicyExportRulesInnerAction
    """ # noqa: E501
    allow: Optional[LogicalRoutersVrfInnerBgpPolicyExportRulesInnerActionAllow] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "allow": LogicalRoutersVrfInnerBgpPolicyExportRulesInnerActionAllow.from_dict(obj["allow"]) if obj.get("allow") is not None else None,
            "deny": obj.get("deny")
        })
        return _obj
