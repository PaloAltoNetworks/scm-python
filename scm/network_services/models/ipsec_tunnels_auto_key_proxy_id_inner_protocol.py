...
class IpsecTunnelsAutoKeyProxyIdInnerProtocol(BaseModel):
    """
    ...
    tcp: Optional[IpsecTunnelsAutoKeyProxyIdInnerProtocolTcp] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tcp": IpsecTunnelsAutoKeyProxyIdInnerProtocolTcp.from_dict(obj["tcp"]) if obj.get("tcp") is not None else None,
