...
class LogicalRoutersVrfInnerMulticastRpLocalRpCandidateRp(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["address", "advertisement_interval", "group_addresses", "interface", "priority"]
