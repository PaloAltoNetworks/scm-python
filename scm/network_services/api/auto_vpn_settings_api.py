...
class AutoVPNSettingsApi:
    ...
    def fetch_auto_vpn_settings(
        ...
        **kwargs
        ...
        """
        Fetch a single auto_vpn_settings object by name.
        ...
        Example:
            >>> obj = api.fetch_auto_vpn_settings(name="my-object", folder="Texas")
            >>> if obj:
        ...
        while True:
            ...
            response = self.list_auto_vpn_settings(**list_params)
