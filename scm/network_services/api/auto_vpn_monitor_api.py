...
class AutoVPNMonitorApi:
    ...
    def fetch_auto_vpn_monitor(
        ...
        **kwargs
        ...
        """
        Fetch a single auto_vpn_monitor object by name.
        ...
        Example:
            >>> obj = api.fetch_auto_vpn_monitor(name="my-object", folder="Texas")
            >>> if obj:
        ...
        while True:
            ...
            response = self.list_auto_vpn_monitor(**list_params)
