# scm_network_services.BGPFilteringProfilesApi
...
with scm_network_services.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_network_services.BGPFilteringProfilesApi(api_client)
    bgp_filtering_profiles = scm_network_services.BgpFilteringProfiles() # BgpFilteringProfiles | Created (optional)
...
with scm_network_services.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_network_services.BGPFilteringProfilesApi(api_client)
    id = '123e4567-e89b-12d3-a456-426655440000' # str | The UUID of the configuration resource
    bgp_filtering_profiles = scm_network_services.BgpFilteringProfiles() # BgpFilteringProfiles | OK (optional)
