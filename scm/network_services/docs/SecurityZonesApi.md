# scm_network_services.SecurityZonesApi
...
with scm_network_services.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_network_services.SecurityZonesApi(api_client)
    zones = scm_network_services.Zones() # Zones | Created (optional)
...
with scm_network_services.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_network_services.SecurityZonesApi(api_client)
    id = '123e4567-e89b-12d3-a456-426655440000' # str | The UUID of the configuration resource
    zones = scm_network_services.Zones() # Zones | OK (optional)
