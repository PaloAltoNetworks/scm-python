# scm_network_services.BGPAddressFamilyProfilesApi
...
with scm_network_services.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_network_services.BGPAddressFamilyProfilesApi(api_client)
    bgp_address_family_profiles = scm_network_services.BgpAddressFamilyProfiles() # BgpAddressFamilyProfiles | Created (optional)
...
with scm_network_services.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_network_services.BGPAddressFamilyProfilesApi(api_client)
    id = '123e4567-e89b-12d3-a456-426655440000' # str | The UUID of the configuration resource
    bgp_address_family_profiles = scm_network_services.BgpAddressFamilyProfiles() # BgpAddressFamilyProfiles | OK (optional)
