# scm.network_services.ZoneProtectionProfilesApi
...
with scm.network_services.ApiClient(configuration) as api_client:
    ...
    api_instance = scm.network_services.ZoneProtectionProfilesApi(api_client)
    zone_protection_profiles = scm.network_services.ZoneProtectionProfiles() # ZoneProtectionProfiles | Created (optional)
...
with scm.network_services.ApiClient(configuration) as api_client:
    ...
    api_instance = scm.network_services.ZoneProtectionProfilesApi(api_client)
    id = '123e4567-e89b-12d3-a456-426655440000' # str | The UUID of the configuration resource
    zone_protection_profiles = scm.network_services.ZoneProtectionProfiles() # ZoneProtectionProfiles | OK (optional)
