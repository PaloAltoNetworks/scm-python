# scm_network_services.DHCPInterfacesApi
...
with scm_network_services.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_network_services.DHCPInterfacesApi(api_client)
    dhcp_interfaces = scm_network_services.DhcpInterfaces() # DhcpInterfaces | Created (optional)
...
with scm_network_services.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_network_services.DHCPInterfacesApi(api_client)
    id = '123e4567-e89b-12d3-a456-426655440000' # str | The UUID of the configuration resource
    dhcp_interfaces = scm_network_services.DhcpInterfaces() # DhcpInterfaces | OK (optional)
