# scm_network_services.IPsecTunnelsApi
...
with scm_network_services.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_network_services.IPsecTunnelsApi(api_client)
    ipsec_tunnels = scm_network_services.IpsecTunnels() # IpsecTunnels | Created (optional)
...
with scm_network_services.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_network_services.IPsecTunnelsApi(api_client)
    id = '123e4567-e89b-12d3-a456-426655440000' # str | The UUID of the configuration resource
    ipsec_tunnels = scm_network_services.IpsecTunnels() # IpsecTunnels | OK (optional)
