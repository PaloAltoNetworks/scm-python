# scm_network_services.SDWANRulesApi
...
with scm_network_services.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_network_services.SDWANRulesApi(api_client)
    sdwan_rules = scm_network_services.SdwanRules() # SdwanRules | Created (optional)
...
with scm_network_services.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_network_services.SDWANRulesApi(api_client)
    id = '123e4567-e89b-12d3-a456-426655440000' # str | The UUID of the configuration resource
    sdwan_rules = scm_network_services.SdwanRules() # SdwanRules | OK (optional)
