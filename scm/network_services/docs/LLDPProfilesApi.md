# scm_network_services.LLDPProfilesApi
...
with scm_network_services.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_network_services.LLDPProfilesApi(api_client)
    lldp_profiles = scm_network_services.LldpProfiles() # LldpProfiles | Created (optional)
...
with scm_network_services.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_network_services.LLDPProfilesApi(api_client)
    id = '123e4567-e89b-12d3-a456-426655440000' # str | The UUID of the configuration resource
    lldp_profiles = scm_network_services.LldpProfiles() # LldpProfiles | OK (optional)
