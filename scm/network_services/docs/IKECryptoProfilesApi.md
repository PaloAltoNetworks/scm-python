# scm.network_services.IKECryptoProfilesApi
...
with scm.network_services.ApiClient(configuration) as api_client:
    ...
    api_instance = scm.network_services.IKECryptoProfilesApi(api_client)
    ike_crypto_profiles = scm.network_services.IkeCryptoProfiles() # IkeCryptoProfiles | Created (optional)
...
with scm.network_services.ApiClient(configuration) as api_client:
    ...
    api_instance = scm.network_services.IKECryptoProfilesApi(api_client)
    id = '123e4567-e89b-12d3-a456-426655440000' # str | The UUID of the configuration resource
    ike_crypto_profiles = scm.network_services.IkeCryptoProfiles() # IkeCryptoProfiles | OK (optional)
