...
def dependency_profiles(http_server_profiles_api, syslog_server_profiles_api):
    """
    Creates HTTP and Syslog server profiles as dependencies for Config Match List.
    """
...
@pytest.fixture
def clean_config_match_list(config_match_list_api, dependency_profiles):
    """
...
def test_create_config_match_list(config_match_list_api, dependency_profiles):
    """
...
def test_delete_config_match_list_by_id(config_match_list_api, dependency_profiles):
    """
