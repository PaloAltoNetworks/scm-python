...
class TestAutoVpnClustersBranchesInnerInterfacesInner(unittest.TestCase):
    """AutoVpnClustersBranchesInnerInterfacesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutoVpnClustersBranchesInnerInterfacesInner:
        """Test AutoVpnClustersBranchesInnerInterfacesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutoVpnClustersBranchesInnerInterfacesInner`
        """
        model = AutoVpnClustersBranchesInnerInterfacesInner()
        if include_optional:
            return AutoVpnClustersBranchesInnerInterfacesInner(
                dhcp_ip = '',
                name = '',
    ...
    def testAutoVpnClustersBranchesInnerInterfacesInner(self):
        """Test AutoVpnClustersBranchesInnerInterfacesInner"""
