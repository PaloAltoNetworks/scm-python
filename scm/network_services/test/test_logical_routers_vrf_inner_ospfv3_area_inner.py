...
class TestLogicalRoutersVrfInnerOspfv3AreaInner(unittest.TestCase):
    """LogicalRoutersVrfInnerOspfv3AreaInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LogicalRoutersVrfInnerOspfv3AreaInner:
        """Test LogicalRoutersVrfInnerOspfv3AreaInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogicalRoutersVrfInnerOspfv3AreaInner`
        """
        model = LogicalRoutersVrfInnerOspfv3AreaInner()
        if include_optional:
            return LogicalRoutersVrfInnerOspfv3AreaInner(
                authentication = '',
                interface = [
    ...
    def testLogicalRoutersVrfInnerOspfv3AreaInner(self):
        """Test LogicalRoutersVrfInnerOspfv3AreaInner"""
