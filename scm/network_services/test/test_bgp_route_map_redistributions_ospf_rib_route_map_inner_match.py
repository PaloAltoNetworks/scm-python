...
class TestBgpRouteMapRedistributionsOspfRibRouteMapInnerMatch(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BgpRouteMapRedistributionsOspfRibRouteMapInnerMatch:
        """Test BgpRouteMapRedistributionsOspfRibRouteMapInnerMatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BgpRouteMapRedistributionsOspfRibRouteMapInnerMatch`
        """
    ...
    def testBgpRouteMapRedistributionsOspfRibRouteMapInnerMatch(self):
        """Test BgpRouteMapRedistributionsOspfRibRouteMapInnerMatch"""
