...
class TestBgpAddressFamily(unittest.TestCase):
    """BgpAddressFamily unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BgpAddressFamily:
        """Test BgpAddressFamily
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BgpAddressFamily`
        """
