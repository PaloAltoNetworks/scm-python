...
class TestLogicalRoutersVrfInnerBgpPolicyAggregationAddressInnerAggregateRouteAttributes(unittest.TestCase):
    """LogicalRoutersVrfInnerBgpPolicyAggregationAddressInnerAggregateRouteAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LogicalRoutersVrfInnerBgpPolicyAggregationAddressInnerAggregateRouteAttributes:
        """Test LogicalRoutersVrfInnerBgpPolicyAggregationAddressInnerAggregateRouteAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogicalRoutersVrfInnerBgpPolicyAggregationAddressInnerAggregateRouteAttributes`
        """
        model = LogicalRoutersVrfInnerBgpPolicyAggregationAddressInnerAggregateRouteAttributes()
        if include_optional:
            return LogicalRoutersVrfInnerBgpPolicyAggregationAddressInnerAggregateRouteAttributes(
    ...
    def testLogicalRoutersVrfInnerBgpPolicyAggregationAddressInnerAggregateRouteAttributes(self):
        """Test LogicalRoutersVrfInnerBgpPolicyAggregationAddressInnerAggregateRouteAttributes"""
