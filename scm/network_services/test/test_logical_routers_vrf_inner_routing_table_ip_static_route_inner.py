...
class TestLogicalRoutersVrfInnerRoutingTableIpStaticRouteInner(unittest.TestCase):
    """LogicalRoutersVrfInnerRoutingTableIpStaticRouteInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LogicalRoutersVrfInnerRoutingTableIpStaticRouteInner:
        """Test LogicalRoutersVrfInnerRoutingTableIpStaticRouteInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogicalRoutersVrfInnerRoutingTableIpStaticRouteInner`
        """
        model = LogicalRoutersVrfInnerRoutingTableIpStaticRouteInner()
        if include_optional:
            return LogicalRoutersVrfInnerRoutingTableIpStaticRouteInner(
                admin_dist = 56,
    ...
    def testLogicalRoutersVrfInnerRoutingTableIpStaticRouteInner(self):
        """Test LogicalRoutersVrfInnerRoutingTableIpStaticRouteInner"""
