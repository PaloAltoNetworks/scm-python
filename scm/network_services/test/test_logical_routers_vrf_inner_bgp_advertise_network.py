...
class TestLogicalRoutersVrfInnerBgpAdvertiseNetwork(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LogicalRoutersVrfInnerBgpAdvertiseNetwork:
        """Test LogicalRoutersVrfInnerBgpAdvertiseNetwork
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogicalRoutersVrfInnerBgpAdvertiseNetwork`
        """
    ...
    def testLogicalRoutersVrfInnerBgpAdvertiseNetwork(self):
        """Test LogicalRoutersVrfInnerBgpAdvertiseNetwork"""
