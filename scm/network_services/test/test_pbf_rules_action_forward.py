...
class TestPbfRulesActionForward(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PbfRulesActionForward:
        """Test PbfRulesActionForward
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PbfRulesActionForward`
        """
        model = PbfRulesActionForward()
        if include_optional:
    ...
    def testPbfRulesActionForward(self):
        """Test PbfRulesActionForward"""
