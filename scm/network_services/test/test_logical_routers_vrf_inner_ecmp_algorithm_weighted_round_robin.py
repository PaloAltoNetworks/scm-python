...
class TestLogicalRoutersVrfInnerEcmpAlgorithmWeightedRoundRobin(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LogicalRoutersVrfInnerEcmpAlgorithmWeightedRoundRobin:
        """Test LogicalRoutersVrfInnerEcmpAlgorithmWeightedRoundRobin
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogicalRoutersVrfInnerEcmpAlgorithmWeightedRoundRobin`
        """
        model = LogicalRoutersVrfInnerEcmpAlgorithmWeightedRoundRobin()
        if include_optional:
    ...
    def testLogicalRoutersVrfInnerEcmpAlgorithmWeightedRoundRobin(self):
        """Test LogicalRoutersVrfInnerEcmpAlgorithmWeightedRoundRobin"""
