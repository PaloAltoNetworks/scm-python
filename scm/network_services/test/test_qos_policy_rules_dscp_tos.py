...
class TestQosPolicyRulesDscpTos(unittest.TestCase):
    """QosPolicyRulesDscpTos unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QosPolicyRulesDscpTos:
        """Test QosPolicyRulesDscpTos
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QosPolicyRulesDscpTos`
        """
        model = QosPolicyRulesDscpTos()
        if include_optional:
            return QosPolicyRulesDscpTos(
                codepoints = [
    ...
    def testQosPolicyRulesDscpTos(self):
        """Test QosPolicyRulesDscpTos"""
