...
class TestLogicalRoutersVrfInnerBgpPolicyExportRulesInnerActionAllow(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LogicalRoutersVrfInnerBgpPolicyExportRulesInnerActionAllow:
        """Test LogicalRoutersVrfInnerBgpPolicyExportRulesInnerActionAllow
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogicalRoutersVrfInnerBgpPolicyExportRulesInnerActionAllow`
        """
    ...
    def testLogicalRoutersVrfInnerBgpPolicyExportRulesInnerActionAllow(self):
        """Test LogicalRoutersVrfInnerBgpPolicyExportRulesInnerActionAllow"""
