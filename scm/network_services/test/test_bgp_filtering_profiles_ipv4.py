...
class TestBgpFilteringProfilesIpv4(unittest.TestCase):
    """BgpFilteringProfilesIpv4 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BgpFilteringProfilesIpv4:
        """Test BgpFilteringProfilesIpv4
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BgpFilteringProfilesIpv4`
        """
        model = BgpFilteringProfilesIpv4()
        if include_optional:
            return BgpFilteringProfilesIpv4(
    ...
    def testBgpFilteringProfilesIpv4(self):
        """Test BgpFilteringProfilesIpv4"""
