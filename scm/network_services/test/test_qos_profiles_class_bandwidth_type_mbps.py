...
class TestQosProfilesClassBandwidthTypeMbps(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> QosProfilesClassBandwidthTypeMbps:
        """Test QosProfilesClassBandwidthTypeMbps
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QosProfilesClassBandwidthTypeMbps`
        """
        model = QosProfilesClassBandwidthTypeMbps()
        if include_optional:
    ...
    def testQosProfilesClassBandwidthTypeMbps(self):
        """Test QosProfilesClassBandwidthTypeMbps"""
