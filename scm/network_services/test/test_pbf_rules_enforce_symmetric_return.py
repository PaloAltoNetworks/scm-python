...
class TestPbfRulesEnforceSymmetricReturn(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PbfRulesEnforceSymmetricReturn:
        """Test PbfRulesEnforceSymmetricReturn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PbfRulesEnforceSymmetricReturn`
        """
        model = PbfRulesEnforceSymmetricReturn()
        if include_optional:
    ...
    def testPbfRulesEnforceSymmetricReturn(self):
        """Test PbfRulesEnforceSymmetricReturn"""
