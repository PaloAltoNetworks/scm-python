...
class TestLogicalRoutersVrfInnerBgpPeerGroupInnerType(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LogicalRoutersVrfInnerBgpPeerGroupInnerType:
        """Test LogicalRoutersVrfInnerBgpPeerGroupInnerType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogicalRoutersVrfInnerBgpPeerGroupInnerType`
        """
    ...
    def testLogicalRoutersVrfInnerBgpPeerGroupInnerType(self):
        """Test LogicalRoutersVrfInnerBgpPeerGroupInnerType"""
