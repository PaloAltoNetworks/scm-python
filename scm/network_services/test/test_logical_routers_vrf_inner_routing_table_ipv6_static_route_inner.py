...
class TestLogicalRoutersVrfInnerRoutingTableIpv6StaticRouteInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LogicalRoutersVrfInnerRoutingTableIpv6StaticRouteInner:
        """Test LogicalRoutersVrfInnerRoutingTableIpv6StaticRouteInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogicalRoutersVrfInnerRoutingTableIpv6StaticRouteInner`
        """
        model = LogicalRoutersVrfInnerRoutingTableIpv6StaticRouteInner()
        if include_optional:
    ...
    def testLogicalRoutersVrfInnerRoutingTableIpv6StaticRouteInner(self):
        """Test LogicalRoutersVrfInnerRoutingTableIpv6StaticRouteInner"""
