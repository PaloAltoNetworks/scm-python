...
class TestIpsecTunnelsAutoKeyProxyIdInnerProtocol(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IpsecTunnelsAutoKeyProxyIdInnerProtocol:
        """Test IpsecTunnelsAutoKeyProxyIdInnerProtocol
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IpsecTunnelsAutoKeyProxyIdInnerProtocol`
        """
        model = IpsecTunnelsAutoKeyProxyIdInnerProtocol()
        if include_optional:
    ...
    def testIpsecTunnelsAutoKeyProxyIdInnerProtocol(self):
        """Test IpsecTunnelsAutoKeyProxyIdInnerProtocol"""
