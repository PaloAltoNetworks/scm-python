    ...
    def make_instance(self, include_optional) -> DhcpInterfaces:
        ...
        if include_optional:
            return DhcpInterfaces(
                ...
                name = '',
                relay = scm_network_services.models.dhcp_interfaces_relay.dhcp_interfaces_relay(
                    ip = scm_network_services.models.dhcp_interfaces_relay_ip.dhcp_interfaces_relay_ip(
                        enabled = True, 
                        server = [
                            ''
                            ], ), ),
                server = scm_network_services.models.dhcp_interfaces_server.dhcp_interfaces_server(
                    ip_pool = [
                        ''
                        ], 
                    mode = 'auto', 
