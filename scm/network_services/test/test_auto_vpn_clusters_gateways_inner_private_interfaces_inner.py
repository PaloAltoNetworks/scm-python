...
class TestAutoVpnClustersGatewaysInnerPrivateInterfacesInner(unittest.TestCase):
    """AutoVpnClustersGatewaysInnerPrivateInterfacesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutoVpnClustersGatewaysInnerPrivateInterfacesInner:
        """Test AutoVpnClustersGatewaysInnerPrivateInterfacesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutoVpnClustersGatewaysInnerPrivateInterfacesInner`
        """
        model = AutoVpnClustersGatewaysInnerPrivateInterfacesInner()
        if include_optional:
            return AutoVpnClustersGatewaysInnerPrivateInterfacesInner(
                name = '',
    ...
    def testAutoVpnClustersGatewaysInnerPrivateInterfacesInner(self):
        """Test AutoVpnClustersGatewaysInnerPrivateInterfacesInner"""
