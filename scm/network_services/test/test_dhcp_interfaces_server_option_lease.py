...
class TestDhcpInterfacesServerOptionLease(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DhcpInterfacesServerOptionLease:
        """Test DhcpInterfacesServerOptionLease
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DhcpInterfacesServerOptionLease`
        """
        model = DhcpInterfacesServerOptionLease()
        if include_optional:
    ...
    def testDhcpInterfacesServerOptionLease(self):
        """Test DhcpInterfacesServerOptionLease"""
