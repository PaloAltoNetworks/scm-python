...
class TestAutoVpnClustersGatewaysInnerInterfacesInner(unittest.TestCase):
    """AutoVpnClustersGatewaysInnerInterfacesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutoVpnClustersGatewaysInnerInterfacesInner:
        """Test AutoVpnClustersGatewaysInnerInterfacesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutoVpnClustersGatewaysInnerInterfacesInner`
        """
        model = AutoVpnClustersGatewaysInnerInterfacesInner()
        if include_optional:
            return AutoVpnClustersGatewaysInnerInterfacesInner(
                dhcp_ip = '',
                name = '',
    ...
    def testAutoVpnClustersGatewaysInnerInterfacesInner(self):
        """Test AutoVpnClustersGatewaysInnerInterfacesInner"""
