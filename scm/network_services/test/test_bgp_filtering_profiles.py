...
class TestBgpFilteringProfiles(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BgpFilteringProfiles:
        """Test BgpFilteringProfiles
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BgpFilteringProfiles`
        """
        model = BgpFilteringProfiles()
        if include_optional:
    ...
    def testBgpFilteringProfiles(self):
        """Test BgpFilteringProfiles"""
