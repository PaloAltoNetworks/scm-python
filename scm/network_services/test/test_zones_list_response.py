...
class TestZonesListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ZonesListResponse:
        """Test ZonesListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ZonesListResponse`
        """
    ...
    def testZonesListResponse(self):
        """Test ZonesListResponse"""
