...
class TestLogicalRoutersVrfInnerBgpPolicyImportRulesInner(unittest.TestCase):
    """LogicalRoutersVrfInnerBgpPolicyImportRulesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LogicalRoutersVrfInnerBgpPolicyImportRulesInner:
        """Test LogicalRoutersVrfInnerBgpPolicyImportRulesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogicalRoutersVrfInnerBgpPolicyImportRulesInner`
        """
        model = LogicalRoutersVrfInnerBgpPolicyImportRulesInner()
        if include_optional:
            return LogicalRoutersVrfInnerBgpPolicyImportRulesInner(
    ...
    def testLogicalRoutersVrfInnerBgpPolicyImportRulesInner(self):
        """Test LogicalRoutersVrfInnerBgpPolicyImportRulesInner"""
