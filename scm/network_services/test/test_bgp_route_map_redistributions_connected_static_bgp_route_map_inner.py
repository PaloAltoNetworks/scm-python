...
class TestBgpRouteMapRedistributionsConnectedStaticBgpRouteMapInner(unittest.TestCase):
    """BgpRouteMapRedistributionsConnectedStaticBgpRouteMapInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BgpRouteMapRedistributionsConnectedStaticBgpRouteMapInner:
        """Test BgpRouteMapRedistributionsConnectedStaticBgpRouteMapInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BgpRouteMapRedistributionsConnectedStaticBgpRouteMapInner`
        """
        model = BgpRouteMapRedistributionsConnectedStaticBgpRouteMapInner()
        if include_optional:
            return BgpRouteMapRedistributionsConnectedStaticBgpRouteMapInner(
                action = 'permit',
                description = '',
    ...
    def testBgpRouteMapRedistributionsConnectedStaticBgpRouteMapInner(self):
        """Test BgpRouteMapRedistributionsConnectedStaticBgpRouteMapInner"""
