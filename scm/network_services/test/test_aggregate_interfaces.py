...
class TestAggregateInterfaces(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AggregateInterfaces:
        """Test AggregateInterfaces
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AggregateInterfaces`
        """
        model = AggregateInterfaces()
        if include_optional:
    ...
    def testAggregateInterfaces(self):
        """Test AggregateInterfaces"""
