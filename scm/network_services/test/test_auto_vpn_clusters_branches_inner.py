...
class TestAutoVpnClustersBranchesInner(unittest.TestCase):
    """AutoVpnClustersBranchesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutoVpnClustersBranchesInner:
        """Test AutoVpnClustersBranchesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutoVpnClustersBranchesInner`
        """
        model = AutoVpnClustersBranchesInner()
        if include_optional:
            return AutoVpnClustersBranchesInner(
    ...
    def testAutoVpnClustersBranchesInner(self):
        """Test AutoVpnClustersBranchesInner"""
