...
class TestLogicalRoutersVrfInnerOspfAreaInnerType(unittest.TestCase):
    """LogicalRoutersVrfInnerOspfAreaInnerType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LogicalRoutersVrfInnerOspfAreaInnerType:
        """Test LogicalRoutersVrfInnerOspfAreaInnerType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogicalRoutersVrfInnerOspfAreaInnerType`
        """
        model = LogicalRoutersVrfInnerOspfAreaInnerType()
        if include_optional:
            return LogicalRoutersVrfInnerOspfAreaInnerType(
    ...
    def testLogicalRoutersVrfInnerOspfAreaInnerType(self):
        """Test LogicalRoutersVrfInnerOspfAreaInnerType"""
