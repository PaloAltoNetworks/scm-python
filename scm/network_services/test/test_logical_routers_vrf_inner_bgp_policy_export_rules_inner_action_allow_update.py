...
class TestLogicalRoutersVrfInnerBgpPolicyExportRulesInnerActionAllowUpdate(unittest.TestCase):
    """LogicalRoutersVrfInnerBgpPolicyExportRulesInnerActionAllowUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LogicalRoutersVrfInnerBgpPolicyExportRulesInnerActionAllowUpdate:
        """Test LogicalRoutersVrfInnerBgpPolicyExportRulesInnerActionAllowUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogicalRoutersVrfInnerBgpPolicyExportRulesInnerActionAllowUpdate`
        """
        model = LogicalRoutersVrfInnerBgpPolicyExportRulesInnerActionAllowUpdate()
        if include_optional:
            return LogicalRoutersVrfInnerBgpPolicyExportRulesInnerActionAllowUpdate(
    ...
    def testLogicalRoutersVrfInnerBgpPolicyExportRulesInnerActionAllowUpdate(self):
        """Test LogicalRoutersVrfInnerBgpPolicyExportRulesInnerActionAllowUpdate"""
