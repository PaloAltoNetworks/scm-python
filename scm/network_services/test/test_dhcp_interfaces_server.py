...
class TestDhcpInterfacesServer(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DhcpInterfacesServer:
        """Test DhcpInterfacesServer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DhcpInterfacesServer`
        """
        model = DhcpInterfacesServer()
        if include_optional:
            return DhcpInterfacesServer(
                ip_pool = [
                    ''
                    ],
                mode = 'auto',
    ...
    def testDhcpInterfacesServer(self):
        """Test DhcpInterfacesServer"""
