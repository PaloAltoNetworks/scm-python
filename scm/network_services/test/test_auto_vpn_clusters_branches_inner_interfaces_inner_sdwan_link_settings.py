...
class TestAutoVpnClustersBranchesInnerInterfacesInnerSdwanLinkSettings(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AutoVpnClustersBranchesInnerInterfacesInnerSdwanLinkSettings:
        """Test AutoVpnClustersBranchesInnerInterfacesInnerSdwanLinkSettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutoVpnClustersBranchesInnerInterfacesInnerSdwanLinkSettings`
        """
        model = AutoVpnClustersBranchesInnerInterfacesInnerSdwanLinkSettings()
        if include_optional:
    ...
    def testAutoVpnClustersBranchesInnerInterfacesInnerSdwanLinkSettings(self):
        """Test AutoVpnClustersBranchesInnerInterfacesInnerSdwanLinkSettings"""
