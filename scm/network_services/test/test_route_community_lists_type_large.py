...
class TestRouteCommunityListsTypeLarge(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RouteCommunityListsTypeLarge:
        """Test RouteCommunityListsTypeLarge
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RouteCommunityListsTypeLarge`
        """
        model = RouteCommunityListsTypeLarge()
        if include_optional:
    ...
    def testRouteCommunityListsTypeLarge(self):
        """Test RouteCommunityListsTypeLarge"""
