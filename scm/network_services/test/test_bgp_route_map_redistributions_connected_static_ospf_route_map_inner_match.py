...
class TestBgpRouteMapRedistributionsConnectedStaticOspfRouteMapInnerMatch(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BgpRouteMapRedistributionsConnectedStaticOspfRouteMapInnerMatch:
        """Test BgpRouteMapRedistributionsConnectedStaticOspfRouteMapInnerMatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BgpRouteMapRedistributionsConnectedStaticOspfRouteMapInnerMatch`
        """
        model = BgpRouteMapRedistributionsConnectedStaticOspfRouteMapInnerMatch()
        if include_optional:
    ...
    def testBgpRouteMapRedistributionsConnectedStaticOspfRouteMapInnerMatch(self):
        """Test BgpRouteMapRedistributionsConnectedStaticOspfRouteMapInnerMatch"""
