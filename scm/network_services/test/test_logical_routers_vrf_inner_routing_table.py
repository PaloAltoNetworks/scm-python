...
class TestLogicalRoutersVrfInnerRoutingTable(unittest.TestCase):
    """LogicalRoutersVrfInnerRoutingTable unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LogicalRoutersVrfInnerRoutingTable:
        """Test LogicalRoutersVrfInnerRoutingTable
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogicalRoutersVrfInnerRoutingTable`
        """
        model = LogicalRoutersVrfInnerRoutingTable()
        if include_optional:
            return LogicalRoutersVrfInnerRoutingTable(
                ...
                ipv6 = scm_network_services.models.logical_routers_vrf_inner_routing_table_ipv6.logical_routers_vrf_inner_routing_table_ipv6(
                    static_route = [
                        scm_network_services.models.logical_routers_vrf_inner_routing_table_ipv6_static_route_inner.logical_routers_vrf_inner_routing_table_ipv6_static_route_inner(
                            admin_dist = 56, 
                            bfd = scm_network_services.models.logical_routers_vrf_inner_bgp_global_bfd.logical_routers_vrf_inner_bgp_global_bfd(
                                profile = '', ), 
                            destination = '', 
    ...
    def testLogicalRoutersVrfInnerRoutingTable(self):
        """Test LogicalRoutersVrfInnerRoutingTable"""
