...
with scm_config_setup.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_config_setup.FoldersApi(api_client)
    folders = scm_config_setup.Folders() # Folders | The `folder` resource definition (optional)
