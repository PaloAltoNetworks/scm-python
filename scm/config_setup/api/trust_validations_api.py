...
class TrustValidationsApi:
    ...
    def fetch_trust_validations(
        ...
        **kwargs
        ...
        """
        Fetch a single trust_validations object by name.
        ...
        Example:
            >>> obj = api.fetch_trust_validations(name="my-object", folder="Texas")
            >>> if obj:
        ...
        while True:
            ...
            response = self.list_trust_validations(**list_params)
