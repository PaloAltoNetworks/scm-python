...
class TestLabelsListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LabelsListResponse:
        """Test LabelsListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LabelsListResponse`
        """
        model = LabelsListResponse()
        if include_optional:
    ...
    def testLabelsListResponse(self):
        """Test LabelsListResponse"""
