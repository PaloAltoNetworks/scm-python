...
class TestTrustsValidationPayload(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TrustsValidationPayload:
        """Test TrustsValidationPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrustsValidationPayload`
        """
        model = TrustsValidationPayload()
        if include_optional:
            return TrustsValidationPayload(
                donor_tenant_name = '',
                psk = '',
    ...
    def testTrustsValidationPayload(self):
        """Test TrustsValidationPayload"""
