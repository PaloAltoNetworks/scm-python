...
class TestSnippetSnapshotCompareEntry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SnippetSnapshotCompareEntry:
        """Test SnippetSnapshotCompareEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SnippetSnapshotCompareEntry`
        """
        model = SnippetSnapshotCompareEntry()
        if include_optional:
    ...
    def testSnippetSnapshotCompareEntry(self):
        """Test SnippetSnapshotCompareEntry"""
