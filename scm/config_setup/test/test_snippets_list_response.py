...
class TestSnippetsListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SnippetsListResponse:
        """Test SnippetsListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SnippetsListResponse`
        """
        model = SnippetsListResponse()
        if include_optional:
    ...
    def testSnippetsListResponse(self):
        """Test SnippetsListResponse"""
