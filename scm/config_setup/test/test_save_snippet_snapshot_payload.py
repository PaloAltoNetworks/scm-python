...
class TestSaveSnippetSnapshotPayload(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SaveSnippetSnapshotPayload:
        """Test SaveSnippetSnapshotPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SaveSnippetSnapshotPayload`
        """
        model = SaveSnippetSnapshotPayload()
        if include_optional:
            return SaveSnippetSnapshotPayload(
                description = '',
                id = ''
            )
        else:
    ...
    def testSaveSnippetSnapshotPayload(self):
        """Test SaveSnippetSnapshotPayload"""
