...
class DiscoveredApplications(BaseModel):
    """
    DiscoveredApplications
    """ # noqa: E501
    applications: Optional[List[DiscoveredApplicationsApplicationsInner]] = None
    cie_tenant_id: Optional[StrictStr] = None
    count: Optional[Union[StrictFloat, StrictInt]] = None
    tenant_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["applications", "cie_tenant_id", "count", "tenant_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "applications": [DiscoveredApplicationsApplicationsInner.from_dict(_item) for _item in obj["applications"]] if obj.get("applications") is not None else None,
            "cie_tenant_id": obj.get("cie_tenant_id"),
            "count": obj.get("count"),
