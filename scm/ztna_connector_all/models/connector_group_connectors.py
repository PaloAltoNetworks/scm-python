...
class ConnectorGroupConnectors(BaseModel):
    """
    ConnectorGroupConnectors
    """ # noqa: E501
    connectors: Optional[ConnectorGroupConnectorsConnectors] = None
    group: Optional[ConnectorGroups] = None
    __properties: ClassVar[List[str]] = ["connectors", "group"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "connectors": ConnectorGroupConnectorsConnectors.from_dict(obj["connectors"]) if obj.get("connectors") is not None else None,
