...
class ConnectorGroupFqdnRules(BaseModel):
    """
    ConnectorGroupFqdnRules
    """ # noqa: E501
    applications: Optional[ConnectorGroupConnectorsConnectors] = None
    group: Optional[ConnectorGroups] = None
    __properties: ClassVar[List[str]] = ["applications", "group"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "applications": ConnectorGroupConnectorsConnectors.from_dict(obj["applications"]) if obj.get("applications") is not None else None,
