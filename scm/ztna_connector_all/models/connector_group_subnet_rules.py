...
class ConnectorGroupSubnetRules(BaseModel):
    """
    ConnectorGroupSubnetRules
    """ # noqa: E501
    group: Optional[ConnectorGroups] = None
    subnets: Optional[ConnectorGroupConnectorsConnectors] = None
    __properties: ClassVar[List[str]] = ["group", "subnets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subnets": ConnectorGroupConnectorsConnectors.from_dict(obj["subnets"]) if obj.get("subnets") is not None else None
        })
        return _obj
