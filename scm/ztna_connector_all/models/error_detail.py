...
class ErrorDetail(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Type identifier for the detail object", alias="@type")
    causes: Optional[List[ErrorDetailCausesInner]] = Field(default=None, description="Array of cause information objects")
    message: Optional[StrictStr] = Field(default=None, description="Detailed error message")
    __properties: ClassVar[List[str]] = ["@type", "causes", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@type": obj.get("@type"),
            "causes": [ErrorDetailCausesInner.from_dict(_item) for _item in obj["causes"]] if obj.get("causes") is not None else None,
