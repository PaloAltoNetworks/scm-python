# scm_device_settings.ContentIDSettingsApi
...
with scm_device_settings.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_device_settings.ContentIDSettingsApi(api_client)
    content_id_settings = scm_device_settings.ContentIdSettings() # ContentIdSettings |  (optional)
...
with scm_device_settings.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_device_settings.ContentIDSettingsApi(api_client)
    id = '123e4567-e89b-12d3-a456-426655440000' # str | The UUID of the configuration resource
    content_id_settings = scm_device_settings.ContentIdSettings() # ContentIdSettings | OK (optional)
