# scm_device_settings.ManagementInterfaceSettingsApi
...
with scm_device_settings.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_device_settings.ManagementInterfaceSettingsApi(api_client)
    management_interface = scm_device_settings.ManagementInterface() # ManagementInterface |  (optional)
...
with scm_device_settings.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_device_settings.ManagementInterfaceSettingsApi(api_client)
    id = '123e4567-e89b-12d3-a456-426655440000' # str | The UUID of the configuration resource
    management_interface = scm_device_settings.ManagementInterface() # ManagementInterface | OK (optional)
