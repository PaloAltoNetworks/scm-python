# scm_device_settings.ServiceRouteSettingsApi
...
with scm_device_settings.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_device_settings.ServiceRouteSettingsApi(api_client)
    service_route = scm_device_settings.ServiceRoute() # ServiceRoute |  (optional)
...
with scm_device_settings.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_device_settings.ServiceRouteSettingsApi(api_client)
    id = '123e4567-e89b-12d3-a456-426655440000' # str | The UUID of the configuration resource
    service_route = scm_device_settings.ServiceRoute() # ServiceRoute | OK (optional)
