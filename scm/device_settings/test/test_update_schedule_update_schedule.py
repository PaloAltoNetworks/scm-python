...
class TestUpdateScheduleUpdateSchedule(unittest.TestCase):
    """UpdateScheduleUpdateSchedule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateScheduleUpdateSchedule:
        """Test UpdateScheduleUpdateSchedule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateScheduleUpdateSchedule`
        """
        model = UpdateScheduleUpdateSchedule()
        if include_optional:
            return UpdateScheduleUpdateSchedule(
    ...
    def testUpdateScheduleUpdateSchedule(self):
        """Test UpdateScheduleUpdateSchedule"""
