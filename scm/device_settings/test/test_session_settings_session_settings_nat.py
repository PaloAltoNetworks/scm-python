...
class TestSessionSettingsSessionSettingsNat(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SessionSettingsSessionSettingsNat:
        """Test SessionSettingsSessionSettingsNat
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SessionSettingsSessionSettingsNat`
        """
        model = SessionSettingsSessionSettingsNat()
        if include_optional:
            return SessionSettingsSessionSettingsNat(
                dipp_oversub = '1x'
            )
        else:
            return SessionSettingsSessionSettingsNat(
    ...
    def testSessionSettingsSessionSettingsNat(self):
        """Test SessionSettingsSessionSettingsNat"""
