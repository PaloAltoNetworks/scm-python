...
class TestUpdateScheduleUpdateScheduleWildfire(unittest.TestCase):
    """UpdateScheduleUpdateScheduleWildfire unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateScheduleUpdateScheduleWildfire:
        """Test UpdateScheduleUpdateScheduleWildfire
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateScheduleUpdateScheduleWildfire`
        """
        model = UpdateScheduleUpdateScheduleWildfire()
        if include_optional:
            return UpdateScheduleUpdateScheduleWildfire(
    ...
    def testUpdateScheduleUpdateScheduleWildfire(self):
        """Test UpdateScheduleUpdateScheduleWildfire"""
