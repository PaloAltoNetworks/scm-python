...
class TestHaConfigurationsGroupMonitoringLinkMonitoring(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> HaConfigurationsGroupMonitoringLinkMonitoring:
        """Test HaConfigurationsGroupMonitoringLinkMonitoring
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HaConfigurationsGroupMonitoringLinkMonitoring`
        """
        model = HaConfigurationsGroupMonitoringLinkMonitoring()
        if include_optional:
            return HaConfigurationsGroupMonitoringLinkMonitoring(
                enabled = True,
    ...
    def testHaConfigurationsGroupMonitoringLinkMonitoring(self):
        """Test HaConfigurationsGroupMonitoringLinkMonitoring"""
