...
class TestAuthenticationSettingsAuthentication(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AuthenticationSettingsAuthentication:
        """Test AuthenticationSettingsAuthentication
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthenticationSettingsAuthentication`
        """
        model = AuthenticationSettingsAuthentication()
        if include_optional:
            return AuthenticationSettingsAuthentication(
    ...
    def testAuthenticationSettingsAuthentication(self):
        """Test AuthenticationSettingsAuthentication"""
