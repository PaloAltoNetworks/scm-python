...
class TestServiceRouteRouteDestinationInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ServiceRouteRouteDestinationInner:
        """Test ServiceRouteRouteDestinationInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceRouteRouteDestinationInner`
        """
        model = ServiceRouteRouteDestinationInner()
        if include_optional:
    ...
    def testServiceRouteRouteDestinationInner(self):
        """Test ServiceRouteRouteDestinationInner"""
