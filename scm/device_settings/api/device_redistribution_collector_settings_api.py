...
class DeviceRedistributionCollectorSettingsApi:
    ...
    def fetch_device_redistribution_collector_settings(
        self,
        name: str,
        ...
        **kwargs
        ...
        """
        Fetch a single device_redistribution_collector_settings object by name.
        ...
        Example:
            >>> obj = api.fetch_device_redistribution_collector_settings(name="my-object", folder="Texas")
            >>> if obj:
        ...
        while True:
            ...
            response = self.list_device_redistribution_collector_settings(**list_params)
