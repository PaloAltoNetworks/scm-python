...
class ServiceSettingsApi:
    ...
    def fetch_service_settings(
        ...
        **kwargs
        ...
        """
        Fetch a single service_settings object by name.
        ...
        Example:
            >>> obj = api.fetch_service_settings(name="my-object", folder="Texas")
            >>> if obj:
        ...
        while True:
            ...
            response = self.list_service_settings(**list_params)
