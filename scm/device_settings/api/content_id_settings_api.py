...
class ContentIDSettingsApi:
    ...
    def fetch_content_id_settings(
        ...
        **kwargs
        ...
        """
        Fetch a single content_id_settings object by name.
        ...
        Example:
            >>> obj = api.fetch_content_id_settings(name="my-object", folder="Texas")
            >>> if obj:
        ...
        while True:
            ...
            response = self.list_content_id_settings(**list_params)
