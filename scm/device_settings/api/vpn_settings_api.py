...
class VPNSettingsApi:
    ...
    def fetch_vpn_settings(
        ...
        **kwargs
        ...
        """
        Fetch a single vpn_settings object by name.
        ...
        Example:
            >>> obj = api.fetch_vpn_settings(name="my-object", folder="Texas")
            >>> if obj:
        ...
        while True:
            ...
            response = self.list_vpn_settings(**list_params)
