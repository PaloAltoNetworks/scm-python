...
class SessionSettingsApi:
    ...
    def fetch_session_settings(
        ...
        **kwargs
        ...
        """
        Fetch a single session_settings object by name.
        ...
        Example:
            >>> obj = api.fetch_session_settings(name="my-object", folder="Texas")
            >>> if obj:
        ...
        while True:
            ...
            response = self.list_session_settings(**list_params)
