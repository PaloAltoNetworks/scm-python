...
class ManagementInterfaceSettingsApi:
    ...
    def fetch_management_interface_settings(
        self,
        name: str,
        ...
        **kwargs
        ...
        """
        Fetch a single management_interface_settings object by name.
        ...
        Example:
            >>> obj = api.fetch_management_interface_settings(name="my-object", folder="Texas")
            >>> if obj:
        ...
        while True:
            ...
            response = self.list_management_interface_settings(**list_params)
