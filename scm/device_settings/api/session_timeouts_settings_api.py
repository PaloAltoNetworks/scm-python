...
class SessionTimeoutsSettingsApi:
    ...
    def fetch_session_timeouts_settings(
        self,
        name: str,
        ...
        **kwargs
        ...
        """
        Fetch a single session_timeouts_settings object by name.
        ...
        Example:
            >>> obj = api.fetch_session_timeouts_settings(name="my-object", folder="Texas")
            >>> if obj:
        ...
        while True:
            ...
            response = self.list_session_timeouts_settings(**list_params)
