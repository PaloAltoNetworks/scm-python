...
class TCPSettingsApi:
    ...
    def fetch_tcp_settings(
        ...
        **kwargs
        ...
        """
        Fetch a single tcp_settings object by name.
        ...
        Example:
            >>> obj = api.fetch_tcp_settings(name="my-object", folder="Texas")
            >>> if obj:
        ...
        while True:
            ...
            response = self.list_tcp_settings(**list_params)
