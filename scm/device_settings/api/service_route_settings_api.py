...
class ServiceRouteSettingsApi:
    ...
    def fetch_service_route_settings(
        self,
        name: str,
        ...
        **kwargs
        ...
        """
        Fetch a single service_route_settings object by name.
        ...
        Example:
            >>> obj = api.fetch_service_route_settings(name="my-object", folder="Texas")
            >>> if obj:
        ...
        while True:
            ...
            response = self.list_service_route_settings(**list_params)
