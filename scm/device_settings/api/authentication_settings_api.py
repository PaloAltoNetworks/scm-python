...
class AuthenticationSettingsApi:
    ...
    def fetch_authentication_settings(
        self,
        name: str,
        ...
        **kwargs
        ...
        """
        Fetch a single authentication_settings object by name.
        ...
        Example:
            >>> obj = api.fetch_authentication_settings(name="my-object", folder="Texas")
            >>> if obj:
        ...
        while True:
            ...
            response = self.list_authentication_settings(**list_params)
