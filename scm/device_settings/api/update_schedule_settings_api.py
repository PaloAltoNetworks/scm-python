...
class UpdateScheduleSettingsApi:
    ...
    def fetch_update_schedule_settings(
        self,
        name: str,
        ...
        **kwargs
        ...
        """
        Fetch a single update_schedule_settings object by name.
        ...
        Example:
            >>> obj = api.fetch_update_schedule_settings(name="my-object", folder="Texas")
            >>> if obj:
        ...
        while True:
            ...
            response = self.list_update_schedule_settings(**list_params)
