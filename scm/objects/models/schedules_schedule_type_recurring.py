...
class SchedulesScheduleTypeRecurring(BaseModel):
    """
    SchedulesScheduleTypeRecurring
    """ # noqa: E501
    daily: Optional[List[Annotated[str, Field(min_length=11, strict=True, max_length=11)]]] = None
    weekly: Optional[SchedulesScheduleTypeRecurringWeekly] = None
    __properties: ClassVar[List[str]] = ["daily", "weekly"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "daily": obj.get("daily"),
            "weekly": SchedulesScheduleTypeRecurringWeekly.from_dict(obj["weekly"]) if obj.get("weekly") is not None else None
        })
        return _obj
