...
class HipObjectsNetworkInfo(BaseModel):
    """
    HipObjectsNetworkInfo
    """ # noqa: E501
    criteria: Optional[HipObjectsNetworkInfoCriteria] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "criteria": HipObjectsNetworkInfoCriteria.from_dict(obj["criteria"]) if obj.get("criteria") is not None else None
        })
        return _obj
