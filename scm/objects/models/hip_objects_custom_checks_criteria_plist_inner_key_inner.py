...
class HipObjectsCustomChecksCriteriaPlistInnerKeyInner(BaseModel):
    """
    HipObjectsCustomChecksCriteriaPlistInnerKeyInner
    """ # noqa: E501
    name: Annotated[str, Field(strict=True, max_length=1023)] = Field(description="Key name")
    negate: Optional[StrictBool] = Field(default=False, description="Value does not exist or match specified value data")
    value: Optional[Annotated[str, Field(strict=True, max_length=1024)]] = Field(default=None, description="Key value")
    __properties: ClassVar[List[str]] = ["name", "negate", "value"]
