...
class ExternalDynamicListsTypeIpAuth(BaseModel):
    """
    Authentication settings for Custom IP type
    """ # noqa: E501
    password: Annotated[str, Field(strict=True, max_length=255)] = Field(description="Password for Custom IP authentication")
    username: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(description="Username for Custom IP authentication")
