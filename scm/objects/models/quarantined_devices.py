...
class QuarantinedDevices(BaseModel):
    """
    QuarantinedDevices
    """ # noqa: E501
    host_id: StrictStr = Field(description="Device host ID")
    serial_number: Optional[StrictStr] = Field(default=None, description="Device serial number")
    __properties: ClassVar[List[str]] = ["host_id", "serial_number"]
