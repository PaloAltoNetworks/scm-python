...
class ServicesProtocolUdp(BaseModel):
    """
    ServicesProtocolUdp
    """ # noqa: E501
    override: Optional[ServicesProtocolUdpOverride] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "override": ServicesProtocolUdpOverride.from_dict(obj["override"]) if obj.get("override") is not None else None,
            "port": obj.get("port"),
