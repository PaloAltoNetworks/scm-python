...
class ApplicationFiltersTagging(BaseModel):
    """
    ApplicationFiltersTagging
    """ # noqa: E501
    no_tag: Optional[StrictBool] = None
    tag: Optional[List[Annotated[str, Field(strict=True, max_length=127)]]] = None
    __properties: ClassVar[List[str]] = ["no_tag", "tag"]
