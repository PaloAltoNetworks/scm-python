...
class ServicesProtocol(BaseModel):
    """
    ServicesProtocol
    """ # noqa: E501
    tcp: Optional[ServicesProtocolTcp] = None
    udp: Optional[ServicesProtocolUdp] = None
    __properties: ClassVar[List[str]] = ["tcp", "udp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tcp": ServicesProtocolTcp.from_dict(obj["tcp"]) if obj.get("tcp") is not None else None,
            "udp": ServicesProtocolUdp.from_dict(obj["udp"]) if obj.get("udp") is not None else None
        })
        return _obj
