...
class AddressGroupsDynamic(BaseModel):
    """
    AddressGroupsDynamic
    """ # noqa: E501
    filter: Annotated[str, Field(strict=True, max_length=2047)] = Field(description="Tag based filter defining group membership")
