...
class Tags(BaseModel):
    ...
    Tags
    """ # noqa: E501
    color: Optional[StrictStr] = Field(default=None, description="The color of the tag")
    comments: Optional[Annotated[str, Field(strict=True, max_length=1023)]] = Field(default=None, description="The description of the tag")
    ...
    id: Optional[StrictStr] = Field(default=None, description="The UUID of the tag")
    name: Annotated[str, Field(strict=True, max_length=127)] = Field(description="The name of the tag")
    ...
    __properties: ClassVar[List[str]] = ["color", "comments", "device", "folder", "id", "name", "snippet"]
