...
class LogForwardingProfiles(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in match_list (list)
        _items = []
        if self.match_list:
            for _item_match_list in self.match_list:
                if _item_match_list:
                    _items.append(_item_match_list.to_dict())
            _dict['match_list'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "match_list": [LogForwardingProfilesMatchListInner.from_dict(_item) for _item in obj["match_list"]] if obj.get("match_list") is not None else None,
            "name": obj.get("name"),
