...
class ServicesProtocolUdpOverride(BaseModel):
    """
    ServicesProtocolUdpOverride
    """ # noqa: E501
    timeout: Optional[Annotated[int, Field(le=604800, strict=True, ge=1)]] = Field(default=30, description="udp session timeout value (in second)")
