...
class HipProfiles(BaseModel):
    ...
    match: Annotated[str, Field(strict=True, max_length=2048)]
    name: Annotated[str, Field(strict=True, max_length=31)] = Field(description="The name of the HIP profile")
    ...
    __properties: ClassVar[List[str]] = ["description", "device", "folder", "id", "match", "name", "snippet"]
