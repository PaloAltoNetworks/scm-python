...
class DynamicUserGroups(BaseModel):
    """
    DynamicUserGroups
    """ # noqa: E501
    description: Optional[Annotated[str, Field(strict=True, max_length=1023)]] = Field(default=None, description="The description of the dynamic address group")
    ...
    filter: Annotated[str, Field(strict=True, max_length=2047)] = Field(description="The tag-based filter for the dynamic user group")
    ...
    id: StrictStr = Field(description="The UUID of the dynamic user group")
    name: Annotated[str, Field(strict=True, max_length=63)] = Field(description="The name of the dynamic address group")
    ...
    tag: Optional[Annotated[List[Annotated[str, Field(strict=True, max_length=127)]], Field(max_length=64)]] = Field(default=None, description="Tags associated with the dynamic user group")
    __properties: ClassVar[List[str]] = ["description", "device", "filter", "folder", "id", "name", "snippet", "tag"]
