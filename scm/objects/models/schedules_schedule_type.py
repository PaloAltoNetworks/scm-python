...
class SchedulesScheduleType(BaseModel):
    """
    SchedulesScheduleType
    """ # noqa: E501
    non_recurring: Optional[List[Annotated[str, Field(min_length=33, strict=True, max_length=33)]]] = None
    recurring: Optional[SchedulesScheduleTypeRecurring] = None
    __properties: ClassVar[List[str]] = ["non_recurring", "recurring"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "non_recurring": obj.get("non_recurring"),
            "recurring": SchedulesScheduleTypeRecurring.from_dict(obj["recurring"]) if obj.get("recurring") is not None else None
        })
        return _obj
