...
class Services(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, description="The UUID of the service")
    name: Annotated[str, Field(strict=True, max_length=63)] = Field(description="The name of the service")
    protocol: Optional[ServicesProtocol] = None
    ...
    tag: Optional[Annotated[List[Annotated[str, Field(strict=True, max_length=127)]], Field(max_length=64)]] = Field(default=None, description="Tags for service object")
    __properties: ClassVar[List[str]] = ["description", "device", "folder", "id", "name", "protocol", "snippet", "tag"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "protocol": ServicesProtocol.from_dict(obj["protocol"]) if obj.get("protocol") is not None else None,
