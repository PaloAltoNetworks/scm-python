...
class SyslogServerProfiles(BaseModel):
    """
    ...
    format: Optional[SyslogServerProfilesFormat] = None
    id: StrictStr = Field(description="The UUID of the syslog server profile")
    name: Annotated[str, Field(strict=True, max_length=31)] = Field(description="The name of the syslog server profile")
    server: Annotated[List[SyslogServerProfilesServerInner], Field(min_length=1)] = Field(description="A list of syslog server configurations. At least one server is required.")
    ...
    __properties: ClassVar[List[str]] = ["device", "folder", "format", "id", "name", "server", "snippet"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "format": SyslogServerProfilesFormat.from_dict(obj["format"]) if obj.get("format") is not None else None,
            "id": obj.get("id"),
            "name": obj.get("name"),
            "server": [SyslogServerProfilesServerInner.from_dict(_item) for _item in obj["server"]] if obj.get("server") is not None else None,
