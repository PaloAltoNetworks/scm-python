...
class HipObjectsCustomChecks(BaseModel):
    """
    HipObjectsCustomChecks
    """ # noqa: E501
    criteria: HipObjectsCustomChecksCriteria
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "criteria": HipObjectsCustomChecksCriteria.from_dict(obj["criteria"]) if obj.get("criteria") is not None else None
        })
        return _obj
