...
class ExternalDynamicListsTypeImsiAuth(BaseModel):
    """
    IMSI Auth Config for Custom IMSI type
    """ # noqa: E501
    password: Annotated[str, Field(strict=True, max_length=255)] = Field(description="IMSI Auth Password for Custom IMSI type")
    username: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(description="IMSI Auth Username for Custom IMSI type")
