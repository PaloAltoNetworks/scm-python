...
class HipObjectsMobileDevice(BaseModel):
    """
    HipObjectsMobileDevice
    """ # noqa: E501
    criteria: Optional[HipObjectsMobileDeviceCriteria] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "criteria": HipObjectsMobileDeviceCriteria.from_dict(obj["criteria"]) if obj.get("criteria") is not None else None
        })
        return _obj
