...
class ExternalDynamicListsTypeUrlRecurringWeekly(BaseModel):
    """
    Weekly settings for URL recurring
    """ # noqa: E501
    at: Annotated[str, Field(min_length=2, strict=True, max_length=2)] = Field(description="Weekly Time specification hh (e.g. 20) for URL")
