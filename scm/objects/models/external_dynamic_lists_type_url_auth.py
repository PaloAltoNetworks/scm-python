...
class ExternalDynamicListsTypeUrlAuth(BaseModel):
    """
    Authentication settings for Custom URL type
    """ # noqa: E501
    password: Annotated[str, Field(strict=True, max_length=255)] = Field(description="Password for Custom URL authentication")
    username: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(description="Username for Custom URL authentication")
