...
class ExternalDynamicListsTypeDomainRecurringWeekly(BaseModel):
    """
    Weekly settings for Domain recurring
    """ # noqa: E501
    at: Annotated[str, Field(min_length=2, strict=True, max_length=2)] = Field(description="Weekly Time specification hh (e.g. 20) for Domain")
    day_of_week: StrictStr
    __properties: ClassVar[List[str]] = ["at", "day_of_week"]
