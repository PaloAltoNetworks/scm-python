...
class ServicesProtocolTcp(BaseModel):
    """
    ServicesProtocolTcp
    """ # noqa: E501
    override: Optional[ServicesProtocolTcpOverride] = None
    port: Annotated[str, Field(min_length=1, strict=True, max_length=1023)]
    source_port: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=1023)]] = None
    __properties: ClassVar[List[str]] = ["override", "port", "source_port"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "override": ServicesProtocolTcpOverride.from_dict(obj["override"]) if obj.get("override") is not None else None,
            "port": obj.get("port"),
