...
class ExternalDynamicListsTypeImeiAuth(BaseModel):
    """
    IMEI Auth Cnfig for Custom IMEI type
    """ # noqa: E501
    password: Annotated[str, Field(strict=True, max_length=255)] = Field(description="IMEI Auth Password for Custom IMEI type")
    username: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(description="IMEI Auth username for Custom IMEI type")
