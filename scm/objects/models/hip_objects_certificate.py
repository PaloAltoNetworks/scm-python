...
class HipObjectsCertificate(BaseModel):
    """
    HipObjectsCertificate
    """ # noqa: E501
    criteria: Optional[HipObjectsCertificateCriteria] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "criteria": HipObjectsCertificateCriteria.from_dict(obj["criteria"]) if obj.get("criteria") is not None else None
        })
        return _obj
