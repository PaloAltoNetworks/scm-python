...
class ServiceGroups(BaseModel):
    ...
    id: StrictStr = Field(description="The UUID of the service group")
    members: List[Annotated[str, Field(strict=True, max_length=63)]]
    name: Annotated[str, Field(strict=True, max_length=63)] = Field(description="The name of the service group")
    ...
    tag: Optional[Annotated[List[Annotated[str, Field(strict=True, max_length=127)]], Field(max_length=64)]] = Field(default=None, description="Tags associated with the service group")
    __properties: ClassVar[List[str]] = ["device", "folder", "id", "members", "name", "snippet", "tag"]
