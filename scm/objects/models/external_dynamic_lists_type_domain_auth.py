...
class ExternalDynamicListsTypeDomainAuth(BaseModel):
    """
    Authentication settings for Custom Domain type
    """ # noqa: E501
    password: Annotated[str, Field(strict=True, max_length=255)] = Field(description="Password for Custom Domain authentication")
    username: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(description="Username for Custom Domain authentication")
