...
class ExternalDynamicLists(BaseModel):
    """
    ...
    id: Optional[StrictStr] = Field(default=None, description="The UUID of the external dynamic list")
    name: Annotated[str, Field(strict=True, max_length=63)] = Field(description="The name of the external dynamic list")
    ...
    type: Optional[ExternalDynamicListsType] = None
    __properties: ClassVar[List[str]] = ["device", "folder", "id", "name", "snippet", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": ExternalDynamicListsType.from_dict(obj["type"]) if obj.get("type") is not None else None
        })
        return _obj
