# scm_objects.SyslogServerProfilesApi
...
with scm_objects.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_objects.SyslogServerProfilesApi(api_client)
    syslog_server_profiles = scm_objects.SyslogServerProfiles() # SyslogServerProfiles | Created (optional)
...
with scm_objects.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_objects.SyslogServerProfilesApi(api_client)
    id = '123e4567-e89b-12d3-a456-426655440000' # str | The UUID of the configuration resource
    syslog_server_profiles = scm_objects.SyslogServerProfiles() # SyslogServerProfiles | OK (optional)
