# scm.objects.ExternalDynamicListsApi
...
with scm.objects.ApiClient(configuration) as api_client:
    ...
    api_instance = scm.objects.ExternalDynamicListsApi(api_client)
    external_dynamic_lists = scm.objects.ExternalDynamicLists() # ExternalDynamicLists | Created (optional)
...
with scm.objects.ApiClient(configuration) as api_client:
    ...
    api_instance = scm.objects.ExternalDynamicListsApi(api_client)
    id = '123e4567-e89b-12d3-a456-426655440000' # str | The UUID of the configuration resource
    external_dynamic_lists = scm.objects.ExternalDynamicLists() # ExternalDynamicLists | OK (optional)
