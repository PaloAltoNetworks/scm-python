...
with scm_objects.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_objects.SchedulesApi(api_client)
    schedules = scm_objects.Schedules() # Schedules | Created (optional)
...
with scm_objects.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_objects.SchedulesApi(api_client)
    id = '123e4567-e89b-12d3-a456-426655440000' # str | The UUID of the configuration resource
    schedules = scm_objects.Schedules() # Schedules | OK (optional)
