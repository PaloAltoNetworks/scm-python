...
class RegionsApi:
    ...
    def create_regions(
        ...
        _param = self._create_regions_serialize(
            regions=regions,
    ...
    def delete_regions_by_id(
        ...
        _param = self._delete_regions_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _delete_regions_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def get_regions_by_id(
        ...
        _param = self._get_regions_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _get_regions_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def list_regions_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RegionsListResponse]:
        """List regions
    ...
    def update_regions_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        regions: Annotated[Optional[Regions], Field(description="OK")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._update_regions_by_id_serialize(
            id=id,
            regions=regions,
            _request_auth=_request_auth,
            _content_type=_content_type,
