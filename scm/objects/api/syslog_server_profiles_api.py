...
class SyslogServerProfilesApi:
    ...
    def fetch_syslog_server_profiles(
        self,
        name: str,
        ...
        **kwargs
        ...
        """
        Fetch a single syslog_server_profiles object by name.
        ...
        Example:
            >>> obj = api.fetch_syslog_server_profiles(name="my-object", folder="Texas")
            >>> if obj:
        ...
        while True:
            ...
            response = self.list_syslog_server_profiles(**list_params)
