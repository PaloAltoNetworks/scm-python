...
class TagsApi:
    ...
    def create_tags(
        self,
        tags: Annotated[Optional[Tags], Field(description="Created")] = None,
    ...
    def delete_tags_by_id(
        ...
        _param = self._delete_tags_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def delete_tags_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def delete_tags_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _delete_tags_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def get_tags_by_id(
        ...
        _param = self._get_tags_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def get_tags_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def get_tags_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def update_tags_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        tags: Annotated[Optional[Tags], Field(description="OK")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._update_tags_by_id_serialize(
            id=id,
            tags=tags,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    @with_error_handling
    def update_tags_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        tags: Annotated[Optional[Tags], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    @with_error_handling
    def update_tags_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        tags: Annotated[Optional[Tags], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    def fetch_tags(
        ...
        **kwargs
        ...
        """
        Fetch a single tags object by name.
        ...
        Example:
            >>> obj = api.fetch_tags(name="my-object", folder="Texas")
            >>> if obj:
        ...
        try:
            response = self.list_tags(**list_params)
    ...
    def _update_tags_by_id_serialize(
        self,
        id,
        tags,
        _request_auth,
