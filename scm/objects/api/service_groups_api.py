...
class ServiceGroupsApi:
    ...
    def create_service_groups(
        self,
        service_groups: Annotated[Optional[ServiceGroups], Field(description="Created")] = None,
        ...
        :param service_groups: Created
        :type service_groups: ServiceGroups
        ...
        _param = self._create_service_groups_serialize(
    ...
    @validate_call
    @with_error_handling
    def create_service_groups_with_http_info(
        self,
        service_groups: Annotated[Optional[ServiceGroups], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def create_service_groups_without_preload_content(
        self,
        service_groups: Annotated[Optional[ServiceGroups], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_service_groups_serialize(
        self,
        service_groups,
        _request_auth,
        _content_type,
    ...
    @validate_call
    @with_error_handling
    def delete_service_groups_by_id(
        self,
        ...
        _param = self._delete_service_groups_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def delete_service_groups_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def delete_service_groups_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _delete_service_groups_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/service-groups/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_service_groups_by_id(
        ...
        _param = self._get_service_groups_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def get_service_groups_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def get_service_groups_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_service_groups_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def list_service_groups(
        ...
        _param = self._list_service_groups_serialize(
            name=name,
            folder=folder,
            snippet=snippet,
            device=device,
    ...
    @validate_call
    @with_error_handling
    def list_service_groups_with_http_info(
        self,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ServiceGroupsListResponse]:
        """List service groups
    ...
    @validate_call
    @with_error_handling
    def list_service_groups_without_preload_content(
        self,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
    ...
    def _list_service_groups_serialize(
        self,
        name,
        folder,
        snippet,
    ...
    @validate_call
    @with_error_handling
    def update_service_groups_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        service_groups: Annotated[Optional[ServiceGroups], Field(description="OK")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._update_service_groups_by_id_serialize(
            id=id,
            service_groups=service_groups,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    @with_error_handling
    def update_service_groups_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        service_groups: Annotated[Optional[ServiceGroups], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    @with_error_handling
    def update_service_groups_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        service_groups: Annotated[Optional[ServiceGroups], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    def fetch_service_groups(
        ...
        **kwargs
        ...
        """
        Fetch a single service_groups object by name.
        ...
        Example:
            >>> obj = api.fetch_service_groups(name="my-object", folder="Texas")
            >>> if obj:
        ...
        try:
            response = self.list_service_groups(**list_params)
    ...
    def _update_service_groups_by_id_serialize(
        self,
        id,
        service_groups,
        _request_auth,
