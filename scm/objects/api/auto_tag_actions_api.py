...
class AutoTagActionsApi:
    ...
    def fetch_auto_tag_actions(
        ...
        **kwargs
        ...
        """
        Fetch a single auto_tag_actions object by name.
        ...
        Example:
            >>> obj = api.fetch_auto_tag_actions(name="my-object", folder="Texas")
            >>> if obj:
        ...
        try:
            response = self.list_auto_tag_actions(**list_params)
