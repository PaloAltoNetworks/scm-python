...
class DynamicUserGroupsApi:
    ...
    @validate_call
    @with_error_handling
    def create_dynamic_user_groups(
        self,
        dynamic_user_groups: Annotated[Optional[DynamicUserGroups], Field(description="Created")] = None,
        ...
        :param dynamic_user_groups: Created
        :type dynamic_user_groups: DynamicUserGroups
        ...
        _param = self._create_dynamic_user_groups_serialize(
    ...
    @validate_call
    @with_error_handling
    def create_dynamic_user_groups_with_http_info(
        self,
        dynamic_user_groups: Annotated[Optional[DynamicUserGroups], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def create_dynamic_user_groups_without_preload_content(
        self,
        dynamic_user_groups: Annotated[Optional[DynamicUserGroups], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_dynamic_user_groups_serialize(
        self,
        dynamic_user_groups,
        _request_auth,
        _content_type,
        ...
        if dynamic_user_groups is not None:
            _body_params = dynamic_user_groups
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/dynamic-user-groups',
    ...
    @validate_call
    @with_error_handling
    def delete_dynamic_user_groups_by_id(
        self,
        ...
        _param = self._delete_dynamic_user_groups_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def delete_dynamic_user_groups_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def delete_dynamic_user_groups_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _delete_dynamic_user_groups_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/dynamic-user-groups/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    @with_error_handling
    def get_dynamic_user_groups_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
        ...
        _param = self._get_dynamic_user_groups_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def get_dynamic_user_groups_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def get_dynamic_user_groups_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_dynamic_user_groups_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def list_dynamic_user_groups(
        ...
        _param = self._list_dynamic_user_groups_serialize(
            name=name,
            folder=folder,
            snippet=snippet,
            device=device,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DynamicUserGroupsListResponse",
            '400': "GenericError",
            '401': "GenericError",
            '403': "GenericError",
            '404': "GenericError",
    ...
    @validate_call
    @with_error_handling
    def list_dynamic_user_groups_with_http_info(
        self,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DynamicUserGroupsListResponse]:
        """List Dynamic User Groups
    ...
    @validate_call
    @with_error_handling
    def list_dynamic_user_groups_without_preload_content(
        self,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
    ...
    def _list_dynamic_user_groups_serialize(
        self,
        name,
        folder,
        snippet,
    ...
    @validate_call
    @with_error_handling
    def update_dynamic_user_groups_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        dynamic_user_groups: Annotated[Optional[DynamicUserGroups], Field(description="OK")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._update_dynamic_user_groups_by_id_serialize(
            id=id,
            dynamic_user_groups=dynamic_user_groups,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    @with_error_handling
    def update_dynamic_user_groups_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        dynamic_user_groups: Annotated[Optional[DynamicUserGroups], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    @with_error_handling
    def update_dynamic_user_groups_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        dynamic_user_groups: Annotated[Optional[DynamicUserGroups], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    def fetch_dynamic_user_groups(
        ...
        **kwargs
        ...
        """
        Fetch a single dynamic_user_groups object by name.
        ...
        Example:
            >>> obj = api.fetch_dynamic_user_groups(name="my-object", folder="Texas")
            >>> if obj:
        ...
        try:
            response = self.list_dynamic_user_groups(**list_params)
    ...
    def _update_dynamic_user_groups_by_id_serialize(
        self,
        id,
        dynamic_user_groups,
        _request_auth,
