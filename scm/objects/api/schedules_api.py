...
class SchedulesApi:
    ...
    def create_schedules(
        self,
        schedules: Annotated[Optional[Schedules], Field(description="Created")] = None,
    ...
    def delete_schedules_by_id(
        ...
        _param = self._delete_schedules_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def delete_schedules_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def delete_schedules_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _delete_schedules_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def get_schedules_by_id(
        ...
        _param = self._get_schedules_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def get_schedules_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def get_schedules_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_schedules_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def list_schedules_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SchedulesListResponse]:
        """List schedules
    ...
    @validate_call
    @with_error_handling
    def update_schedules_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        schedules: Annotated[Optional[Schedules], Field(description="OK")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._update_schedules_by_id_serialize(
            id=id,
            schedules=schedules,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    @with_error_handling
    def update_schedules_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        schedules: Annotated[Optional[Schedules], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    @with_error_handling
    def update_schedules_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        schedules: Annotated[Optional[Schedules], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    def fetch_schedules(
        ...
        **kwargs
        ...
        """
        Fetch a single schedules object by name.
        ...
        Example:
            >>> obj = api.fetch_schedules(name="my-object", folder="Texas")
            >>> if obj:
        ...
        while True:
            ...
            response = self.list_schedules(**list_params)
    ...
    def _update_schedules_by_id_serialize(
        self,
        id,
        schedules,
        _request_auth,
