...
class ServicesApi:
    ...
    def create_services(
        self,
        services: Annotated[Optional[Services], Field(description="Created")] = None,
    ...
    def delete_services_by_id(
        ...
        _param = self._delete_services_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def delete_services_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def delete_services_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _delete_services_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def get_services_by_id(
        ...
        _param = self._get_services_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def get_services_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def get_services_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_services_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    @with_error_handling
    def update_services_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        services: Annotated[Optional[Services], Field(description="OK")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._update_services_by_id_serialize(
            id=id,
            services=services,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    @with_error_handling
    def update_services_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        services: Annotated[Optional[Services], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    @with_error_handling
    def update_services_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        services: Annotated[Optional[Services], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    def fetch_services(
        ...
        **kwargs
        ...
        """
        Fetch a single services object by name.
        ...
        Example:
            >>> obj = api.fetch_services(name="my-object", folder="Texas")
            >>> if obj:
        ...
        try:
            response = self.list_services(**list_params)
    ...
    def _update_services_by_id_serialize(
        self,
        id,
        services,
        _request_auth,
