...
class ExternalDynamicListsApi:
    ...
    @validate_call
    @with_error_handling
    def create_external_dynamic_lists(
        self,
        external_dynamic_lists: Annotated[Optional[ExternalDynamicLists], Field(description="Created")] = None,
        ...
        :param external_dynamic_lists: Created
        :type external_dynamic_lists: ExternalDynamicLists
        ...
        _param = self._create_external_dynamic_lists_serialize(
            external_dynamic_lists=external_dynamic_lists,
    ...
    @validate_call
    @with_error_handling
    def create_external_dynamic_lists_with_http_info(
        self,
        external_dynamic_lists: Annotated[Optional[ExternalDynamicLists], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExternalDynamicLists]:
        """Create an External Dynamic List
    ...
    @validate_call
    @with_error_handling
    def create_external_dynamic_lists_without_preload_content(
        self,
        external_dynamic_lists: Annotated[Optional[ExternalDynamicLists], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_external_dynamic_lists_serialize(
        self,
        ...
        if external_dynamic_lists is not None:
            _body_params = external_dynamic_lists
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/external-dynamic-lists',
    ...
    @validate_call
    @with_error_handling
    def delete_external_dynamic_lists_by_id(
        self,
        ...
        _param = self._delete_external_dynamic_lists_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def delete_external_dynamic_lists_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def delete_external_dynamic_lists_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _delete_external_dynamic_lists_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/external-dynamic-lists/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    @with_error_handling
    def get_external_dynamic_lists_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
        ...
        _param = self._get_external_dynamic_lists_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def get_external_dynamic_lists_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def get_external_dynamic_lists_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_external_dynamic_lists_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def list_external_dynamic_lists(
        ...
        _param = self._list_external_dynamic_lists_serialize(
            name=name,
            folder=folder,
            snippet=snippet,
            device=device,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ExternalDynamicListsListResponse",
            '400': "GenericError",
            '401': "GenericError",
            '403': "GenericError",
            '404': "GenericError",
    ...
    @validate_call
    @with_error_handling
    def list_external_dynamic_lists_with_http_info(
        self,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExternalDynamicListsListResponse]:
        """List External Dynamic Lists
    ...
    @validate_call
    @with_error_handling
    def list_external_dynamic_lists_without_preload_content(
        self,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
    ...
    def _list_external_dynamic_lists_serialize(
        self,
        name,
        folder,
        snippet,
    ...
    @validate_call
    @with_error_handling
    def update_external_dynamic_lists_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        external_dynamic_lists: Annotated[Optional[ExternalDynamicLists], Field(description="OK")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: The UUID of the configuration resource (required)
        :type id: str
        :param external_dynamic_lists: OK
        :type external_dynamic_lists: ExternalDynamicLists
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._update_external_dynamic_lists_by_id_serialize(
            id=id,
            external_dynamic_lists=external_dynamic_lists,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    @with_error_handling
    def update_external_dynamic_lists_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        external_dynamic_lists: Annotated[Optional[ExternalDynamicLists], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    @with_error_handling
    def update_external_dynamic_lists_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        external_dynamic_lists: Annotated[Optional[ExternalDynamicLists], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    def fetch_external_dynamic_lists(
        self,
        name: str,
        ...
        **kwargs
        ...
        """
        Fetch a single external_dynamic_lists object by name.
        ...
        Example:
            >>> obj = api.fetch_external_dynamic_lists(name="my-object", folder="Texas")
            >>> if obj:
        ...
        while True:
            ...
            response = self.list_external_dynamic_lists(**list_params)
