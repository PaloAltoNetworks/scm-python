...
class HIPObjectsApi:
    ...
    @validate_call
    @with_error_handling
    def create_hip_objects(
        self,
        hip_objects: Annotated[Optional[HipObjects], Field(description="Created")] = None,
        ...
        :param hip_objects: Created
        :type hip_objects: HipObjects
        ...
        _param = self._create_hip_objects_serialize(
            hip_objects=hip_objects,
    ...
    @validate_call
    @with_error_handling
    def create_hip_objects_with_http_info(
        self,
        hip_objects: Annotated[Optional[HipObjects], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def create_hip_objects_without_preload_content(
        self,
        hip_objects: Annotated[Optional[HipObjects], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_hip_objects_serialize(
        self,
        hip_objects,
        _request_auth,
        _content_type,
        ...
        if hip_objects is not None:
            _body_params = hip_objects
    ...
    def delete_hip_objects_by_id(
        ...
        _param = self._delete_hip_objects_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def delete_hip_objects_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def delete_hip_objects_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _delete_hip_objects_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def get_hip_objects_by_id(
        ...
        _param = self._get_hip_objects_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def get_hip_objects_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def get_hip_objects_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_hip_objects_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def list_hip_objects(
        ...
        _param = self._list_hip_objects_serialize(
            name=name,
            folder=folder,
            snippet=snippet,
            device=device,
    ...
    @validate_call
    @with_error_handling
    def list_hip_objects_with_http_info(
        self,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[HIPObjectsListResponse]:
        """List HIP objects
    ...
    @validate_call
    @with_error_handling
    def list_hip_objects_without_preload_content(
        self,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
    ...
    def _list_hip_objects_serialize(
        self,
        name,
        folder,
        snippet,
    ...
    @validate_call
    @with_error_handling
    def update_hip_objects_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        hip_objects: Annotated[Optional[HipObjects], Field(description="OK")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._update_hip_objects_by_id_serialize(
            id=id,
            hip_objects=hip_objects,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    @with_error_handling
    def update_hip_objects_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        hip_objects: Annotated[Optional[HipObjects], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    @with_error_handling
    def update_hip_objects_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        hip_objects: Annotated[Optional[HipObjects], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    def fetch_hip_objects(
        ...
        **kwargs
        ...
        """
        Fetch a single hip_objects object by name.
        ...
        Example:
            >>> obj = api.fetch_hip_objects(name="my-object", folder="Texas")
            >>> if obj:
        ...
        while True:
            ...
            response = self.list_hip_objects(**list_params)
    ...
    def _update_hip_objects_by_id_serialize(
        self,
        id,
        hip_objects,
        _request_auth,
