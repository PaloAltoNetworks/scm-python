...
class ApplicationFiltersApi:
    ...
    @validate_call
    @with_error_handling
    def create_application_filters(
        self,
        application_filters: Annotated[Optional[ApplicationFilters], Field(description="Created")] = None,
        ...
        :param application_filters: Created
        :type application_filters: ApplicationFilters
        ...
        _param = self._create_application_filters_serialize(
    ...
    @validate_call
    @with_error_handling
    def create_application_filters_with_http_info(
        self,
        application_filters: Annotated[Optional[ApplicationFilters], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApplicationFilters]:
        """Create an application filter
    ...
    @validate_call
    @with_error_handling
    def create_application_filters_without_preload_content(
        self,
        application_filters: Annotated[Optional[ApplicationFilters], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_application_filters_serialize(
        self,
        application_filters,
        _request_auth,
        _content_type,
        ...
        if application_filters is not None:
            _body_params = application_filters
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/application-filters',
    ...
    @validate_call
    @with_error_handling
    def delete_application_filters_by_id(
        self,
        ...
        _param = self._delete_application_filters_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def delete_application_filters_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def delete_application_filters_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _delete_application_filters_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/application-filters/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    @with_error_handling
    def get_application_filters_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
        ...
        _param = self._get_application_filters_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def get_application_filters_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def get_application_filters_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_application_filters_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def list_application_filters(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ApplicationFiltersListResponse",
            '400': "GenericError",
            '401': "GenericError",
            '403': "GenericError",
            '404': "GenericError",
    ...
    def list_application_filters_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApplicationFiltersListResponse]:
        """List application filters
    ...
    @validate_call
    @with_error_handling
    def update_application_filters_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        application_filters: Annotated[Optional[ApplicationFilters], Field(description="OK")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._update_application_filters_by_id_serialize(
            id=id,
            application_filters=application_filters,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    @with_error_handling
    def update_application_filters_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        application_filters: Annotated[Optional[ApplicationFilters], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    @with_error_handling
    def update_application_filters_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        application_filters: Annotated[Optional[ApplicationFilters], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    def fetch_application_filters(
        ...
        **kwargs
        ...
        """
        Fetch a single application_filters object by name.
        ...
        Example:
            >>> obj = api.fetch_application_filters(name="my-object", folder="Texas")
            >>> if obj:
        ...
        try:
            response = self.list_application_filters(**list_params)
    ...
    def _update_application_filters_by_id_serialize(
        self,
        id,
        application_filters,
        _request_auth,
