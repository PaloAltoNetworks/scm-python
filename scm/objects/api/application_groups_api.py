...
class ApplicationGroupsApi:
    ...
    @validate_call
    @with_error_handling
    def create_application_groups(
        self,
        application_groups: Annotated[Optional[ApplicationGroups], Field(description="Created")] = None,
        ...
        :param application_groups: Created
        :type application_groups: ApplicationGroups
        ...
        _param = self._create_application_groups_serialize(
    ...
    @validate_call
    @with_error_handling
    def create_application_groups_with_http_info(
        self,
        application_groups: Annotated[Optional[ApplicationGroups], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def create_application_groups_without_preload_content(
        self,
        application_groups: Annotated[Optional[ApplicationGroups], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_application_groups_serialize(
        self,
        application_groups,
        _request_auth,
        _content_type,
        ...
        if application_groups is not None:
            _body_params = application_groups
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/application-groups',
    ...
    @validate_call
    @with_error_handling
    def delete_application_groups_by_id(
        self,
        ...
        _param = self._delete_application_groups_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def delete_application_groups_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def delete_application_groups_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _delete_application_groups_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/application-groups/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    @with_error_handling
    def get_application_groups_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
        ...
        _param = self._get_application_groups_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def get_application_groups_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def get_application_groups_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_application_groups_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def list_application_groups(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ApplicationGroupsListResponse",
            '400': "GenericError",
            '401': "GenericError",
            '403': "GenericError",
            '404': "GenericError",
    ...
    def list_application_groups_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApplicationGroupsListResponse]:
        """List application groups
    ...
    @validate_call
    @with_error_handling
    def update_application_groups_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        application_groups: Annotated[Optional[ApplicationGroups], Field(description="OK")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._update_application_groups_by_id_serialize(
            id=id,
            application_groups=application_groups,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    @with_error_handling
    def update_application_groups_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        application_groups: Annotated[Optional[ApplicationGroups], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    @with_error_handling
    def update_application_groups_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        application_groups: Annotated[Optional[ApplicationGroups], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    def fetch_application_groups(
        ...
        **kwargs
        ...
        """
        Fetch a single application_groups object by name.
        ...
        Example:
            >>> obj = api.fetch_application_groups(name="my-object", folder="Texas")
            >>> if obj:
        ...
        while True:
            ...
            response = self.list_application_groups(**list_params)
    ...
    def _update_application_groups_by_id_serialize(
        self,
        id,
        application_groups,
        _request_auth,
