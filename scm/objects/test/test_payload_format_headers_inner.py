...
class TestPayloadFormatHeadersInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PayloadFormatHeadersInner:
        """Test PayloadFormatHeadersInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayloadFormatHeadersInner`
        """
        model = PayloadFormatHeadersInner()
        if include_optional:
            return PayloadFormatHeadersInner(
                name = '',
                value = ''
            )
        else:
    ...
    def testPayloadFormatHeadersInner(self):
        """Test PayloadFormatHeadersInner"""
