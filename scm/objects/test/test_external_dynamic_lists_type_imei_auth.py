...
class TestExternalDynamicListsTypeImeiAuth(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ExternalDynamicListsTypeImeiAuth:
        """Test ExternalDynamicListsTypeImeiAuth
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExternalDynamicListsTypeImeiAuth`
        """
        model = ExternalDynamicListsTypeImeiAuth()
        if include_optional:
            return ExternalDynamicListsTypeImeiAuth(
                password = '',
                username = '0'
            )
        else:
    ...
    def testExternalDynamicListsTypeImeiAuth(self):
        """Test ExternalDynamicListsTypeImeiAuth"""
