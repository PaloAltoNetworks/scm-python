...
class TestServicesProtocolUdpOverride(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ServicesProtocolUdpOverride:
        """Test ServicesProtocolUdpOverride
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServicesProtocolUdpOverride`
        """
        model = ServicesProtocolUdpOverride()
        if include_optional:
            return ServicesProtocolUdpOverride(
                timeout = 1
            )
        else:
            return ServicesProtocolUdpOverride(
    ...
    def testServicesProtocolUdpOverride(self):
        """Test ServicesProtocolUdpOverride"""
