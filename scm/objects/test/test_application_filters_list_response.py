...
class TestApplicationFiltersListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApplicationFiltersListResponse:
        """Test ApplicationFiltersListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationFiltersListResponse`
        """
        model = ApplicationFiltersListResponse()
        if include_optional:
    ...
    def testApplicationFiltersListResponse(self):
        """Test ApplicationFiltersListResponse"""
