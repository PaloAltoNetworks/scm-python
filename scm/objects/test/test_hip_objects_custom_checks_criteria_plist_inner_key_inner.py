...
class TestHipObjectsCustomChecksCriteriaPlistInnerKeyInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> HipObjectsCustomChecksCriteriaPlistInnerKeyInner:
        """Test HipObjectsCustomChecksCriteriaPlistInnerKeyInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HipObjectsCustomChecksCriteriaPlistInnerKeyInner`
        """
        model = HipObjectsCustomChecksCriteriaPlistInnerKeyInner()
        if include_optional:
            return HipObjectsCustomChecksCriteriaPlistInnerKeyInner(
                name = '',
                negate = True,
    ...
    def testHipObjectsCustomChecksCriteriaPlistInnerKeyInner(self):
        """Test HipObjectsCustomChecksCriteriaPlistInnerKeyInner"""
