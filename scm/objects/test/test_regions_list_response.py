...
class TestRegionsListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RegionsListResponse:
        """Test RegionsListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegionsListResponse`
        """
        model = RegionsListResponse()
        if include_optional:
    ...
    def testRegionsListResponse(self):
        """Test RegionsListResponse"""
