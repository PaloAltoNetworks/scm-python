...
class TestServicesProtocolTcpOverride(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ServicesProtocolTcpOverride:
        """Test ServicesProtocolTcpOverride
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServicesProtocolTcpOverride`
        """
        model = ServicesProtocolTcpOverride()
        if include_optional:
            return ServicesProtocolTcpOverride(
                halfclose_timeout = 1,
                timeout = 1,
                timewait_timeout = 1
            )
    ...
    def testServicesProtocolTcpOverride(self):
        """Test ServicesProtocolTcpOverride"""
