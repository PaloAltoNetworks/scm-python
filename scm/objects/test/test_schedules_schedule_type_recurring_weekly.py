...
class TestSchedulesScheduleTypeRecurringWeekly(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SchedulesScheduleTypeRecurringWeekly:
        """Test SchedulesScheduleTypeRecurringWeekly
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SchedulesScheduleTypeRecurringWeekly`
        """
        model = SchedulesScheduleTypeRecurringWeekly()
        if include_optional:
            return SchedulesScheduleTypeRecurringWeekly(
                friday = [
    ...
    def testSchedulesScheduleTypeRecurringWeekly(self):
        """Test SchedulesScheduleTypeRecurringWeekly"""
