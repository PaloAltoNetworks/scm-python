...
class TestApplicationsSignatureInnerAndConditionInner(unittest.TestCase):
    """ApplicationsSignatureInnerAndConditionInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationsSignatureInnerAndConditionInner:
        """Test ApplicationsSignatureInnerAndConditionInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationsSignatureInnerAndConditionInner`
        """
        model = ApplicationsSignatureInnerAndConditionInner()
        if include_optional:
            return ApplicationsSignatureInnerAndConditionInner(
                name = '',
                or_condition = [
    ...
    def testApplicationsSignatureInnerAndConditionInner(self):
        """Test ApplicationsSignatureInnerAndConditionInner"""
