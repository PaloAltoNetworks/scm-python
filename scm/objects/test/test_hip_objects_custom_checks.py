...
class TestHipObjectsCustomChecks(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> HipObjectsCustomChecks:
        """Test HipObjectsCustomChecks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HipObjectsCustomChecks`
        """
    ...
    def testHipObjectsCustomChecks(self):
        """Test HipObjectsCustomChecks"""
