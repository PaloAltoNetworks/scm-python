...
class TestHipObjectsNetworkInfoCriteriaNetworkIsMobile(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> HipObjectsNetworkInfoCriteriaNetworkIsMobile:
        """Test HipObjectsNetworkInfoCriteriaNetworkIsMobile
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HipObjectsNetworkInfoCriteriaNetworkIsMobile`
        """
        model = HipObjectsNetworkInfoCriteriaNetworkIsMobile()
        if include_optional:
            return HipObjectsNetworkInfoCriteriaNetworkIsMobile(
    ...
    def testHipObjectsNetworkInfoCriteriaNetworkIsMobile(self):
        """Test HipObjectsNetworkInfoCriteriaNetworkIsMobile"""
