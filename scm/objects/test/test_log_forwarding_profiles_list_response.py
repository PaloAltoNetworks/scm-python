...
class TestLogForwardingProfilesListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LogForwardingProfilesListResponse:
        """Test LogForwardingProfilesListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogForwardingProfilesListResponse`
        """
        model = LogForwardingProfilesListResponse()
        if include_optional:
    ...
    def testLogForwardingProfilesListResponse(self):
        """Test LogForwardingProfilesListResponse"""
