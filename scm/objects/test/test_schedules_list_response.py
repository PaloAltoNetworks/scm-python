...
class TestSchedulesListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SchedulesListResponse:
        """Test SchedulesListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SchedulesListResponse`
        """
        model = SchedulesListResponse()
        if include_optional:
    ...
    def testSchedulesListResponse(self):
        """Test SchedulesListResponse"""
