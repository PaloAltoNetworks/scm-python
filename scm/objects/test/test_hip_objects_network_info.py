...
class TestHipObjectsNetworkInfo(unittest.TestCase):
    """HipObjectsNetworkInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HipObjectsNetworkInfo:
        """Test HipObjectsNetworkInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HipObjectsNetworkInfo`
        """
        model = HipObjectsNetworkInfo()
        if include_optional:
            return HipObjectsNetworkInfo(
    ...
    def testHipObjectsNetworkInfo(self):
        """Test HipObjectsNetworkInfo"""
