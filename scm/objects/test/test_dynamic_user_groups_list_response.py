...
class TestDynamicUserGroupsListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DynamicUserGroupsListResponse:
        """Test DynamicUserGroupsListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DynamicUserGroupsListResponse`
        """
        model = DynamicUserGroupsListResponse()
        if include_optional:
    ...
    def testDynamicUserGroupsListResponse(self):
        """Test DynamicUserGroupsListResponse"""
