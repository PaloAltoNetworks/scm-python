...
class TestExternalDynamicListsTypeIpAuth(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ExternalDynamicListsTypeIpAuth:
        """Test ExternalDynamicListsTypeIpAuth
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExternalDynamicListsTypeIpAuth`
        """
        model = ExternalDynamicListsTypeIpAuth()
        if include_optional:
            return ExternalDynamicListsTypeIpAuth(
                password = '',
                username = '0'
            )
        else:
    ...
    def testExternalDynamicListsTypeIpAuth(self):
        """Test ExternalDynamicListsTypeIpAuth"""
