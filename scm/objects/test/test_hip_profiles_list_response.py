...
class TestHIPProfilesListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> HIPProfilesListResponse:
        """Test HIPProfilesListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HIPProfilesListResponse`
        """
        model = HIPProfilesListResponse()
        if include_optional:
    ...
    def testHIPProfilesListResponse(self):
        """Test HIPProfilesListResponse"""
