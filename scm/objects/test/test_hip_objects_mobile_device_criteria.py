        ...
        if include_optional:
            return HipObjectsMobileDeviceCriteria(
                ...
                model = scm.objects.models.hip_objects_host_info_criteria_client_version.hip_objects_host_info_criteria_client_version(
                    ...
                    is_not = '', ),
                passcode_set = True,
                phone_number = scm.objects.models.hip_objects_host_info_criteria_client_version.hip_objects_host_info_criteria_client_version(
                    contains = '', 
                    is = '', 
                    is_not = '', ),
                tag = scm.objects.models.hip_objects_host_info_criteria_client_version.hip_objects_host_info_criteria_client_version(
                    contains = '', 
                    is = '', 
                    is_not = '', )
            )
