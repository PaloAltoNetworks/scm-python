...
class GenericError(BaseModel):
    ...
    """ # noqa: E501
    errors: Optional[List[ErrorDetailCauseInfo]] = Field(default=None, description="Array of detailed error cause information", alias="_errors")
    request_id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the API request", alias="_request_id")
