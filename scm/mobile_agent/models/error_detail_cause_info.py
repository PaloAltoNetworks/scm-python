...
class ErrorDetailCauseInfo(BaseModel):
    ...
    details: Optional[Any] = Field(default=None, description="Additional error details as string or structured object")
    help: Optional[StrictStr] = Field(default=None, description="Help text for resolving the error")
