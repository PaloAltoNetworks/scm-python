...
class GenericError(BaseModel):
    ...
    GenericError
    """ # noqa: E501
    errors: Optional[List[GenericErrorErrorsInner]] = Field(default=None, alias="_errors")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_errors": [GenericErrorErrorsInner.from_dict(_item) for _item in obj["_errors"]] if obj.get("_errors") is not None else None,
