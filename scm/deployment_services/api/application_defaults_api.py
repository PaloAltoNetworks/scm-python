...
class ApplicationDefaultsApi:
    ...
    def fetch_application_defaults(
        self,
        name: str,
        ...
        **kwargs
        ...
        """
        Fetch a single application_defaults object by name.
        ...
        Example:
            >>> obj = api.fetch_application_defaults(name="my-object", folder="Texas")
            >>> if obj:
        ...
        while True:
            ...
            response = self.list_application_defaults(**list_params)
