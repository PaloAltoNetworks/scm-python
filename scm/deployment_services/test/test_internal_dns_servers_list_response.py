...
class TestInternalDNSServersListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InternalDNSServersListResponse:
        """Test InternalDNSServersListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InternalDNSServersListResponse`
        """
        model = InternalDNSServersListResponse()
        if include_optional:
    ...
    def testInternalDNSServersListResponse(self):
        """Test InternalDNSServersListResponse"""
