...
class TestServiceConnectionGroupsListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ServiceConnectionGroupsListResponse:
        """Test ServiceConnectionGroupsListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceConnectionGroupsListResponse`
        """
        model = ServiceConnectionGroupsListResponse()
        if include_optional:
    ...
    def testServiceConnectionGroupsListResponse(self):
        """Test ServiceConnectionGroupsListResponse"""
