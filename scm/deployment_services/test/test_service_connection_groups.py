...
class TestServiceConnectionGroups(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ServiceConnectionGroups:
        """Test ServiceConnectionGroups
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceConnectionGroups`
        """
        model = ServiceConnectionGroups()
        if include_optional:
    ...
    def testServiceConnectionGroups(self):
        """Test ServiceConnectionGroups"""
