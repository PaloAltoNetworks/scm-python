...
class TestRemoteNetworksListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RemoteNetworksListResponse:
        """Test RemoteNetworksListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemoteNetworksListResponse`
        """
        model = RemoteNetworksListResponse()
        if include_optional:
    ...
    def testRemoteNetworksListResponse(self):
        """Test RemoteNetworksListResponse"""
