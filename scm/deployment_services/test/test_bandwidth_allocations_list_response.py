...
class TestBandwidthAllocationsListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BandwidthAllocationsListResponse:
        """Test BandwidthAllocationsListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BandwidthAllocationsListResponse`
        """
        model = BandwidthAllocationsListResponse()
        if include_optional:
    ...
    def testBandwidthAllocationsListResponse(self):
        """Test BandwidthAllocationsListResponse"""
