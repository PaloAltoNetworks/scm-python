...
class TestTrafficSteeringRulesListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TrafficSteeringRulesListResponse:
        """Test TrafficSteeringRulesListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrafficSteeringRulesListResponse`
        """
        model = TrafficSteeringRulesListResponse()
        if include_optional:
    ...
    def testTrafficSteeringRulesListResponse(self):
        """Test TrafficSteeringRulesListResponse"""
