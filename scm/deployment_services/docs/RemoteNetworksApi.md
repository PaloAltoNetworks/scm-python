# scm_deployment_services.RemoteNetworksApi
...
with scm_deployment_services.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_deployment_services.RemoteNetworksApi(api_client)
    remote_networks = scm_deployment_services.RemoteNetworks() # RemoteNetworks | Created (optional)
...
with scm_deployment_services.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_deployment_services.RemoteNetworksApi(api_client)
    id = 'id_example' # str | The UUID of the configuration resource
    remote_networks = scm_deployment_services.RemoteNetworks() # RemoteNetworks | OK (optional)
