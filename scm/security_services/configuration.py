...
class Configuration:
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://api.strata.paloaltonetworks.com/config/security/v1" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("scm_security_services")
