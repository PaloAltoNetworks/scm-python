# scm_security_services.DoSProtectionProfilesApi
...
with scm_security_services.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_security_services.DoSProtectionProfilesApi(api_client)
    dos_protection_profiles = scm_security_services.DosProtectionProfiles() # DosProtectionProfiles | Created (optional)
...
with scm_security_services.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_security_services.DoSProtectionProfilesApi(api_client)
    id = '123e4567-e89b-12d3-a456-426655440000' # str | The UUID of the configuration resource
    dos_protection_profiles = scm_security_services.DosProtectionProfiles() # DosProtectionProfiles | OK (optional)
