# scm.security_services.DecryptionProfilesApi
...
with scm.security_services.ApiClient(configuration) as api_client:
    ...
    api_instance = scm.security_services.DecryptionProfilesApi(api_client)
    decryption_profiles = scm.security_services.DecryptionProfiles() # DecryptionProfiles | Created (optional)
...
with scm.security_services.ApiClient(configuration) as api_client:
    ...
    api_instance = scm.security_services.DecryptionProfilesApi(api_client)
    id = '123e4567-e89b-12d3-a456-426655440000' # str | The UUID of the configuration resource
    decryption_profiles = scm.security_services.DecryptionProfiles() # DecryptionProfiles | OK (optional)
