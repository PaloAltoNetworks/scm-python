# scm_security_services.HTTPHeaderProfilesApi
...
with scm_security_services.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_security_services.HTTPHeaderProfilesApi(api_client)
    http_header_profiles = scm_security_services.HttpHeaderProfiles() # HttpHeaderProfiles | Created (optional)
...
with scm_security_services.ApiClient(configuration) as api_client:
    ...
    api_instance = scm_security_services.HTTPHeaderProfilesApi(api_client)
    id = '123e4567-e89b-12d3-a456-426655440000' # str | The UUID of the configuration resource
    http_header_profiles = scm_security_services.HttpHeaderProfiles() # HttpHeaderProfiles | OK (optional)
