...
class TestAntiSpywareSignaturesSignatureStandardInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AntiSpywareSignaturesSignatureStandardInner:
        """Test AntiSpywareSignaturesSignatureStandardInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AntiSpywareSignaturesSignatureStandardInner`
        """
        model = AntiSpywareSignaturesSignatureStandardInner()
        if include_optional:
    ...
    def testAntiSpywareSignaturesSignatureStandardInner(self):
        """Test AntiSpywareSignaturesSignatureStandardInner"""
