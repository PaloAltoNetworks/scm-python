...
class TestDosProtectionRulesProtectionAggregate(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DosProtectionRulesProtectionAggregate:
        """Test DosProtectionRulesProtectionAggregate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DosProtectionRulesProtectionAggregate`
        """
        model = DosProtectionRulesProtectionAggregate()
        if include_optional:
            return DosProtectionRulesProtectionAggregate(
                profile = ''
            )
        else:
            return DosProtectionRulesProtectionAggregate(
    ...
    def testDosProtectionRulesProtectionAggregate(self):
        """Test DosProtectionRulesProtectionAggregate"""
