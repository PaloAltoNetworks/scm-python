...
class TestSaasTenantRestrictions(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SaasTenantRestrictions:
        """Test SaasTenantRestrictions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SaasTenantRestrictions`
        """
        model = SaasTenantRestrictions()
        if include_optional:
    ...
    def testSaasTenantRestrictions(self):
        """Test SaasTenantRestrictions"""
