...
class TestFileBlockingProfilesListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FileBlockingProfilesListResponse:
        """Test FileBlockingProfilesListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileBlockingProfilesListResponse`
        """
        model = FileBlockingProfilesListResponse()
        if include_optional:
    ...
    def testFileBlockingProfilesListResponse(self):
        """Test FileBlockingProfilesListResponse"""
