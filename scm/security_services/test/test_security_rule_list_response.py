...
class TestSecurityRuleListResponse(unittest.TestCase):
    """SecurityRuleListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SecurityRuleListResponse:
        """Test SecurityRuleListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SecurityRuleListResponse`
        """
        model = SecurityRuleListResponse()
        if include_optional:
            return SecurityRuleListResponse(
                data = [
                    scm_security_services.models.security_rules.security-rules(
                        action = 'allow', 
                        allow_url_category = [
    ...
    def testSecurityRuleListResponse(self):
        """Test SecurityRuleListResponse"""
