...
class TestWildfireAntiVirusProfilesMlavExceptionInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WildfireAntiVirusProfilesMlavExceptionInner:
        """Test WildfireAntiVirusProfilesMlavExceptionInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WildfireAntiVirusProfilesMlavExceptionInner`
        """
        model = WildfireAntiVirusProfilesMlavExceptionInner()
        if include_optional:
            return WildfireAntiVirusProfilesMlavExceptionInner(
                description = '',
                filename = '',
                name = ''
            )
    ...
    def testWildfireAntiVirusProfilesMlavExceptionInner(self):
        """Test WildfireAntiVirusProfilesMlavExceptionInner"""
