...
class TestAntiSpywareSignaturesSignatureCombination(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AntiSpywareSignaturesSignatureCombination:
        """Test AntiSpywareSignaturesSignatureCombination
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AntiSpywareSignaturesSignatureCombination`
        """
        model = AntiSpywareSignaturesSignatureCombination()
        if include_optional:
    ...
    def testAntiSpywareSignaturesSignatureCombination(self):
        """Test AntiSpywareSignaturesSignatureCombination"""
