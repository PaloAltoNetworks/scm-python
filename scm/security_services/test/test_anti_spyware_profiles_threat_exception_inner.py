...
class TestAntiSpywareProfilesThreatExceptionInner(unittest.TestCase):
    """AntiSpywareProfilesThreatExceptionInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AntiSpywareProfilesThreatExceptionInner:
        """Test AntiSpywareProfilesThreatExceptionInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AntiSpywareProfilesThreatExceptionInner`
        """
        model = AntiSpywareProfilesThreatExceptionInner()
        if include_optional:
            return AntiSpywareProfilesThreatExceptionInner(
    ...
    def testAntiSpywareProfilesThreatExceptionInner(self):
        """Test AntiSpywareProfilesThreatExceptionInner"""
