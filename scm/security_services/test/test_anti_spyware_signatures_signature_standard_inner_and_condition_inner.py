...
class TestAntiSpywareSignaturesSignatureStandardInnerAndConditionInner(unittest.TestCase):
    """AntiSpywareSignaturesSignatureStandardInnerAndConditionInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AntiSpywareSignaturesSignatureStandardInnerAndConditionInner:
        """Test AntiSpywareSignaturesSignatureStandardInnerAndConditionInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AntiSpywareSignaturesSignatureStandardInnerAndConditionInner`
        """
        model = AntiSpywareSignaturesSignatureStandardInnerAndConditionInner()
        if include_optional:
            return AntiSpywareSignaturesSignatureStandardInnerAndConditionInner(
                name = '',
                or_condition = [
    ...
    def testAntiSpywareSignaturesSignatureStandardInnerAndConditionInner(self):
        """Test AntiSpywareSignaturesSignatureStandardInnerAndConditionInner"""
