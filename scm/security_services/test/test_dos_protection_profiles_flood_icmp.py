...
class TestDosProtectionProfilesFloodIcmp(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DosProtectionProfilesFloodIcmp:
        """Test DosProtectionProfilesFloodIcmp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DosProtectionProfilesFloodIcmp`
        """
        model = DosProtectionProfilesFloodIcmp()
        if include_optional:
    ...
    def testDosProtectionProfilesFloodIcmp(self):
        """Test DosProtectionProfilesFloodIcmp"""
