...
class TestAntiSpywareSignaturesSignatureCombinationAndConditionInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AntiSpywareSignaturesSignatureCombinationAndConditionInner:
        """Test AntiSpywareSignaturesSignatureCombinationAndConditionInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AntiSpywareSignaturesSignatureCombinationAndConditionInner`
        """
        model = AntiSpywareSignaturesSignatureCombinationAndConditionInner()
        if include_optional:
    ...
    def testAntiSpywareSignaturesSignatureCombinationAndConditionInner(self):
        """Test AntiSpywareSignaturesSignatureCombinationAndConditionInner"""
