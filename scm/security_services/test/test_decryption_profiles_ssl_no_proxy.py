...
class TestDecryptionProfilesSslNoProxy(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DecryptionProfilesSslNoProxy:
        """Test DecryptionProfilesSslNoProxy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DecryptionProfilesSslNoProxy`
        """
        model = DecryptionProfilesSslNoProxy()
        if include_optional:
            return DecryptionProfilesSslNoProxy(
    ...
    def testDecryptionProfilesSslNoProxy(self):
        """Test DecryptionProfilesSslNoProxy"""
