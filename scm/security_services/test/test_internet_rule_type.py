...
class TestInternetRuleType(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InternetRuleType:
        """Test InternetRuleType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InternetRuleType`
        """
        model = InternetRuleType()
        if include_optional:
