...
class TestDosProtectionProfilesResourceSessions(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DosProtectionProfilesResourceSessions:
        """Test DosProtectionProfilesResourceSessions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DosProtectionProfilesResourceSessions`
        """
        model = DosProtectionProfilesResourceSessions()
        if include_optional:
            return DosProtectionProfilesResourceSessions(
                enabled = True,
    ...
    def testDosProtectionProfilesResourceSessions(self):
        """Test DosProtectionProfilesResourceSessions"""
