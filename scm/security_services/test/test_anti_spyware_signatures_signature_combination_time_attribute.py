...
class TestAntiSpywareSignaturesSignatureCombinationTimeAttribute(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AntiSpywareSignaturesSignatureCombinationTimeAttribute:
        """Test AntiSpywareSignaturesSignatureCombinationTimeAttribute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AntiSpywareSignaturesSignatureCombinationTimeAttribute`
        """
        model = AntiSpywareSignaturesSignatureCombinationTimeAttribute()
        if include_optional:
            return AntiSpywareSignaturesSignatureCombinationTimeAttribute(
                interval = 1,
                threshold = 1,
    ...
    def testAntiSpywareSignaturesSignatureCombinationTimeAttribute(self):
        """Test AntiSpywareSignaturesSignatureCombinationTimeAttribute"""
