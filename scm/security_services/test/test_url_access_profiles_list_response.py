...
class TestURLAccessProfilesListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> URLAccessProfilesListResponse:
        """Test URLAccessProfilesListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `URLAccessProfilesListResponse`
        """
        model = URLAccessProfilesListResponse()
        if include_optional:
    ...
    def testURLAccessProfilesListResponse(self):
        """Test URLAccessProfilesListResponse"""
