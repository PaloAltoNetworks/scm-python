...
class TestURLFilteringCategoriesListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> URLFilteringCategoriesListResponse:
        """Test URLFilteringCategoriesListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `URLFilteringCategoriesListResponse`
        """
        model = URLFilteringCategoriesListResponse()
        if include_optional:
    ...
    def testURLFilteringCategoriesListResponse(self):
        """Test URLFilteringCategoriesListResponse"""
