...
class TestDecryptionProfilesListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DecryptionProfilesListResponse:
        """Test DecryptionProfilesListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DecryptionProfilesListResponse`
        """
        model = DecryptionProfilesListResponse()
        if include_optional:
    ...
    def testDecryptionProfilesListResponse(self):
        """Test DecryptionProfilesListResponse"""
