...
class TestDNSSecurityProfilesListResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DNSSecurityProfilesListResponse:
        """Test DNSSecurityProfilesListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DNSSecurityProfilesListResponse`
        """
        model = DNSSecurityProfilesListResponse()
        if include_optional:
    ...
    def testDNSSecurityProfilesListResponse(self):
        """Test DNSSecurityProfilesListResponse"""
