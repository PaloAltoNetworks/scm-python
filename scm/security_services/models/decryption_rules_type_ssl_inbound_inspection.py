...
class DecryptionRulesTypeSslInboundInspection(BaseModel):
    """
    add the certificate name for SSL inbound inspection
    """ # noqa: E501
    certificates: Optional[List[StrictStr]] = Field(default=None, description="List of certificate names for SSL inbound inspection")
