...
class InternetRuleTypeLogSettings(BaseModel):
    """
    InternetRuleTypeLogSettings
    """ # noqa: E501
    log_sessions: Optional[StrictBool] = True
    __properties: ClassVar[List[str]] = ["log_sessions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "log_sessions": obj.get("log_sessions") if obj.get("log_sessions") is not None else True
        })
        return _obj
