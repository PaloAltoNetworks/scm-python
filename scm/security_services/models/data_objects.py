...
class DataObjects(BaseModel):
    ...
    DataObjects
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="The description of the data object")
    ...
    id: Optional[StrictStr] = Field(default=None, description="The UUID of the data object")
    name: Optional[StrictStr] = Field(default=None, description="The name of the data object")
    pattern_type: Optional[DataObjectsPatternType] = None
    ...
    __properties: ClassVar[List[str]] = ["description", "device", "disable_override", "folder", "id", "name", "pattern_type", "snippet"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of pattern_type
        if self.pattern_type:
            _dict['pattern_type'] = self.pattern_type.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "pattern_type": DataObjectsPatternType.from_dict(obj["pattern_type"]) if obj.get("pattern_type") is not None else None,
