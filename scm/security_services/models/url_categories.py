...
class UrlCategories(BaseModel):
    ...
    type: Optional[StrictStr] = 'URL List'
    __properties: ClassVar[List[str]] = ["description", "device", "folder", "id", "list", "name", "snippet", "type"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['URL List', 'Category Match']):
            raise ValueError("must be one of enum values ('URL List', 'Category Match')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type") if obj.get("type") is not None else 'URL List'
        })
        return _obj
