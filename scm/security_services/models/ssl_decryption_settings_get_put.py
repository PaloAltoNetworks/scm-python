...
class SslDecryptionSettingsGetPut(BaseModel):
    """
    ...
    ssl_decrypt: SslDecryptionSettingsGetPutSslDecrypt
    __properties: ClassVar[List[str]] = ["device", "folder", "snippet", "ssl_decrypt"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of ssl_decrypt
        if self.ssl_decrypt:
            _dict['ssl_decrypt'] = self.ssl_decrypt.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ssl_decrypt": SslDecryptionSettingsGetPutSslDecrypt.from_dict(obj["ssl_decrypt"]) if obj.get("ssl_decrypt") is not None else None
        })
        return _obj
