...
class DosProtectionProfilesResource(BaseModel):
    """
    DosProtectionProfilesResource
    """ # noqa: E501
    sessions: Optional[DosProtectionProfilesResourceSessions] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sessions": DosProtectionProfilesResourceSessions.from_dict(obj["sessions"]) if obj.get("sessions") is not None else None
        })
        return _obj
