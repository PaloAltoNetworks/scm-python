...
class DoSProtectionRulesListResponse(BaseModel):
    """
    DoSProtectionRulesListResponse
    """ # noqa: E501
    data: List[DosProtectionRules]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        if "data" not in obj and "total" not in obj:
            single_obj = DosProtectionRules.from_dict(obj)
        ...
        _obj = cls.model_validate({
            "data": [DosProtectionRules.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
