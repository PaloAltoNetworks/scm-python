...
class SecurityRuleListResponse(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[List[SecurityRules]] = None
    limit: Optional[StrictInt] = 200
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        if "data" not in obj and "total" not in obj:
            single_obj = SecurityRules.from_dict(obj)
        ...
        _obj = cls.model_validate({
            "data": [SecurityRules.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
