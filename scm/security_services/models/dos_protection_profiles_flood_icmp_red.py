...
class DosProtectionProfilesFloodIcmpRed(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activate-rate": obj.get("activate-rate") if obj.get("activate-rate") is not None else 10000,
            "alarm-rate": obj.get("alarm-rate") if obj.get("alarm-rate") is not None else 10000,
            "block": DosProtectionProfilesFloodIcmpRedBlock.from_dict(obj["block"]) if obj.get("block") is not None else None,
            "maximal-rate": obj.get("maximal-rate") if obj.get("maximal-rate") is not None else 40000
        })
        return _obj
