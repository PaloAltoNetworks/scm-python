...
class DataFilteringProfiles(BaseModel):
    """
    DataFilteringProfiles
    """ # noqa: E501
    data_capture: Optional[StrictBool] = None
    description: Optional[StrictStr] = Field(default=None, description="The description of the data filtering profile")
    ...
    disable_override: Optional[StrictStr] = None
    ...
    id: Optional[StrictStr] = Field(default=None, description="The UUID of the data filtering profile")
    name: Optional[StrictStr] = Field(default=None, description="The name of the data filtering profile")
    rules: Optional[List[DataFilteringProfilesRulesInner]] = None
    ...
    __properties: ClassVar[List[str]] = ["data_capture", "description", "device", "disable_override", "folder", "id", "name", "rules", "snippet"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data_capture": obj.get("data_capture"),
            "description": obj.get("description"),
            "device": obj.get("device"),
            "disable_override": obj.get("disable_override"),
            "folder": obj.get("folder"),
            "id": obj.get("id"),
            "name": obj.get("name"),
            "rules": [DataFilteringProfilesRulesInner.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None,
