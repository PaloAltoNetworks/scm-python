...
class InternetRuleTypeAllowWebApplicationInnerTenantControl(BaseModel):
    """
    InternetRuleTypeAllowWebApplicationInnerTenantControl
    """ # noqa: E501
    allowed_activities: Optional[List[StrictStr]] = None
    blocked_activities: Optional[List[StrictStr]] = None
    parent_application: Optional[StrictStr] = None
    tenants: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["allowed_activities", "blocked_activities", "parent_application", "tenants"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "allowed_activities": obj.get("allowed_activities"),
            "blocked_activities": obj.get("blocked_activities"),
