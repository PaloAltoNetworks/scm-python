...
class DnsSecurityProfilesBotnetDomainsListsInnerAction(BaseModel):
    """
    ...
    sinkhole: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["alert", "allow", "block", "sinkhole"]
