...
class DosProtectionRulesProtection(BaseModel):
    """
    DosProtectionRulesProtection
    """ # noqa: E501
    aggregate: Optional[DosProtectionRulesProtectionAggregate] = None
    classified: Optional[DosProtectionRulesProtectionClassified] = None
    __properties: ClassVar[List[str]] = ["aggregate", "classified"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of classified
        if self.classified:
            _dict['classified'] = self.classified.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "aggregate": DosProtectionRulesProtectionAggregate.from_dict(obj["aggregate"]) if obj.get("aggregate") is not None else None,
            "classified": DosProtectionRulesProtectionClassified.from_dict(obj["classified"]) if obj.get("classified") is not None else None
        })
        return _obj
