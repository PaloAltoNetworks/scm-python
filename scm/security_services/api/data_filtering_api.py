...
class DataFilteringApi:
    ...
    @validate_call
    @with_error_handling
    def create_data_filtering_profiles(
        self,
        data_filtering_profiles: DataFilteringProfiles,
        ...
        :param data_filtering_profiles: (required)
        :type data_filtering_profiles: DataFilteringProfiles
        ...
        _param = self._create_data_filtering_profiles_serialize(
    ...
    @validate_call
    @with_error_handling
    def create_data_filtering_profiles_with_http_info(
        self,
        data_filtering_profiles: DataFilteringProfiles,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DataFilteringProfiles]:
        """Create Data Filtering Profile
    ...
    @validate_call
    @with_error_handling
    def create_data_filtering_profiles_without_preload_content(
        self,
        data_filtering_profiles: DataFilteringProfiles,
        _request_timeout: Union[
            None,
    ...
    def _create_data_filtering_profiles_serialize(
        self,
        ...
        if data_filtering_profiles is not None:
            _body_params = data_filtering_profiles
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/data-filtering-profiles',
    ...
    @validate_call
    @with_error_handling
    def delete_data_filtering_profiles_by_id(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _param = self._delete_data_filtering_profiles_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def delete_data_filtering_profiles_by_id_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def delete_data_filtering_profiles_by_id_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _delete_data_filtering_profiles_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/data-filtering-profiles/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    @with_error_handling
    def get_data_filtering_profiles_by_id(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _param = self._get_data_filtering_profiles_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def get_data_filtering_profiles_by_id_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def get_data_filtering_profiles_by_id_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_data_filtering_profiles_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    @with_error_handling
    def list_data_filtering_profiles(
        self,
        ...
        _param = self._list_data_filtering_profiles_serialize(
            name=name,
            folder=folder,
            snippet=snippet,
            device=device,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DataFilteringProfilesListResponse",
            '400': "GenericError",
            '401': "GenericError",
            '403': "GenericError",
            '404': "GenericError",
    ...
    @validate_call
    @with_error_handling
    def list_data_filtering_profiles_with_http_info(
        self,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DataFilteringProfilesListResponse]:
        """List Data Filtering Profiles
    ...
    @validate_call
    @with_error_handling
    def list_data_filtering_profiles_without_preload_content(
        self,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
    ...
    def _list_data_filtering_profiles_serialize(
        self,
        name,
        folder,
        snippet,
    ...
    @validate_call
    @with_error_handling
    def update_data_filtering_profiles_by_id(
        self,
        id: StrictStr,
        data_filtering_profiles: DataFilteringProfiles,
        _request_timeout: Union[
        ...
        _param = self._update_data_filtering_profiles_by_id_serialize(
            id=id,
            data_filtering_profiles=data_filtering_profiles,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    @with_error_handling
    def update_data_filtering_profiles_by_id_with_http_info(
        self,
        id: StrictStr,
        data_filtering_profiles: DataFilteringProfiles,
        _request_timeout: Union[
    ...
    @validate_call
    @with_error_handling
    def update_data_filtering_profiles_by_id_without_preload_content(
        self,
        id: StrictStr,
        data_filtering_profiles: DataFilteringProfiles,
        _request_timeout: Union[
    ...
    def fetch_data_filtering(
        ...
        **kwargs
        ...
        """
        Fetch a single data_filtering object by name.
        ...
        Example:
            >>> obj = api.fetch_data_filtering(name="my-object", folder="Texas")
            >>> if obj:
        ...
        try:
            response = self.list_data_filtering_profiles(**list_params)
