...
class DataObjectsApi:
    ...
    def create_data_objects(
        ...
        :param data_objects: (required)
        :type data_objects: DataObjects
        ...
        _param = self._create_data_objects_serialize(
    ...
    @validate_call
    @with_error_handling
    def create_data_objects_with_http_info(
        self,
        data_objects: DataObjects,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def create_data_objects_without_preload_content(
        self,
        data_objects: DataObjects,
        _request_timeout: Union[
            None,
    ...
    def _create_data_objects_serialize(
        self,
        data_objects,
        _request_auth,
        _content_type,
    ...
    def delete_data_objects_by_id(
        ...
        _param = self._delete_data_objects_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def delete_data_objects_by_id_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def delete_data_objects_by_id_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _delete_data_objects_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def get_data_objects_by_id(
        ...
        _param = self._get_data_objects_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def get_data_objects_by_id_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def get_data_objects_by_id_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_data_objects_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def list_data_objects(
        ...
        _param = self._list_data_objects_serialize(
            name=name,
            folder=folder,
            snippet=snippet,
            device=device,
    ...
    @validate_call
    @with_error_handling
    def list_data_objects_with_http_info(
        self,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DataObjectsListResponse]:
        """List Data Objects
    ...
    @validate_call
    @with_error_handling
    def list_data_objects_without_preload_content(
        self,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
    ...
    def _list_data_objects_serialize(
        self,
        name,
        folder,
        snippet,
    ...
    def update_data_objects_by_id(
        ...
        _param = self._update_data_objects_by_id_serialize(
            id=id,
            data_objects=data_objects,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    @with_error_handling
    def update_data_objects_by_id_with_http_info(
        self,
        id: StrictStr,
        data_objects: DataObjects,
        _request_timeout: Union[
    ...
    @validate_call
    @with_error_handling
    def update_data_objects_by_id_without_preload_content(
        self,
        id: StrictStr,
        data_objects: DataObjects,
        _request_timeout: Union[
    ...
    def fetch_data_objects(
        ...
        **kwargs
        ...
        """
        Fetch a single data_objects object by name.
        ...
        Example:
            >>> obj = api.fetch_data_objects(name="my-object", folder="Texas")
            >>> if obj:
        ...
        try:
            response = self.list_data_objects(**list_params)
    ...
    def _update_data_objects_by_id_serialize(
        self,
        id,
        data_objects,
        _request_auth,
