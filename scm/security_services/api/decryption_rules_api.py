...
class DecryptionRulesApi:
    ...
    @validate_call
    @with_error_handling
    def create_decryption_rules(
        self,
        position: Annotated[StrictStr, Field(description="The position of a security rule ")],
        decryption_rules: Annotated[Optional[DecryptionRules], Field(description="Created")] = None,
        ...
        :type position: str
        :param decryption_rules: Created
        :type decryption_rules: DecryptionRules
        ...
        _param = self._create_decryption_rules_serialize(
            position=position,
    ...
    @validate_call
    @with_error_handling
    def create_decryption_rules_with_http_info(
        self,
        position: Annotated[StrictStr, Field(description="The position of a security rule ")],
        decryption_rules: Annotated[Optional[DecryptionRules], Field(description="Created")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    @with_error_handling
    def create_decryption_rules_without_preload_content(
        self,
        position: Annotated[StrictStr, Field(description="The position of a security rule ")],
        decryption_rules: Annotated[Optional[DecryptionRules], Field(description="Created")] = None,
        _request_timeout: Union[
    ...
    def _create_decryption_rules_serialize(
        self,
        position,
        decryption_rules,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/decryption-rules',
    ...
    @validate_call
    @with_error_handling
    def delete_decryption_rules_by_id(
        self,
        ...
        _param = self._delete_decryption_rules_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def delete_decryption_rules_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def delete_decryption_rules_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _delete_decryption_rules_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/decryption-rules/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    @with_error_handling
    def get_decryption_rules_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
        ...
        _param = self._get_decryption_rules_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def get_decryption_rules_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def get_decryption_rules_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_decryption_rules_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def list_decryption_rules(
        ...
        _param = self._list_decryption_rules_serialize(
            position=position,
            name=name,
            folder=folder,
            snippet=snippet,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DecryptionRulesListResponse",
            '400': "GenericError",
            '401': "GenericError",
            '403': "GenericError",
            '404': "GenericError",
    ...
    @validate_call
    @with_error_handling
    def list_decryption_rules_with_http_info(
        self,
        position: Annotated[StrictStr, Field(description="The position of a security rule ")],
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DecryptionRulesListResponse]:
        """List decryption rules
    ...
    @validate_call
    @with_error_handling
    def list_decryption_rules_without_preload_content(
        self,
        position: Annotated[StrictStr, Field(description="The position of a security rule ")],
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
    ...
    def _list_decryption_rules_serialize(
        self,
        position,
        name,
        folder,
    ...
    @validate_call
    @with_error_handling
    def move_decryption_rules_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        ...
        _param = self._move_decryption_rules_by_id_serialize(
            id=id,
    ...
    @validate_call
    @with_error_handling
    def move_decryption_rules_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        rule_based_move: Annotated[Optional[RuleBasedMove], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    @with_error_handling
    def move_decryption_rules_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        rule_based_move: Annotated[Optional[RuleBasedMove], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    def _move_decryption_rules_by_id_serialize(
        self,
        id,
        rule_based_move,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/decryption-rules/{id}:move',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    @with_error_handling
    def update_decryption_rules_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        decryption_rules: Annotated[Optional[DecryptionRules], Field(description="OK")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._update_decryption_rules_by_id_serialize(
            id=id,
            decryption_rules=decryption_rules,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    @with_error_handling
    def update_decryption_rules_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        decryption_rules: Annotated[Optional[DecryptionRules], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    @with_error_handling
    def update_decryption_rules_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        decryption_rules: Annotated[Optional[DecryptionRules], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    def fetch_decryption_rules(
        ...
        **kwargs
        ...
        """
        Fetch a single decryption_rules object by name.
        ...
        Example:
            >>> obj = api.fetch_decryption_rules(name="my-object", folder="Texas")
            >>> if obj:
        ...
        while True:
            ...
            response = self.list_decryption_rules(**list_params)
