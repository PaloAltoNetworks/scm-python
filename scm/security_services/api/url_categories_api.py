...
class URLCategoriesApi:
    ...
    @validate_call
    @with_error_handling
    def create_url_categories(
        self,
        url_categories: Annotated[Optional[UrlCategories], Field(description="Created")] = None,
        ...
        :param url_categories: Created
        :type url_categories: UrlCategories
        ...
        _param = self._create_url_categories_serialize(
    ...
    @validate_call
    @with_error_handling
    def create_url_categories_with_http_info(
        self,
        url_categories: Annotated[Optional[UrlCategories], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def create_url_categories_without_preload_content(
        self,
        url_categories: Annotated[Optional[UrlCategories], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_url_categories_serialize(
        self,
        url_categories,
        _request_auth,
        _content_type,
    ...
    @validate_call
    @with_error_handling
    def delete_url_categories_by_id(
        self,
        ...
        _param = self._delete_url_categories_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def delete_url_categories_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def delete_url_categories_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _delete_url_categories_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/url-categories/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_url_categories_by_id(
        ...
        _param = self._get_url_categories_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def get_url_categories_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def get_url_categories_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_url_categories_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def list_url_categories(
        ...
        _param = self._list_url_categories_serialize(
            name=name,
            folder=folder,
            snippet=snippet,
            device=device,
    ...
    @validate_call
    @with_error_handling
    def list_url_categories_with_http_info(
        self,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[URLCategoriesListResponse]:
        """List custom URL categories
    ...
    @validate_call
    @with_error_handling
    def list_url_categories_without_preload_content(
        self,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
    ...
    def _list_url_categories_serialize(
        self,
        name,
        folder,
        snippet,
    ...
    @validate_call
    @with_error_handling
    def update_url_categories_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        url_categories: Annotated[Optional[UrlCategories], Field(description="OK")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._update_url_categories_by_id_serialize(
            id=id,
            url_categories=url_categories,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    @with_error_handling
    def update_url_categories_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        url_categories: Annotated[Optional[UrlCategories], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    @with_error_handling
    def update_url_categories_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        url_categories: Annotated[Optional[UrlCategories], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    def fetch_url_categories(
        ...
        **kwargs
        ...
        """
        Fetch a single url_categories object by name.
        ...
        Example:
            >>> obj = api.fetch_url_categories(name="my-object", folder="Texas")
            >>> if obj:
        ...
        try:
            response = self.list_url_categories(**list_params)
