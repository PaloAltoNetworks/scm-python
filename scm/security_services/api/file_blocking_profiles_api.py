...
class FileBlockingProfilesApi:
    ...
    @validate_call
    @with_error_handling
    def create_file_blocking_profiles(
        self,
        file_blocking_profiles: Annotated[Optional[FileBlockingProfiles], Field(description="Created")] = None,
        ...
        :param file_blocking_profiles: Created
        :type file_blocking_profiles: FileBlockingProfiles
        ...
        _param = self._create_file_blocking_profiles_serialize(
            file_blocking_profiles=file_blocking_profiles,
    ...
    @validate_call
    @with_error_handling
    def create_file_blocking_profiles_with_http_info(
        self,
        file_blocking_profiles: Annotated[Optional[FileBlockingProfiles], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FileBlockingProfiles]:
        """Create a file blocking profiles
    ...
    @validate_call
    @with_error_handling
    def create_file_blocking_profiles_without_preload_content(
        self,
        file_blocking_profiles: Annotated[Optional[FileBlockingProfiles], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_file_blocking_profiles_serialize(
        self,
        ...
        if file_blocking_profiles is not None:
            _body_params = file_blocking_profiles
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/file-blocking-profiles',
    ...
    @validate_call
    @with_error_handling
    def delete_file_blocking_profiles_by_id(
        self,
        ...
        _param = self._delete_file_blocking_profiles_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def delete_file_blocking_profiles_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def delete_file_blocking_profiles_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _delete_file_blocking_profiles_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/file-blocking-profiles/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    @with_error_handling
    def get_file_blocking_profiles_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
        ...
        _param = self._get_file_blocking_profiles_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def get_file_blocking_profiles_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def get_file_blocking_profiles_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_file_blocking_profiles_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    @with_error_handling
    def list_file_blocking_profiles(
        self,
        ...
        _param = self._list_file_blocking_profiles_serialize(
            name=name,
            folder=folder,
            snippet=snippet,
            device=device,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "FileBlockingProfilesListResponse",
            '400': "GenericError",
            '401': "GenericError",
            '403': "GenericError",
            '404': "GenericError",
    ...
    @validate_call
    @with_error_handling
    def list_file_blocking_profiles_with_http_info(
        self,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FileBlockingProfilesListResponse]:
        """List file blocking profiles
    ...
    @validate_call
    @with_error_handling
    def list_file_blocking_profiles_without_preload_content(
        self,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
    ...
    def _list_file_blocking_profiles_serialize(
        self,
        name,
        folder,
        snippet,
    ...
    @validate_call
    @with_error_handling
    def update_file_blocking_profiles_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        file_blocking_profiles: Annotated[Optional[FileBlockingProfiles], Field(description="OK")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: The UUID of the configuration resource (required)
        :type id: str
        :param file_blocking_profiles: OK
        :type file_blocking_profiles: FileBlockingProfiles
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._update_file_blocking_profiles_by_id_serialize(
            id=id,
            file_blocking_profiles=file_blocking_profiles,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    @with_error_handling
    def update_file_blocking_profiles_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        file_blocking_profiles: Annotated[Optional[FileBlockingProfiles], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    @with_error_handling
    def update_file_blocking_profiles_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        file_blocking_profiles: Annotated[Optional[FileBlockingProfiles], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    def fetch_file_blocking_profiles(
        self,
        name: str,
        ...
        **kwargs
        ...
        """
        Fetch a single file_blocking_profiles object by name.
        ...
        Example:
            >>> obj = api.fetch_file_blocking_profiles(name="my-object", folder="Texas")
            >>> if obj:
        ...
        while True:
            ...
            response = self.list_file_blocking_profiles(**list_params)
    ...
    def _update_file_blocking_profiles_by_id_serialize(
        self,
        id,
        file_blocking_profiles,
        _request_auth,
