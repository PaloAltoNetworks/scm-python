...
class DecryptionExclusionsApi:
    ...
    @validate_call
    @with_error_handling
    def create_decryption_exclusions(
        self,
        decryption_exclusions: Annotated[Optional[DecryptionExclusions], Field(description="Created")] = None,
        ...
        :param decryption_exclusions: Created
        :type decryption_exclusions: DecryptionExclusions
        ...
        _param = self._create_decryption_exclusions_serialize(
            decryption_exclusions=decryption_exclusions,
    ...
    @validate_call
    @with_error_handling
    def create_decryption_exclusions_with_http_info(
        self,
        decryption_exclusions: Annotated[Optional[DecryptionExclusions], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DecryptionExclusions]:
        """Create a decryption exclusion
    ...
    @validate_call
    @with_error_handling
    def create_decryption_exclusions_without_preload_content(
        self,
        decryption_exclusions: Annotated[Optional[DecryptionExclusions], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_decryption_exclusions_serialize(
        self,
        ...
        if decryption_exclusions is not None:
            _body_params = decryption_exclusions
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/decryption-exclusions',
    ...
    @validate_call
    @with_error_handling
    def delete_decryption_exclusions_by_id(
        self,
        ...
        _param = self._delete_decryption_exclusions_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def delete_decryption_exclusions_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def delete_decryption_exclusions_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _delete_decryption_exclusions_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/decryption-exclusions/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    @with_error_handling
    def get_decryption_exclusions_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
        ...
        _param = self._get_decryption_exclusions_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def get_decryption_exclusions_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def get_decryption_exclusions_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_decryption_exclusions_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    @with_error_handling
    def list_decryption_exclusions(
        self,
        ...
        _param = self._list_decryption_exclusions_serialize(
            name=name,
            folder=folder,
            snippet=snippet,
            device=device,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DecryptionExclusionsListResponse",
            '400': "GenericError",
            '401': "GenericError",
            '403': "GenericError",
            '409': "GenericError",
    ...
    @validate_call
    @with_error_handling
    def list_decryption_exclusions_with_http_info(
        self,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DecryptionExclusionsListResponse]:
        """List decryption exclusions
    ...
    @validate_call
    @with_error_handling
    def list_decryption_exclusions_without_preload_content(
        self,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
    ...
    def _list_decryption_exclusions_serialize(
        self,
        name,
        folder,
        snippet,
    ...
    @validate_call
    @with_error_handling
    def update_decryption_exclusions_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        decryption_exclusions: Annotated[Optional[DecryptionExclusions], Field(description="OK")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: The UUID of the configuration resource (required)
        :type id: str
        :param decryption_exclusions: OK
        :type decryption_exclusions: DecryptionExclusions
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._update_decryption_exclusions_by_id_serialize(
            id=id,
            decryption_exclusions=decryption_exclusions,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    @with_error_handling
    def update_decryption_exclusions_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        decryption_exclusions: Annotated[Optional[DecryptionExclusions], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    @with_error_handling
    def update_decryption_exclusions_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        decryption_exclusions: Annotated[Optional[DecryptionExclusions], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    def fetch_decryption_exclusions(
        self,
        name: str,
        ...
        **kwargs
        ...
        """
        Fetch a single decryption_exclusions object by name.
        ...
        Example:
            >>> obj = api.fetch_decryption_exclusions(name="my-object", folder="Texas")
            >>> if obj:
        ...
        while True:
            ...
            response = self.list_decryption_exclusions(**list_params)
    ...
    def _update_decryption_exclusions_by_id_serialize(
        self,
        id,
        decryption_exclusions,
        _request_auth,
