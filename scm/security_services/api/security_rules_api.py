...
class SecurityRulesApi:
    ...
    def create_security_rules(
        ...
        security_rules: Annotated[Optional[SecurityRules], Field(description="Created")] = None,
        ...
        :type position: str
        :param security_rules: Created
        :type security_rules: SecurityRules
        ...
        _param = self._create_security_rules_serialize(
            position=position,
    ...
    @validate_call
    @with_error_handling
    def create_security_rules_with_http_info(
        self,
        position: Annotated[StrictStr, Field(description="The position of a security rule ")],
        security_rules: Annotated[Optional[SecurityRules], Field(description="Created")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    @with_error_handling
    def create_security_rules_without_preload_content(
        self,
        position: Annotated[StrictStr, Field(description="The position of a security rule ")],
        security_rules: Annotated[Optional[SecurityRules], Field(description="Created")] = None,
        _request_timeout: Union[
    ...
    def _create_security_rules_serialize(
        self,
        position,
        security_rules,
        _request_auth,
    ...
    @validate_call
    @with_error_handling
    def delete_security_rules_by_id(
        self,
        ...
        _param = self._delete_security_rules_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def delete_security_rules_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def delete_security_rules_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _delete_security_rules_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/security-rules/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_security_rules_by_id(
        ...
        _param = self._get_security_rules_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def get_security_rules_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def get_security_rules_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_security_rules_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def move_security_rules_by_id(
        ...
        _param = self._move_security_rules_by_id_serialize(
            id=id,
    ...
    @validate_call
    @with_error_handling
    def move_security_rules_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        rule_based_move: Annotated[Optional[RuleBasedMove], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    @with_error_handling
    def move_security_rules_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        rule_based_move: Annotated[Optional[RuleBasedMove], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    def _move_security_rules_by_id_serialize(
        self,
        id,
        rule_based_move,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/security-rules/{id}:move',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    @with_error_handling
    def update_security_rules_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        security_rules: Annotated[Optional[SecurityRules], Field(description="OK")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._update_security_rules_by_id_serialize(
            id=id,
            security_rules=security_rules,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    @with_error_handling
    def update_security_rules_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        security_rules: Annotated[Optional[SecurityRules], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    @with_error_handling
    def update_security_rules_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        security_rules: Annotated[Optional[SecurityRules], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    def fetch_security_rules(
        ...
        **kwargs
        ...
        try:
            response = self.list_security_rules(**list_params)
