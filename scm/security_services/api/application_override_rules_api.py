...
class ApplicationOverrideRulesApi:
    ...
    @validate_call
    @with_error_handling
    def create_application_override_rules(
        self,
        position: Annotated[StrictStr, Field(description="The position of a security rule ")],
        app_override_rules: Annotated[Optional[AppOverrideRules], Field(description="Created")] = None,
        ...
        :param position: The position of a security rule  (required)
        :type position: str
        :param app_override_rules: Created
        :type app_override_rules: AppOverrideRules
        ...
        _param = self._create_application_override_rules_serialize(
            position=position,
            app_override_rules=app_override_rules,
    ...
    @validate_call
    @with_error_handling
    def create_application_override_rules_with_http_info(
        self,
        position: Annotated[StrictStr, Field(description="The position of a security rule ")],
        app_override_rules: Annotated[Optional[AppOverrideRules], Field(description="Created")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    @with_error_handling
    def create_application_override_rules_without_preload_content(
        self,
        position: Annotated[StrictStr, Field(description="The position of a security rule ")],
        app_override_rules: Annotated[Optional[AppOverrideRules], Field(description="Created")] = None,
        _request_timeout: Union[
    ...
    def _create_application_override_rules_serialize(
        self,
        position,
        app_override_rules,
        _request_auth,
        ...
        if app_override_rules is not None:
            _body_params = app_override_rules
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/app-override-rules',
    ...
    @validate_call
    @with_error_handling
    def delete_application_override_rules_by_id(
        self,
        ...
        _param = self._delete_application_override_rules_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def delete_application_override_rules_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def delete_application_override_rules_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _delete_application_override_rules_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/app-override-rules/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    @with_error_handling
    def get_application_override_rules_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
        ...
        _param = self._get_application_override_rules_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def get_application_override_rules_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def get_application_override_rules_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_application_override_rules_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    @with_error_handling
    def list_application_override_rules(
        self,
        position: Annotated[StrictStr, Field(description="The position of a security rule ")],
        ...
        _param = self._list_application_override_rules_serialize(
            position=position,
            name=name,
            folder=folder,
            snippet=snippet,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ApplicationOverrideRulesListResponse",
            '400': "GenericError",
            '401': "GenericError",
            '403': "GenericError",
            '404': "GenericError",
    ...
    @validate_call
    @with_error_handling
    def list_application_override_rules_with_http_info(
        self,
        position: Annotated[StrictStr, Field(description="The position of a security rule ")],
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApplicationOverrideRulesListResponse]:
        """List application override rules
    ...
    @validate_call
    @with_error_handling
    def list_application_override_rules_without_preload_content(
        self,
        position: Annotated[StrictStr, Field(description="The position of a security rule ")],
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
    ...
    def _list_application_override_rules_serialize(
        self,
        position,
        name,
        folder,
    ...
    @validate_call
    @with_error_handling
    def move_application_override_rules_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        rule_based_move: Annotated[Optional[RuleBasedMove], Field(description="The app override rule you want to move")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: The UUID of the configuration resource (required)
        :type id: str
        :param rule_based_move: The app override rule you want to move
        ...
        _param = self._move_application_override_rules_by_id_serialize(
            id=id,
    ...
    @validate_call
    @with_error_handling
    def move_application_override_rules_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        rule_based_move: Annotated[Optional[RuleBasedMove], Field(description="The app override rule you want to move")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    @with_error_handling
    def move_application_override_rules_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        rule_based_move: Annotated[Optional[RuleBasedMove], Field(description="The app override rule you want to move")] = None,
        _request_timeout: Union[
    ...
    def _move_application_override_rules_by_id_serialize(
        self,
        id,
        rule_based_move,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/app-override-rules/{id}:move',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    @with_error_handling
    def update_application_override_rules_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        app_override_rules: Annotated[Optional[AppOverrideRules], Field(description="OK")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._update_application_override_rules_by_id_serialize(
            id=id,
            app_override_rules=app_override_rules,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    @with_error_handling
    def update_application_override_rules_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        app_override_rules: Annotated[Optional[AppOverrideRules], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    @with_error_handling
    def update_application_override_rules_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        app_override_rules: Annotated[Optional[AppOverrideRules], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    def fetch_application_override_rules(
        self,
        name: str,
        ...
        **kwargs
        ...
        """
        Fetch a single application_override_rules object by name.
        ...
        Example:
            >>> obj = api.fetch_application_override_rules(name="my-object", folder="Texas")
            >>> if obj:
        ...
        try:
            response = self.list_application_override_rules(**list_params)
