...
class ProfileGroupsApi:
    ...
    def create_profile_groups(
        self,
        profile_groups: Annotated[Optional[ProfileGroups], Field(description="Created")] = None,
        ...
        :param profile_groups: Created
        :type profile_groups: ProfileGroups
        ...
        _param = self._create_profile_groups_serialize(
    ...
    @validate_call
    @with_error_handling
    def create_profile_groups_with_http_info(
        self,
        profile_groups: Annotated[Optional[ProfileGroups], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def create_profile_groups_without_preload_content(
        self,
        profile_groups: Annotated[Optional[ProfileGroups], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_profile_groups_serialize(
        self,
        profile_groups,
        _request_auth,
        _content_type,
    ...
    @validate_call
    @with_error_handling
    def delete_profile_groups_by_id(
        self,
        ...
        _param = self._delete_profile_groups_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def delete_profile_groups_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def delete_profile_groups_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _delete_profile_groups_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/profile-groups/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_profile_groups_by_id(
        ...
        _param = self._get_profile_groups_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def get_profile_groups_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def get_profile_groups_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_profile_groups_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def list_profile_groups(
        ...
        _param = self._list_profile_groups_serialize(
            name=name,
            folder=folder,
            snippet=snippet,
            device=device,
    ...
    @validate_call
    @with_error_handling
    def list_profile_groups_with_http_info(
        self,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProfileGroupsListResponse]:
        """List profile groups
    ...
    @validate_call
    @with_error_handling
    def list_profile_groups_without_preload_content(
        self,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
    ...
    def _list_profile_groups_serialize(
        self,
        name,
        folder,
        snippet,
    ...
    @validate_call
    @with_error_handling
    def update_profile_groups_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        profile_groups: Annotated[Optional[ProfileGroups], Field(description="OK")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._update_profile_groups_by_id_serialize(
            id=id,
            profile_groups=profile_groups,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    @with_error_handling
    def update_profile_groups_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        profile_groups: Annotated[Optional[ProfileGroups], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    @with_error_handling
    def update_profile_groups_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        profile_groups: Annotated[Optional[ProfileGroups], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    def fetch_profile_groups(
        ...
        **kwargs
        ...
        """
        Fetch a single profile_groups object by name.
        ...
        Example:
            >>> obj = api.fetch_profile_groups(name="my-object", folder="Texas")
            >>> if obj:
        ...
        while True:
            ...
            response = self.list_profile_groups(**list_params)
    ...
    def _update_profile_groups_by_id_serialize(
        self,
        id,
        profile_groups,
        _request_auth,
