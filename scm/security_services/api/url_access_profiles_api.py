...
class URLAccessProfilesApi:
    ...
    @validate_call
    @with_error_handling
    def create_url_access_profiles(
        self,
        url_access_profiles: Annotated[Optional[UrlAccessProfiles], Field(description="Created")] = None,
        ...
        :param url_access_profiles: Created
        :type url_access_profiles: UrlAccessProfiles
        ...
        _param = self._create_url_access_profiles_serialize(
    ...
    @validate_call
    @with_error_handling
    def create_url_access_profiles_with_http_info(
        self,
        url_access_profiles: Annotated[Optional[UrlAccessProfiles], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def create_url_access_profiles_without_preload_content(
        self,
        url_access_profiles: Annotated[Optional[UrlAccessProfiles], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_url_access_profiles_serialize(
        self,
        url_access_profiles,
        _request_auth,
        _content_type,
        ...
        if url_access_profiles is not None:
            _body_params = url_access_profiles
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/url-access-profiles',
    ...
    @validate_call
    @with_error_handling
    def delete_url_access_profiles_by_id(
        self,
        ...
        _param = self._delete_url_access_profiles_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def delete_url_access_profiles_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def delete_url_access_profiles_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _delete_url_access_profiles_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/url-access-profiles/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    @with_error_handling
    def get_url_access_profiles_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
        ...
        _param = self._get_url_access_profiles_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def get_url_access_profiles_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def get_url_access_profiles_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_url_access_profiles_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def list_url_access_profiles(
        ...
        _param = self._list_url_access_profiles_serialize(
            name=name,
            folder=folder,
            snippet=snippet,
            device=device,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "URLAccessProfilesListResponse",
            '400': "GenericError",
            '401': "GenericError",
            '403': "GenericError",
            '404': "GenericError",
    ...
    @validate_call
    @with_error_handling
    def list_url_access_profiles_with_http_info(
        self,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[URLAccessProfilesListResponse]:
        """List URL access profiles
    ...
    @validate_call
    @with_error_handling
    def list_url_access_profiles_without_preload_content(
        self,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
    ...
    def _list_url_access_profiles_serialize(
        self,
        name,
        folder,
        snippet,
    ...
    @validate_call
    @with_error_handling
    def update_url_access_profiles_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        url_access_profiles: Annotated[Optional[UrlAccessProfiles], Field(description="OK")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._update_url_access_profiles_by_id_serialize(
            id=id,
            url_access_profiles=url_access_profiles,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    @with_error_handling
    def update_url_access_profiles_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        url_access_profiles: Annotated[Optional[UrlAccessProfiles], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    @with_error_handling
    def update_url_access_profiles_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        url_access_profiles: Annotated[Optional[UrlAccessProfiles], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    def fetch_url_access_profiles(
        ...
        **kwargs
        ...
        """
        Fetch a single url_access_profiles object by name.
        ...
        Example:
            >>> obj = api.fetch_url_access_profiles(name="my-object", folder="Texas")
            >>> if obj:
        ...
        try:
            response = self.list_url_access_profiles(**list_params)
    ...
    def _update_url_access_profiles_by_id_serialize(
        self,
        id,
        url_access_profiles,
        _request_auth,
