...
class HTTPHeaderProfilesApi:
    ...
    @validate_call
    @with_error_handling
    def create_http_header_profiles(
        self,
        http_header_profiles: Annotated[Optional[HttpHeaderProfiles], Field(description="Created")] = None,
        ...
        :param http_header_profiles: Created
        :type http_header_profiles: HttpHeaderProfiles
        ...
        _param = self._create_http_header_profiles_serialize(
            http_header_profiles=http_header_profiles,
    ...
    @validate_call
    @with_error_handling
    def create_http_header_profiles_with_http_info(
        self,
        http_header_profiles: Annotated[Optional[HttpHeaderProfiles], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[HttpHeaderProfiles]:
        """Create an HTTP header profile
    ...
    @validate_call
    @with_error_handling
    def create_http_header_profiles_without_preload_content(
        self,
        http_header_profiles: Annotated[Optional[HttpHeaderProfiles], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_http_header_profiles_serialize(
        self,
        ...
        if http_header_profiles is not None:
            _body_params = http_header_profiles
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/http-header-profiles',
    ...
    @validate_call
    @with_error_handling
    def delete_http_header_profiles_by_id(
        self,
        ...
        _param = self._delete_http_header_profiles_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def delete_http_header_profiles_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def delete_http_header_profiles_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _delete_http_header_profiles_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/http-header-profiles/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    @with_error_handling
    def get_http_header_profiles_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
        ...
        _param = self._get_http_header_profiles_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def get_http_header_profiles_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def get_http_header_profiles_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_http_header_profiles_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def list_http_header_profiles(
        ...
        _param = self._list_http_header_profiles_serialize(
            name=name,
            folder=folder,
            snippet=snippet,
            device=device,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "HTTPHeaderProfilesListResponse",
            '400': "GenericError",
            '401': "GenericError",
            '403': "GenericError",
            '404': "GenericError",
    ...
    @validate_call
    @with_error_handling
    def list_http_header_profiles_with_http_info(
        self,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[HTTPHeaderProfilesListResponse]:
        """List HTTP header profiles
    ...
    @validate_call
    @with_error_handling
    def list_http_header_profiles_without_preload_content(
        self,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
    ...
    def _list_http_header_profiles_serialize(
        self,
        name,
        folder,
        snippet,
    ...
    @validate_call
    @with_error_handling
    def update_http_header_profiles_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        http_header_profiles: Annotated[Optional[HttpHeaderProfiles], Field(description="OK")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._update_http_header_profiles_by_id_serialize(
            id=id,
            http_header_profiles=http_header_profiles,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    @with_error_handling
    def update_http_header_profiles_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        http_header_profiles: Annotated[Optional[HttpHeaderProfiles], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    @with_error_handling
    def update_http_header_profiles_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        http_header_profiles: Annotated[Optional[HttpHeaderProfiles], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    def fetch_http_header_profiles(
        self,
        name: str,
        ...
        **kwargs
        ...
        """
        Fetch a single http_header_profiles object by name.
        ...
        Example:
            >>> obj = api.fetch_http_header_profiles(name="my-object", folder="Texas")
            >>> if obj:
        ...
        try:
            response = self.list_http_header_profiles(**list_params)
    ...
    def _update_http_header_profiles_by_id_serialize(
        self,
        id,
        http_header_profiles,
        _request_auth,
