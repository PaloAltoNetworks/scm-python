...
class DoSProtectionProfilesApi:
    ...
    def create_do_s_protection_profiles(
        ...
        :param dos_protection_profiles: Created
        :type dos_protection_profiles: DosProtectionProfiles
        ...
        _param = self._create_do_s_protection_profiles_serialize(
            dos_protection_profiles=dos_protection_profiles,
    ...
    def create_do_s_protection_profiles_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DosProtectionProfiles]:
        """Create a DoS protection profile
    ...
    def _create_do_s_protection_profiles_serialize(
        self,
        ...
        if dos_protection_profiles is not None:
            _body_params = dos_protection_profiles
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/dos-protection-profiles',
    ...
    def delete_do_s_protection_profiles_by_id(
        ...
        _param = self._delete_do_s_protection_profiles_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _delete_do_s_protection_profiles_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/dos-protection-profiles/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_do_s_protection_profiles_by_id(
        ...
        _param = self._get_do_s_protection_profiles_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _get_do_s_protection_profiles_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def list_do_s_protection_profiles(
        ...
        _param = self._list_do_s_protection_profiles_serialize(
            limit=limit,
            offset=offset,
            name=name,
            folder=folder,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DoSProtectionProfilesListResponse",
            '400': "GenericError",
            '401': "GenericError",
            '403': "GenericError",
            '404': "GenericError",
    ...
    def list_do_s_protection_profiles_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DoSProtectionProfilesListResponse]:
        """List DoS protection profiles
    ...
    def _list_do_s_protection_profiles_serialize(
        self,
        limit,
        offset,
        name,
    ...
    def update_do_s_protection_profiles_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        dos_protection_profiles: Annotated[Optional[DosProtectionProfiles], Field(description="OK")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: The UUID of the configuration resource (required)
        :type id: str
        :param dos_protection_profiles: OK
        :type dos_protection_profiles: DosProtectionProfiles
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._update_do_s_protection_profiles_by_id_serialize(
            id=id,
            dos_protection_profiles=dos_protection_profiles,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def fetch_dos_protection_profiles(
        self,
        name: str,
        ...
        **kwargs
        ...
        """
        Fetch a single dos_protection_profiles object by name.
        ...
        Example:
            >>> obj = api.fetch_dos_protection_profiles(name="my-object", folder="Texas")
            >>> if obj:
