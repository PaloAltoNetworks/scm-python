...
class SaasTenantRestrictionsApi:
    ...
    @validate_call
    @with_error_handling
    def get_saas_tenant_restrictions(
        self,
        ...
        _param = self._get_saas_tenant_restrictions_serialize(
            name=name,
            folder=folder,
            snippet=snippet,
            device=device,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetSaasTenantRestrictionsListResponse",
            '400': "GenericError",
            '401': "GenericError",
            '403': "GenericError",
            '404': "GenericError",
    ...
    @validate_call
    @with_error_handling
    def get_saas_tenant_restrictions_with_http_info(
        self,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetSaasTenantRestrictionsListResponse]:
        """Get Saas Tenant Restrictions
    ...
    @validate_call
    @with_error_handling
    def get_saas_tenant_restrictions_without_preload_content(
        self,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
    ...
    def _get_saas_tenant_restrictions_serialize(
        self,
        name,
        folder,
        snippet,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/saas-tenant-restrictions',
    ...
    @validate_call
    @with_error_handling
    def update_saas_tenant_restrictions(
        self,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
        saas_tenant_restrictions: Annotated[Optional[SaasTenantRestrictions], Field(description="OK")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param snippet: The snippet in which the resource is defined 
        :type snippet: str
        :param saas_tenant_restrictions: OK
        :type saas_tenant_restrictions: SaasTenantRestrictions
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_saas_tenant_restrictions_serialize(
            snippet=snippet,
            saas_tenant_restrictions=saas_tenant_restrictions,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    @with_error_handling
    def update_saas_tenant_restrictions_with_http_info(
        self,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
        saas_tenant_restrictions: Annotated[Optional[SaasTenantRestrictions], Field(description="OK")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SaasTenantRestrictions]:
        """Update Saas Tenant Restrictions
    ...
    @validate_call
    @with_error_handling
    def update_saas_tenant_restrictions_without_preload_content(
        self,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
        saas_tenant_restrictions: Annotated[Optional[SaasTenantRestrictions], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    def fetch_saas_tenant_restrictions(
        self,
        name: str,
        ...
        **kwargs
        ...
        """
        Fetch a single saas_tenant_restrictions object by name.
        ...
        Example:
            >>> obj = api.fetch_saas_tenant_restrictions(name="my-object", folder="Texas")
            >>> if obj:
        ...
        while True:
            ...
            response = self.list_saas_tenant_restrictions(**list_params)
    ...
    def _update_saas_tenant_restrictions_serialize(
        self,
        snippet,
        saas_tenant_restrictions,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if saas_tenant_restrictions is not None:
            _body_params = saas_tenant_restrictions
