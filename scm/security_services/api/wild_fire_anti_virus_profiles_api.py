...
class WildFireAntiVirusProfilesApi:
    ...
    def fetch_wild_fire_anti_virus_profiles(
        self,
        name: str,
        ...
        **kwargs
        ...
        """
        Fetch a single wild_fire_anti_virus_profiles object by name.
        ...
        Example:
            >>> obj = api.fetch_wild_fire_anti_virus_profiles(name="my-object", folder="Texas")
            >>> if obj:
