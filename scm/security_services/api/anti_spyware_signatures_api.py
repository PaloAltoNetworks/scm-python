...
class AntiSpywareSignaturesApi:
    ...
    @validate_call
    @with_error_handling
    def create_anti_spyware_signatures(
        self,
        anti_spyware_signatures: Annotated[Optional[AntiSpywareSignatures], Field(description="Created")] = None,
        ...
        :param anti_spyware_signatures: Created
        :type anti_spyware_signatures: AntiSpywareSignatures
        ...
        _param = self._create_anti_spyware_signatures_serialize(
            anti_spyware_signatures=anti_spyware_signatures,
    ...
    @validate_call
    @with_error_handling
    def create_anti_spyware_signatures_with_http_info(
        self,
        anti_spyware_signatures: Annotated[Optional[AntiSpywareSignatures], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AntiSpywareSignatures]:
        """Create an anti-spyware signature
    ...
    @validate_call
    @with_error_handling
    def create_anti_spyware_signatures_without_preload_content(
        self,
        anti_spyware_signatures: Annotated[Optional[AntiSpywareSignatures], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_anti_spyware_signatures_serialize(
        self,
        anti_spyware_signatures,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if anti_spyware_signatures is not None:
            _body_params = anti_spyware_signatures
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/anti-spyware-signatures',
    ...
    @validate_call
    @with_error_handling
    def delete_anti_spyware_signatures_by_id(
        self,
        ...
        _param = self._delete_anti_spyware_signatures_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def delete_anti_spyware_signatures_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def delete_anti_spyware_signatures_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _delete_anti_spyware_signatures_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/anti-spyware-signatures/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    @with_error_handling
    def get_anti_spyware_signatures_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
        ...
        _param = self._get_anti_spyware_signatures_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def get_anti_spyware_signatures_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def get_anti_spyware_signatures_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_anti_spyware_signatures_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    @with_error_handling
    def list_anti_spyware_signatures(
        self,
        ...
        _param = self._list_anti_spyware_signatures_serialize(
            folder=folder,
            snippet=snippet,
            device=device,
            offset=offset,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AntiSpywareSignaturesListResponse",
            '400': "GenericError",
            '401': "GenericError",
            '403': "GenericError",
            '404': "GenericError",
    ...
    @validate_call
    @with_error_handling
    def list_anti_spyware_signatures_with_http_info(
        self,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
        device: Annotated[Optional[StrictStr], Field(description="The device in which the resource is defined ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AntiSpywareSignaturesListResponse]:
        """List anti-spyware signatures
    ...
    @validate_call
    @with_error_handling
    def list_anti_spyware_signatures_without_preload_content(
        self,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
        device: Annotated[Optional[StrictStr], Field(description="The device in which the resource is defined ")] = None,
    ...
    def _list_anti_spyware_signatures_serialize(
        self,
        folder,
        snippet,
        device,
    ...
    @validate_call
    @with_error_handling
    def update_anti_spyware_signatures_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        anti_spyware_signatures: Annotated[Optional[AntiSpywareSignatures], Field(description="OK")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: The UUID of the configuration resource (required)
        :type id: str
        :param anti_spyware_signatures: OK
        :type anti_spyware_signatures: AntiSpywareSignatures
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._update_anti_spyware_signatures_by_id_serialize(
            id=id,
            anti_spyware_signatures=anti_spyware_signatures,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    @with_error_handling
    def update_anti_spyware_signatures_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        anti_spyware_signatures: Annotated[Optional[AntiSpywareSignatures], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    @with_error_handling
    def update_anti_spyware_signatures_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        anti_spyware_signatures: Annotated[Optional[AntiSpywareSignatures], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    def fetch_anti_spyware_signatures(
        self,
        name: str,
        ...
        **kwargs
        ...
        """
        Fetch a single anti_spyware_signatures object by name.
        ...
        Example:
            >>> obj = api.fetch_anti_spyware_signatures(name="my-object", folder="Texas")
            >>> if obj:
        ...
        while True:
            ...
            response = self.list_anti_spyware_signatures(**list_params)
    ...
    def _update_anti_spyware_signatures_by_id_serialize(
        self,
        id,
        anti_spyware_signatures,
        _request_auth,
