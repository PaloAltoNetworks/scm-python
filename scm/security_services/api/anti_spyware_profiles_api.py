...
class AntiSpywareProfilesApi:
    ...
    @validate_call
    @with_error_handling
    def create_anti_spyware_profiles(
        self,
        anti_spyware_profiles: Annotated[Optional[AntiSpywareProfiles], Field(description="Created")] = None,
        ...
        :param anti_spyware_profiles: Created
        :type anti_spyware_profiles: AntiSpywareProfiles
        ...
        _param = self._create_anti_spyware_profiles_serialize(
            anti_spyware_profiles=anti_spyware_profiles,
    ...
    @validate_call
    @with_error_handling
    def create_anti_spyware_profiles_with_http_info(
        self,
        anti_spyware_profiles: Annotated[Optional[AntiSpywareProfiles], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AntiSpywareProfiles]:
        """Create an anti-spyware profile
    ...
    @validate_call
    @with_error_handling
    def create_anti_spyware_profiles_without_preload_content(
        self,
        anti_spyware_profiles: Annotated[Optional[AntiSpywareProfiles], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_anti_spyware_profiles_serialize(
        self,
        ...
        if anti_spyware_profiles is not None:
            _body_params = anti_spyware_profiles
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/anti-spyware-profiles',
    ...
    @validate_call
    @with_error_handling
    def delete_anti_spyware_profiles_by_id(
        self,
        ...
        _param = self._delete_anti_spyware_profiles_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def delete_anti_spyware_profiles_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def delete_anti_spyware_profiles_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _delete_anti_spyware_profiles_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/anti-spyware-profiles/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    @with_error_handling
    def get_anti_spyware_profiles_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
        ...
        _param = self._get_anti_spyware_profiles_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def get_anti_spyware_profiles_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def get_anti_spyware_profiles_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_anti_spyware_profiles_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def list_anti_spyware_profiles(
        ...
        _param = self._list_anti_spyware_profiles_serialize(
            name=name,
            folder=folder,
            snippet=snippet,
            device=device,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AntiSpywareProfilesListResponse",
            '400': "GenericError",
            '401': "GenericError",
            '403': "GenericError",
            '404': "GenericError",
    ...
    @validate_call
    @with_error_handling
    def list_anti_spyware_profiles_with_http_info(
        self,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AntiSpywareProfilesListResponse]:
        """List anti-spyware profiles
    ...
    @validate_call
    @with_error_handling
    def list_anti_spyware_profiles_without_preload_content(
        self,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
    ...
    def _list_anti_spyware_profiles_serialize(
        self,
        name,
        folder,
        snippet,
    ...
    @validate_call
    @with_error_handling
    def update_anti_spyware_profiles_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        anti_spyware_profiles: Annotated[Optional[AntiSpywareProfiles], Field(description="OK")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: The UUID of the configuration resource (required)
        :type id: str
        :param anti_spyware_profiles: OK
        :type anti_spyware_profiles: AntiSpywareProfiles
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._update_anti_spyware_profiles_by_id_serialize(
            id=id,
            anti_spyware_profiles=anti_spyware_profiles,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    @with_error_handling
    def update_anti_spyware_profiles_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        anti_spyware_profiles: Annotated[Optional[AntiSpywareProfiles], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    @with_error_handling
    def update_anti_spyware_profiles_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        anti_spyware_profiles: Annotated[Optional[AntiSpywareProfiles], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    def fetch_anti_spyware_profiles(
        self,
        name: str,
        ...
        **kwargs
        ...
        """
        Fetch a single anti_spyware_profiles object by name.
        ...
        Example:
            >>> obj = api.fetch_anti_spyware_profiles(name="my-object", folder="Texas")
            >>> if obj:
        ...
        while True:
            ...
            response = self.list_anti_spyware_profiles(**list_params)
