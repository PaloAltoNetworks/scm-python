...
class URLFilteringCategoriesApi:
    ...
    def fetch_url_filtering_categories(
        self,
        name: str,
        ...
        **kwargs
        ...
        """
        Fetch a single url_filtering_categories object by name.
        ...
        Example:
            >>> obj = api.fetch_url_filtering_categories(name="my-object", folder="Texas")
            >>> if obj:
        ...
        while True:
            ...
            response = self.list_url_filtering_categories(**list_params)
