...
class DNSSecurityProfilesApi:
    ...
    @validate_call
    @with_error_handling
    def create_dns_security_profiles(
        self,
        dns_security_profiles: Annotated[Optional[DnsSecurityProfiles], Field(description="Created")] = None,
        ...
        :param dns_security_profiles: Created
        :type dns_security_profiles: DnsSecurityProfiles
        ...
        _param = self._create_dns_security_profiles_serialize(
            dns_security_profiles=dns_security_profiles,
    ...
    @validate_call
    @with_error_handling
    def create_dns_security_profiles_with_http_info(
        self,
        dns_security_profiles: Annotated[Optional[DnsSecurityProfiles], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DnsSecurityProfiles]:
        """Create a DNS security profile
    ...
    @validate_call
    @with_error_handling
    def create_dns_security_profiles_without_preload_content(
        self,
        dns_security_profiles: Annotated[Optional[DnsSecurityProfiles], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_dns_security_profiles_serialize(
        self,
        ...
        if dns_security_profiles is not None:
            _body_params = dns_security_profiles
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/dns-security-profiles',
    ...
    @validate_call
    @with_error_handling
    def delete_dns_security_profiles_by_id(
        self,
        ...
        _param = self._delete_dns_security_profiles_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def delete_dns_security_profiles_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def delete_dns_security_profiles_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _delete_dns_security_profiles_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/dns-security-profiles/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    @with_error_handling
    def get_dns_security_profiles_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
        ...
        _param = self._get_dns_security_profiles_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def get_dns_security_profiles_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def get_dns_security_profiles_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_dns_security_profiles_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def list_dns_security_profiles(
        ...
        _param = self._list_dns_security_profiles_serialize(
            name=name,
            folder=folder,
            snippet=snippet,
            device=device,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DNSSecurityProfilesListResponse",
            '400': "GenericError",
            '401': "GenericError",
            '403': "GenericError",
            '404': "GenericError",
    ...
    @validate_call
    @with_error_handling
    def list_dns_security_profiles_with_http_info(
        self,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DNSSecurityProfilesListResponse]:
        """List DNS security profiles
    ...
    @validate_call
    @with_error_handling
    def list_dns_security_profiles_without_preload_content(
        self,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        folder: Annotated[Optional[StrictStr], Field(description="The folder in which the resource is defined ")] = None,
        snippet: Annotated[Optional[StrictStr], Field(description="The snippet in which the resource is defined ")] = None,
    ...
    def _list_dns_security_profiles_serialize(
        self,
        name,
        folder,
        snippet,
    ...
    @validate_call
    @with_error_handling
    def update_dns_security_profiles_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        dns_security_profiles: Annotated[Optional[DnsSecurityProfiles], Field(description="OK")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: The UUID of the configuration resource (required)
        :type id: str
        :param dns_security_profiles: OK
        :type dns_security_profiles: DnsSecurityProfiles
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._update_dns_security_profiles_by_id_serialize(
            id=id,
            dns_security_profiles=dns_security_profiles,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    @with_error_handling
    def update_dns_security_profiles_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        dns_security_profiles: Annotated[Optional[DnsSecurityProfiles], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    @with_error_handling
    def update_dns_security_profiles_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        dns_security_profiles: Annotated[Optional[DnsSecurityProfiles], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    def fetch_dns_security_profiles(
        self,
        name: str,
        ...
        **kwargs
        ...
        """
        Fetch a single dns_security_profiles object by name.
        ...
        Example:
            >>> obj = api.fetch_dns_security_profiles(name="my-object", folder="Texas")
            >>> if obj:
        ...
        try:
            response = self.list_dns_security_profiles(**list_params)
