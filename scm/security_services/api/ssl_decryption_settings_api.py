...
class SslDecryptionSettingsApi:
    ...
    def delete_ssl_decryption_settings(
        ...
        _param = self._delete_ssl_decryption_settings_serialize(
    ...
    def delete_ssl_decryption_settings_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SslDecryptionSettings]:
        """DELETE Ssl Decryption Settings
    ...
    def _delete_ssl_decryption_settings_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/ssl-decryption-settings',
    ...
    def get_ssl_decryption_settings(
        ...
        _param = self._get_ssl_decryption_settings_serialize(
            folder=folder,
            snippet=snippet,
            device=device,
            offset=offset,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetSslDecryptionSettingsListResponse",
            '400': "GenericError",
            '401': "GenericError",
            '403': "GenericError",
            '404': "GenericError",
    ...
    def get_ssl_decryption_settings_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetSslDecryptionSettingsListResponse]:
        """GET Ssl Decryption Settings
    ...
    def _get_ssl_decryption_settings_serialize(
        self,
        folder,
        snippet,
        device,
    ...
    def post_ssl_decryption_settings(
        ...
        :param ssl_decryption_settings: (required)
        :type ssl_decryption_settings: SslDecryptionSettings
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_ssl_decryption_settings_serialize(
            ssl_decryption_settings=ssl_decryption_settings,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _post_ssl_decryption_settings_serialize(
        self,
        ssl_decryption_settings,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if ssl_decryption_settings is not None:
            _body_params = ssl_decryption_settings
    ...
    def put_ssl_decryption_settings(
        self,
        ssl_decryption_settings_get_put: SslDecryptionSettingsGetPut,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param ssl_decryption_settings_get_put: (required)
        :type ssl_decryption_settings_get_put: SslDecryptionSettingsGetPut
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._put_ssl_decryption_settings_serialize(
            ssl_decryption_settings_get_put=ssl_decryption_settings_get_put,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SslDecryptionSettingsGetPut",
            '400': "GenericError",
            '401': "GenericError",
            '403': "GenericError",
            '404': "GenericError",
    ...
    def put_ssl_decryption_settings_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SslDecryptionSettingsGetPut]:
        """PUT Ssl Decryption Settings
    ...
    def _put_ssl_decryption_settings_serialize(
        self,
        ssl_decryption_settings_get_put,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if ssl_decryption_settings_get_put is not None:
            _body_params = ssl_decryption_settings_get_put
