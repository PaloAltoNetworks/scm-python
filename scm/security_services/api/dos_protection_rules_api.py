...
class DoSProtectionRulesApi:
    ...
    @validate_call
    @with_error_handling
    def create_do_s_protection_rules(
        self,
        dos_protection_rules: Annotated[Optional[DosProtectionRules], Field(description="Created")] = None,
        ...
        :param dos_protection_rules: Created
        :type dos_protection_rules: DosProtectionRules
        ...
        _param = self._create_do_s_protection_rules_serialize(
    ...
    @validate_call
    @with_error_handling
    def create_do_s_protection_rules_with_http_info(
        self,
        dos_protection_rules: Annotated[Optional[DosProtectionRules], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DosProtectionRules]:
        """Create a DoS protection rule
    ...
    @validate_call
    @with_error_handling
    def create_do_s_protection_rules_without_preload_content(
        self,
        dos_protection_rules: Annotated[Optional[DosProtectionRules], Field(description="Created")] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_do_s_protection_rules_serialize(
        self,
        ...
        if dos_protection_rules is not None:
            _body_params = dos_protection_rules
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/dos-protection-rules',
    ...
    @validate_call
    @with_error_handling
    def delete_do_s_protection_rules_by_id(
        self,
        ...
        _param = self._delete_do_s_protection_rules_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def delete_do_s_protection_rules_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def delete_do_s_protection_rules_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _delete_do_s_protection_rules_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/dos-protection-rules/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    @with_error_handling
    def get_do_s_protection_rules_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
        ...
        _param = self._get_do_s_protection_rules_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    @with_error_handling
    def get_do_s_protection_rules_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    @with_error_handling
    def get_do_s_protection_rules_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_do_s_protection_rules_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    @with_error_handling
    def list_do_s_protection_rules(
        self,
        ...
        _param = self._list_do_s_protection_rules_serialize(
            limit=limit,
            offset=offset,
            name=name,
            folder=folder,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DoSProtectionRulesListResponse",
            '400': "GenericError",
            '401': "GenericError",
            '403': "GenericError",
            '404': "GenericError",
    ...
    @validate_call
    @with_error_handling
    def list_do_s_protection_rules_with_http_info(
        self,
        limit: Annotated[Optional[StrictInt], Field(description="The maximum number of results per page")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="The offset into the list of results returned")] = None,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DoSProtectionRulesListResponse]:
        """List DoS protection rules
    ...
    @validate_call
    @with_error_handling
    def list_do_s_protection_rules_without_preload_content(
        self,
        limit: Annotated[Optional[StrictInt], Field(description="The maximum number of results per page")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="The offset into the list of results returned")] = None,
        name: Annotated[Optional[StrictStr], Field(description="The name of the configuration resource")] = None,
    ...
    def _list_do_s_protection_rules_serialize(
        self,
        limit,
        offset,
        name,
    ...
    @validate_call
    @with_error_handling
    def update_do_s_protection_rules_by_id(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        dos_protection_rules: Annotated[Optional[DosProtectionRules], Field(description="OK")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._update_do_s_protection_rules_by_id_serialize(
            id=id,
            dos_protection_rules=dos_protection_rules,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    @with_error_handling
    def update_do_s_protection_rules_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        dos_protection_rules: Annotated[Optional[DosProtectionRules], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    @with_error_handling
    def update_do_s_protection_rules_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The UUID of the configuration resource")],
        dos_protection_rules: Annotated[Optional[DosProtectionRules], Field(description="OK")] = None,
        _request_timeout: Union[
    ...
    def fetch_dos_protection_rules(
        self,
        name: str,
        ...
        **kwargs
        ...
        """
        Fetch a single dos_protection_rules object by name.
        ...
        Example:
            >>> obj = api.fetch_dos_protection_rules(name="my-object", folder="Texas")
            >>> if obj:
        ...
        try:
            response = self.list_do_s_protection_rules(**list_params)
    ...
    def _update_do_s_protection_rules_by_id_serialize(
        self,
        id,
        dos_protection_rules,
        _request_auth,
